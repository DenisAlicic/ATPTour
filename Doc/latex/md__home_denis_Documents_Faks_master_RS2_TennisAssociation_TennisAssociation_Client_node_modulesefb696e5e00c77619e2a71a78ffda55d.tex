...
\href{\#why}{\texttt{ Why another one? See below}}. tl;dr\+: The others I\textquotesingle{}ve tried are one of too loosey goosey (not explicit), too big/too many deps, or ill specified. YMMV.

Follow \href{https://twitter.com/intent/user?screen_name=trentmick}{\texttt{ @trentmick}} for updates to node-\/dashdash.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14266}{}\doxysection{Install}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14266}
\begin{DoxyVerb}npm install dashdash
\end{DoxyVerb}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14267}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14267}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14268}{}\doxysection{Longer Example}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14268}
A more realistic \href{./examples/foo.js}{\texttt{ starter script \char`\"{}foo.\+js\char`\"{}}} is as follows. This also shows using {\ttfamily \mbox{\hyperlink{namespaceupdate-gyp_a1870bb9fc9674e9b64956dffa76f15e8}{parser.\+help()}}} for formatted option help.
...
See the \href{examples/}{\texttt{ \char`\"{}examples\char`\"{}}} dir for a number of starter examples using some of dashdash\textquotesingle{}s features.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14269}{}\doxysection{Environment variable integration}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14269}
...
then the $\ast$$\ast$\char`\"{}\+FOO\+\_\+\+VERBOSE\char`\"{} environment variable$\ast$$\ast$ can be used to set this option\+:
...
With the {\ttfamily include\+Env\+: true} config to {\ttfamily \mbox{\hyperlink{namespaceupdate-gyp_a1870bb9fc9674e9b64956dffa76f15e8}{parser.\+help()}}} the environment variable can also be included in {\bfseries{help output}}\+: \begin{DoxyVerb}usage: node foo.js [OPTIONS]
options:
...
\end{DoxyVerb}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14270}{}\doxysection{Bash completion}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14270}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14271}{}\doxysection{Parser config}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14271}
Parser construction (i.\+e. {\ttfamily dashdash.\+create\+Parser(\+CONFIG)}) takes the following fields\+:


\begin{DoxyItemize}
\item {\ttfamily options} (Array of option specs). Required. See the \href{\#option-specs}{\texttt{ Option specs}} section below.
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14272}{}\doxysection{Option specs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14272}
...
\item date (epoch seconds, e.\+g. 1396031701, or ISO 8601 format {\ttfamily YYYY-\/\+MM-\/\+DD\mbox{[}THH\+:\+MM\+:SS\mbox{[}.sss\mbox{]}\mbox{[}Z\mbox{]}\mbox{]}}, e.\+g. \char`\"{}2014-\/03-\/28\+T18\+:35\+:01.\+489\+Z\char`\"{})
\item array\+Of\+Bool
...
\item {\ttfamily completion\+Type} (String). Optional. This is used for \href{\#bash-completion}{\texttt{ Bash completion}} for an option argument. If not specified, then the value of {\ttfamily type} is used. Any string may be specified, but only the following values have meaning\+:
\begin{DoxyItemize}
...
\item {\itshape Any string FOO for which a {\ttfamily function complete\+\_\+\+FOO} Bash function is defined.} This is for custom completions for a given tool. Typically these custom functions are provided in the {\ttfamily spec\+Extra} argument to {\ttfamily dashdash.\+bash\+Completion\+From\+Options()}. See \href{examples/ddcompletion.js}{\texttt{ \char`\"{}examples/ddcompletion.\+js\char`\"{}}} for an example.
\end{DoxyItemize}
...
\item {\ttfamily help} (String). Optional. Used for {\ttfamily \mbox{\hyperlink{namespaceupdate-gyp_a1870bb9fc9674e9b64956dffa76f15e8}{parser.\+help()}}} output.
\item {\ttfamily help\+Arg} (String). Optional. Used in help output as the placeholder for the option argument, e.\+g. the \char`\"{}\+PATH\char`\"{} in\+: \begin{DoxyVerb}  ...
  -f PATH, --file=PATH    File to process
  ...
\end{DoxyVerb}

\item {\ttfamily help\+Wrap} (Boolean). Optional, default true. Set this to {\ttfamily false} to have that option\textquotesingle{}s {\ttfamily help} {\itshape not} be text wrapped in {\ttfamily $<$parser$>$.\mbox{\hyperlink{namespaceupdate-gyp_a1870bb9fc9674e9b64956dffa76f15e8}{help()}}} output.
\item {\ttfamily default}. Optional. A default value used for this option, if the option isn\textquotesingle{}t specified in argv.
\item {\ttfamily hidden} (Boolean). Optional, default false. If true, help output will not include this option. See also the {\ttfamily include\+Hidden} option to {\ttfamily bash\+Completion\+From\+Options()} for \href{\#bash-completion}{\texttt{ Bash completion}}.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14273}{}\doxysection{Option group headings}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14273}
...
Note\+: You can use an empty string, `\{group\+: '\textquotesingle{}\}\`{}, to get a blank line in help output between groups of options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14274}{}\doxysection{Help config}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14274}
...
\item {\ttfamily include\+Default} (Boolean). Default false. If the option has a default value (via the {\ttfamily default} option spec attribute, or a default on the option\textquotesingle{}s type), then a \char`\"{}\+Default\+: VALUE\char`\"{} string will be appended to the help string.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14275}{}\doxysection{Custom option types}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14275}
...
var opts = dashdash.parse({options: options});
\end{DoxyVerb}
 See \char`\"{}examples/custom-\/option-\/\textbackslash{}$\ast$.\+js\char`\"{} for other examples. See the {\ttfamily add\+Option\+Type} block comment in \char`\"{}lib/dashdash.\+js\char`\"{} for more details. Please let me know \href{https://github.com/trentm/node-dashdash/issues/new}{\texttt{ with an issue}} if you write a generally useful one.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14276}{}\doxysection{Why}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14276}
...
\item {\ttfamily optparse} Incomplete docs. Is this an attempted clone of Python\textquotesingle{}s {\ttfamily optparse}. Not clear. Some divergence. {\ttfamily parser.\+on(\char`\"{}name\char`\"{}, ...)} API is weird.
...
\item \href{https://github.com/visionmedia/commander.js}{\texttt{ \char`\"{}commander.\+js\char`\"{}}}\+: I wrote \href{http://trentm.com/2014/01/a-critique-of-commander-for-nodejs.html}{\texttt{ a critique}} a while back. It seems fine, but last I checked had \href{https://github.com/visionmedia/commander.js/pull/121}{\texttt{ an outstanding bug}} that would prevent me from using it.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14277}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesefb696e5e00c77619e2a71a78ffda55d_autotoc_md14277}
MIT. See LICENSE.\+txt. 