...
\begin{DoxyEnumerate}
\item it outputs Java\+Script instead of JSON \href{\#json}{\texttt{ by default}}, enabling support for data structures like ES6 maps and sets;
\item it offers \href{\#api}{\texttt{ many options}} to customize the output;
\item its output is ASCII-\/safe \href{\#minimal}{\texttt{ by default}}, thanks to its use of \href{https://mathiasbynens.be/notes/javascript-escapes}{\texttt{ escape sequences}} where needed.
\end{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9470}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9470}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9471}{}\doxysubsection{$<$tt$>$jsesc(value, options)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9471}
...
The optional {\ttfamily options} argument accepts an object with the following options\+:\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9472}{}\doxysubsubsection{$<$tt$>$quotes$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9472}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9473}{}\doxysubsubsection{$<$tt$>$numbers$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9473}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9474}{}\doxysubsubsection{$<$tt$>$wrap$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9474}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9475}{}\doxysubsubsection{$<$tt$>$es6$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9475}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9476}{}\doxysubsubsection{$<$tt$>$escape\+Everything$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9476}
...
This setting also affects the output for string literals within arrays and objects.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9477}{}\doxysubsubsection{$<$tt$>$minimal$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9477}
...
\item whatever symbol is being used for wrapping string literals (based on \href{\#quotes}{\texttt{ the {\ttfamily quotes} option}})
\end{DoxyItemize}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9478}{}\doxysubsubsection{$<$tt$>$is\+Script\+Context$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9478}
The {\ttfamily is\+Script\+Context} option takes a boolean value ({\ttfamily true} or {\ttfamily false}), and defaults to {\ttfamily false} (disabled). When enabled, occurrences of \href{https://mathiasbynens.be/notes/etago}{\texttt{ {\ttfamily $<$/script} and {\ttfamily $<$/style}}} in the output are escaped as {\ttfamily $<$\textbackslash{}/script} and {\ttfamily $<$\textbackslash{}/style}, and \href{https://mathiasbynens.be/notes/etago\#comment-8}{\texttt{ {\ttfamily $<$!-\/-\/}}} is escaped as {\ttfamily \textbackslash{}x3\+C!-\/-\/} (or {\ttfamily \textbackslash{}u003\+C!-\/-\/} when the {\ttfamily json} option is enabled). This setting is useful when jsesc’s output ends up as part of a {\ttfamily $<$script$>$} or {\ttfamily $<$style$>$} element in an HTML document.
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9479}{}\doxysubsubsection{$<$tt$>$compact$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9479}
...
This setting has no effect on the output for strings.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9480}{}\doxysubsubsection{$<$tt$>$indent$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9480}
...
This setting has no effect on the output for strings.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9481}{}\doxysubsubsection{$<$tt$>$indent\+Level$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9481}
The {\ttfamily indent\+Level} option takes a numeric value, and defaults to {\ttfamily 0}. It represents the current indentation level, i.\+e. the number of times the value of \href{\#indent}{\texttt{ the {\ttfamily indent} option}} is repeated.
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9482}{}\doxysubsubsection{$<$tt$>$json$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9482}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9484}{}\doxysubsection{$<$tt$>$jsesc.\+version$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9484}
A string representing the semantic version number.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9485}{}\doxysubsection{Using the $<$tt$>$jsesc$<$/tt$>$ binary}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9485}
...
See {\ttfamily jsesc -\/-\/help} for the full list of options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9486}{}\doxysection{Support}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9486}
As of v2.\+0.\+0, jsesc supports Node.\+js v4+ only.

Older versions (up to jsesc v1.\+3.\+0) support Chrome 27, Firefox 3, Safari 4, Opera 10, IE 6, Node.\+js v6.\+0.\+0, Narwhal 0.\+3.\+2, Ringo\+JS 0.\+8-\/0.\+11, Phantom\+JS 1.\+9.\+0, and Rhino 1.\+7\+RC4. {\bfseries{Note\+:}} Using the {\ttfamily json} option on objects or arrays that contain non-\/string values relies on {\ttfamily JSON.\+parse()}. For legacy environments like IE ≤ 7, use \href{https://bestiejs.github.io/json3/}{\texttt{ a {\ttfamily JSON} polyfill}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9487}{}\doxysection{Author}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9487}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9488}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_jsesc_README_autotoc_md9488}
