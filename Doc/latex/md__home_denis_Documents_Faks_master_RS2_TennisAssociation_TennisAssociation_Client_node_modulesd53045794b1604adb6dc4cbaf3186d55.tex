\label{_overview}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16348}{}\doxysection{Overview}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16348}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16349}{}\doxysubsection{Finding problematic bits of code using grep}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16349}
Just run `grep -\/nrE '\mbox{[}$^\wedge$a-\/z\+A-\/Z\mbox{]}(Slow)?Buffer\textbackslash{}s$\ast$(\textquotesingle{} --exclude-\/dir node\+\_\+modules\`{}.

It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16350}{}\doxysubsection{Finding problematic bits of code using Node.\+js 8}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16350}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16351}{}\doxysubsection{Finding problematic bits of code using linters}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16351}
...
\label{_variant-1}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16352}{}\doxysection{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16352}
...
\label{_variant-2}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16353}{}\doxysection{Variant 2\+: Use a polyfill}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16353}
...
\label{_variant-3}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16354}{}\doxysection{Variant 3 — manual detection, with safeguards}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16354}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16355}{}\doxysubsection{Buffer(0)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16355}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16356}{}\doxysubsection{Buffer(not\+Number)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16356}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16357}{}\doxysubsection{Buffer(number)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16357}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16358}{}\doxysection{Regarding Buffer.\+alloc\+Unsafe}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16358}
...
\label{_faq}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16359}{}\doxysection{FAQ}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16359}
\label{_design-flaws}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16360}{}\doxysubsection{What is wrong with the $<$tt$>$\+Buffer$<$/tt$>$ constructor?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16360}
...
\label{_ecosystem-usage}%
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16361}{}\doxysubsection{The $<$tt$>$\+Buffer()$<$/tt$>$ constructor has been deprecated for a while. Is this really an issue?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesd53045794b1604adb6dc4cbaf3186d55_autotoc_md16361}
