...
Parses package name and specifier passed to commands like {\ttfamily npm install} or {\ttfamily npm cache add}, or as found in {\ttfamily package.\+json} dependency sections.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30902}{}\doxysection{EXAMPLES}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30902}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30903}{}\doxysection{USING}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30903}
`var npa = require(\textquotesingle{}npm-\/package-\/arg')\`{}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30904}{}\doxysubsection{var result = npa($<$em$>$arg$<$/em$>$\mbox{[}, $<$em$>$where$<$/em$>$\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30904}
...
\item {\itshape where} -\/ Optionally the path to resolve file paths relative to. Defaults to {\ttfamily \mbox{\hyperlink{namespaceupdate-gyp_a353f325a85a850b0456a7cbaff8fc43b}{process.\+cwd()}}}
\end{DoxyItemize}

{\bfseries{Throws}} if the package name is invalid, a dist-\/tag is invalid or a URL\textquotesingle{}s protocol is not supported.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30905}{}\doxysubsection{var result = npa.\+resolve($<$em$>$name$<$/em$>$, $<$em$>$spec$<$/em$>$\mbox{[}, $<$em$>$where$<$/em$>$\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30905}
...
{\bfseries{Throws}} if the package name is invalid, a dist-\/tag is invalid or a URL\textquotesingle{}s protocol is not supported.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30906}{}\doxysection{RESULT OBJECT}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_package_arg_README_autotoc_md30906}
