...
Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{ Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11916}{}\doxysection{Why?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11916}
...
Initially made for {\bfseries{\href{https://brunch.io/}{\texttt{ Brunch}}}} (an ultra-\/swift web app build tool), it is now used in \href{https://github.com/microsoft/vscode}{\texttt{ Microsoft\textquotesingle{}s Visual Studio Code}}, \href{https://github.com/gulpjs/gulp/}{\texttt{ gulp}}, \href{https://karma-runner.github.io/}{\texttt{ karma}}, \href{https://github.com/Unitech/PM2}{\texttt{ PM2}}, \href{http://browserify.org/}{\texttt{ browserify}}, \href{https://webpack.github.io/}{\texttt{ webpack}}, \href{https://www.browsersync.io/}{\texttt{ Browser\+Sync}}, and \href{https://www.npmjs.com/browse/depended/chokidar}{\texttt{ many others}}. It has proven itself in production environments.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11917}{}\doxysection{How?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11917}
...
On other platforms, the {\ttfamily fs.\+watch}-\/based implementation is the default, which avoids polling and keeps CPU usage down. Be advised that chokidar will initiate watchers recursively for everything within scope of the paths that have been specified, so be judicious about not wasting system resources by watching much more than needed.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11918}{}\doxysection{Getting started}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11918}
Install with npm\+:
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11919}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11919}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11920}{}\doxysubsubsection{Persistence}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11920}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11921}{}\doxysubsubsection{Path filtering}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11921}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11922}{}\doxysubsubsection{Performance}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11922}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11923}{}\doxysubsubsection{Errors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11923}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11924}{}\doxysubsection{Methods \& Events}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11924}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11925}{}\doxysection{CLI}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11925}
If you need a CLI interface for your file watching, check out \href{https://github.com/kimmobrunfeldt/chokidar-cli}{\texttt{ chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11926}{}\doxysection{Install Troubleshooting}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11926}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11927}{}\doxysection{Changelog}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11927}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11928}{}\doxysection{Also}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11928}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

$>$Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four).\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11929}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_chokidar_README_autotoc_md11929}
