\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31596}{}\doxysection{Methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31596}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31597}{}\doxysubsection{$<$tt$>$get\+Options$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31597}
...
\href{https://www.npmjs.com/package/clone}{\texttt{ clone}} is a good library to make a deep copy of the options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31598}{}\doxysubsubsection{Options as query strings}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31598}
If the loader options have been passed as loader query string ({\ttfamily loader?some\&params}), the string is parsed by using \href{\#parsequery}{\texttt{ {\ttfamily parse\+Query}}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31599}{}\doxysubsection{$<$tt$>$parse\+Query$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31599}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31600}{}\doxysubsection{$<$tt$>$stringify\+Request$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31600}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31601}{}\doxysubsection{$<$tt$>$url\+To\+Request$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31601}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31602}{}\doxysubsubsection{Module URLs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31602}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31603}{}\doxysubsubsection{Root-\/relative URLs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31603}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31604}{}\doxysubsection{$<$tt$>$interpolate\+Name$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31604}
...
\item {\ttfamily \mbox{[}$<$hash\+Type$>$\+:contenthash\+:$<$digest\+Type$>$\+:$<$length$>$\mbox{]}} optionally one can configure
\begin{DoxyItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{// loaderContext.resourcePath = "{}/app/js/javascript.js"{}}
...
\DoxyCodeLine{// => 🙍🏢📤🐝}
\DoxyCodeLine{}
\DoxyCodeLine{// loaderContext.resourcePath = "{}/app/img/image.png"{}}
...
\DoxyCodeLine{}
\DoxyCodeLine{// loaderContext.resourcePath = "{}/app/img/myself.png"{}}
...
\DoxyCodeLine{}
\DoxyCodeLine{// loaderContext.resourcePath = "{}/app/dir/file.png"{}}
...
\DoxyCodeLine{}
\DoxyCodeLine{// loaderContext.resourcePath = "{}/app/js/page-\/home.js"{}}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31605}{}\doxysubsection{$<$tt$>$get\+Hash\+Digest$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31605}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31606}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_loader_utils_README_autotoc_md31606}
