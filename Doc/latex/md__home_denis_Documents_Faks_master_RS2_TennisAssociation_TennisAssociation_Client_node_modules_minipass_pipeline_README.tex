...
Errors are proxied along the chain and emitted on the Pipeline stream.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8343}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8343}
...
Pipeline is a \href{http://npm.im/minipass}{\texttt{ minipass}} stream, so it\textquotesingle{}s as synchronous as the streams it wraps. It will buffer data until there is a reader, but no longer, so make sure to attach your listeners before you pipe it somewhere else.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8344}{}\doxysection{$<$tt$>$new Pipeline(opts = \{\}, ...\+streams)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8344}
Create a new Pipeline with the specified Minipass options and any streams provided.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8345}{}\doxysection{$<$tt$>$pipeline.\+push(stream, ...)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8345}
Attach one or more streams to the pipeline at the end (read) side of the pipe chain.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8346}{}\doxysection{$<$tt$>$pipeline.\+unshift(stream, ...)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_pipeline_README_autotoc_md8346}
