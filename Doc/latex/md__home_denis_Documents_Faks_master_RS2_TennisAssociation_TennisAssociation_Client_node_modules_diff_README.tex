...
Based on the algorithm proposed in \href{http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.4.6927}{\texttt{ \char`\"{}\+An O(\+ND) Difference Algorithm and its Variations\char`\"{} (Myers, 1986)}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22337}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22337}
...
\end{DoxyCode}
 or 
\begin{DoxyCode}{0}
\DoxyCodeLine{bower install jsdiff -\/-\/save}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22338}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22338}
...
All methods above which accept the optional {\ttfamily callback} method will run in sync mode when that parameter is omitted and in async mode when supplied. This allows for larger diffs without blocking the event loop. This may be passed either directly as the final parameter or as the {\ttfamily callback} field in the {\ttfamily options} object.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22339}{}\doxysubsection{Change Objects}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22339}
...
Note that some cases may omit a particular flag field. Comparison on the flag fields should always be done in a truthy or falsy manner.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22340}{}\doxysection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22340}
...
{\bfseries{\href{http://kpdecker.github.com/jsdiff}{\texttt{ Full online demo}}}}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22341}{}\doxysection{Compatibility}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22341}
\href{https://saucelabs.com/u/jsdiff}{\texttt{ }}

jsdiff supports all ES3 environments with some known issues on IE8 and below. Under these browsers some diff algorithms such as word diff and others may fail due to lack of support for capturing groups in the {\ttfamily split} operation.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22342}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_diff_README_autotoc_md22342}
