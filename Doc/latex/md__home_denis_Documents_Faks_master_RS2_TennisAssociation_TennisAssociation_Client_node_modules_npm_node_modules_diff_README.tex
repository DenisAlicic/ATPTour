...
Based on the algorithm proposed in \href{http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.4.6927}{\texttt{ \char`\"{}\+An O(\+ND) Difference Algorithm and its Variations\char`\"{} (Myers, 1986)}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15291}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15291}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install diff -\/-\/save}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15292}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15292}

\begin{DoxyItemize}
\item {\ttfamily Diff.\+diff\+Chars(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing character by character.
...
\end{DoxyItemize}
\item {\ttfamily Diff.\+diff\+Words(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing word by word, ignoring whitespace.
...
\end{DoxyItemize}
\item {\ttfamily Diff.\+diff\+Words\+With\+Space(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing word by word, treating whitespace as significant.

Returns a list of change objects (See below).
\item {\ttfamily Diff.\+diff\+Lines(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing line by line.
...
Returns a list of change objects (See below).
\item {\ttfamily Diff.\+diff\+Trimmed\+Lines(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing line by line, ignoring leading and trailing whitespace.

Returns a list of change objects (See below).
\item {\ttfamily Diff.\+diff\+Sentences(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing sentence by sentence.

Returns a list of change objects (See below).
\item {\ttfamily Diff.\+diff\+Css(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing CSS tokens.

Returns a list of change objects (See below).
\item {\ttfamily Diff.\+diff\+Json(old\+Obj, new\+Obj\mbox{[}, options\mbox{]})} -\/ diffs two JSON objects, comparing the fields defined on each. The order of fields, etc does not matter in this comparison.

Returns a list of change objects (See below).
\item {\ttfamily Diff.\+diff\+Arrays(old\+Arr, new\+Arr\mbox{[}, options\mbox{]})} -\/ diffs two arrays, comparing each item for strict equality (===).
...
Returns a list of change objects (See below).
\item {\ttfamily Diff.\+create\+Two\+Files\+Patch(old\+File\+Name, new\+File\+Name, old\+Str, new\+Str, old\+Header, new\+Header)} -\/ creates a unified diff patch.
...
\end{DoxyItemize}
\item {\ttfamily Diff.\+create\+Patch(file\+Name, old\+Str, new\+Str, old\+Header, new\+Header)} -\/ creates a unified diff patch.

Just like Diff.\+create\+Two\+Files\+Patch, but with old\+File\+Name being equal to new\+File\+Name.
\item {\ttfamily Diff.\+structured\+Patch(old\+File\+Name, new\+File\+Name, old\+Str, new\+Str, old\+Header, new\+Header, options)} -\/ returns an object with an array of hunk objects.
...
\item {\ttfamily Diff.\+apply\+Patch(source, patch\mbox{[}, options\mbox{]})} -\/ applies a unified diff patch.
...
All methods above which accept the optional {\ttfamily callback} method will run in sync mode when that parameter is omitted and in async mode when supplied. This allows for larger diffs without blocking the event loop. This may be passed either directly as the final parameter or as the {\ttfamily callback} field in the {\ttfamily options} object.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15293}{}\doxysubsection{Change Objects}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15293}
...
Note that some cases may omit a particular flag field. Comparison on the flag fields should always be done in a truthy or falsy manner.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15294}{}\doxysection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15294}
...
{\bfseries{\href{http://kpdecker.github.com/jsdiff}{\texttt{ Full online demo}}}}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15295}{}\doxysection{Compatibility}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15295}
\href{https://saucelabs.com/u/jsdiff}{\texttt{ }}

jsdiff supports all ES3 environments with some known issues on IE8 and below. Under these browsers some diff algorithms such as word diff and others may fail due to lack of support for capturing groups in the {\ttfamily split} operation.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15296}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_diff_README_autotoc_md15296}
