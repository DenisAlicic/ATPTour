Jobs is a high-\/order API that adds inputs, runtime type checking, sequencing, and other functionality on top of Rx\+JS\textquotesingle{} {\ttfamily Observable}s.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20328}{}\doxysection{Background}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20328}
...
This, of course, can be typed in Type\+Script, but those types are not enforced at runtime.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20329}{}\doxysection{Glossary}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20329}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20330}{}\doxysection{Description}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20330}
...
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20331}{}\doxysubsection{Diagram}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20331}
A simpler way to think about jobs in contrast to observables is that job are closer to a Unix process. It has an argument (command line flags), receive inputs (STDIN and interupt signals), and output values (STDOUT) as well as diagnostic (STDERR). They can be plugged one into another (piping), and can be transformed, synchronized and scheduled (fork, exec, cron).
...
\begin{DoxyEnumerate}
\item {\ttfamily Job\+Outbound\+Message\+Kind.\+Ready}. The {\ttfamily Job$<$$>$} was created, its dependencies are done, and the library is validating Argument and calling the internal job code.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
Utilities should have some filtering and dispatching to separate observables, as a convenience for the user. An example of this would be the {\ttfamily Job.\+prototype.\+output} observable which only contains the value contained by messages of type {\ttfamily Job\+Outbound\+Message\+Kind.\+Output}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20332}{}\doxysection{Higher Order Jobs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20332}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20333}{}\doxysection{Limitations}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules45334f07d430948b7c6911ff9fa4ddb8_autotoc_md20333}
