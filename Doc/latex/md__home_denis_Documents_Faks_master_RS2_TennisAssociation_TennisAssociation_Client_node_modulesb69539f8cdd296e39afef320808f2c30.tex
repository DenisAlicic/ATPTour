\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesb69539f8cdd296e39afef320808f2c30_autotoc_md10732}{}\doxysection{Example for SOCKS \textquotesingle{}associate\textquotesingle{} command}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesb69539f8cdd296e39afef320808f2c30_autotoc_md10732}
...
\begin{DoxyEnumerate}
\item Client -\/(associate)-\/$>$ Proxy (Tells the proxy to create a UDP relay and bind on a new port)
\item Client $<$-\/(port)-\/ Proxy (Tells the origin client which port it opened and is accepting UDP frame packets on)
\end{DoxyEnumerate}
...
\begin{DoxyEnumerate}
\item Client --(udp frame) -\/$>$ Proxy -\/$>$ Destination (The origin client sends a UDP frame to the proxy on the UDP port, and the proxy then forwards it to the destination specified in the UDP frame.)
\item Client $<$--(udp frame) $<$-- Proxy $<$-- Destination (The destination client responds to the udp packet sent in \#3)
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesb69539f8cdd296e39afef320808f2c30_autotoc_md10733}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesb69539f8cdd296e39afef320808f2c30_autotoc_md10733}
