...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31966}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31966}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install mime-\/db}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31967}{}\doxysubsection{Database Download}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31967}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31968}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31968}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31969}{}\doxysection{Data Structure}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31969}
...
If unknown, every property could be {\ttfamily undefined}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31970}{}\doxysection{Contributing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31970}
...
To update the build, run {\ttfamily npm run build}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31971}{}\doxysubsection{Adding Custom Media Types}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_mime_db_README_autotoc_md31971}
