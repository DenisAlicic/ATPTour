...
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24211}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24211}
Install with npm
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24212}{}\doxysection{Glob Primer}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24212}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24213}{}\doxysubsection{Dots}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24213}
...
You can make glob treat dots as normal characters by setting {\ttfamily dot\+:true} in the options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24214}{}\doxysubsection{Basename Matching}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24214}
If you set {\ttfamily match\+Base\+:true} in the options, and the pattern has no slashes in it, then it will seek for any file anywhere in the tree with a matching basename. For example, {\ttfamily $\ast$.js} would match {\ttfamily test/simple/basic.\+js}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24215}{}\doxysubsection{Empty Sets}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24215}
...
a*s*d*f
\end{DoxyVerb}
 To get the bash-\/style behavior, set the {\ttfamily nonull\+:true} in the options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24216}{}\doxysubsection{See Also\+:}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24216}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24217}{}\doxysection{glob.\+has\+Magic(pattern, \mbox{[}options\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24217}
Returns {\ttfamily true} if there are any special characters in the pattern, and {\ttfamily false} otherwise.

Note that the options affect the results. If {\ttfamily noext\+:true} is set in the options object, then {\ttfamily +(a$\vert$b)} will not be considered a magic pattern. If the pattern has a brace expansion, like {\ttfamily a/\{b/c,x/y\}} then that is considered magical, unless {\ttfamily nobrace\+:true} is set in the options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24218}{}\doxysection{glob(pattern, \mbox{[}options\mbox{]}, cb)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24218}
...
Perform an asynchronous glob search.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24219}{}\doxysection{glob.\+sync(pattern, \mbox{[}options\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24219}
...
Perform a synchronous glob search.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24220}{}\doxysection{Class\+: glob.\+Glob}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24220}
...
It\textquotesingle{}s an Event\+Emitter, and starts walking the filesystem to find matches immediately.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24221}{}\doxysubsection{new glob.\+Glob(pattern, \mbox{[}options\mbox{]}, \mbox{[}cb\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24221}
...
Note that if the {\ttfamily sync} flag is set in the options, then matches will be immediately available on the {\ttfamily g.\+found} member.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24222}{}\doxysubsection{Properties}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24222}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24223}{}\doxysubsection{Events}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24223}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24224}{}\doxysubsection{Methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24224}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24225}{}\doxysubsection{Options}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24225}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24226}{}\doxysection{Comparisons to other fnmatch/glob implementations}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24226}
...
If brace expansion is not disabled, then it is performed before any other interpretation of the glob pattern. Thus, a pattern like {\ttfamily +(a$\vert$\{b),c)\}}, which would not be valid in bash or zsh, is expanded {\bfseries{first}} into the set of {\ttfamily +(a$\vert$b)} and {\ttfamily +(a$\vert$c)}, and those patterns are checked for validity. Since those two are valid, matching proceeds.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24227}{}\doxysubsection{Comments and Negation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24227}
...
To specify things that should not match, use the {\ttfamily ignore} option.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24228}{}\doxysection{Windows}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24228}
...
Results from absolute patterns such as {\ttfamily /foo/$\ast$} are mounted onto the root setting using {\ttfamily path.\+join}. On windows, this will by default result in {\ttfamily /foo/$\ast$} matching {\ttfamily C\+:\textbackslash{}foo\textbackslash{}bar.\+txt}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24229}{}\doxysection{Race Conditions}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24229}
...
Users are thus advised not to use a glob result as a guarantee of filesystem state in the face of rapid changes. For the vast majority of operations, this is never a problem.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24230}{}\doxysection{Glob Logo}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_glob_README_autotoc_md24230}
