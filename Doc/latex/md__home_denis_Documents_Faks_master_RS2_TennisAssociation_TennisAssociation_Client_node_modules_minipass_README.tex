...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8008}{}\doxysection{Differences from Node.\+js Streams}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8008}
There are several things that make Minipass streams different from (and in some ways superior to) Node.\+js core streams.

Please read these caveats if you are familiar with noode-\/core streams and intend to use Minipass streams in your programs.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8009}{}\doxysubsection{Timing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8009}
...
This non-\/deferring approach makes Minipass streams much easier to reason about, especially in the context of Promises and other flow-\/control mechanisms.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8010}{}\doxysubsection{No High/\+Low Water Marks}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8010}
...
If the data has nowhere to go, then {\ttfamily write()} returns false, and the data sits in a buffer, to be drained out immediately as soon as anyone consumes it.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8011}{}\doxysubsection{Hazards of Buffering (or\+: Why Minipass Is So Fast)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8011}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8012}{}\doxysubsection{Immediately emit $<$tt$>$end$<$/tt$>$ for empty streams (when not paused)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8012}
...
If you have logic that occurs on the {\ttfamily end} event which you don\textquotesingle{}t want to potentially happen immediately (for example, closing file descriptors, moving on to the next entry in an archive parse stream, etc.) then be sure to call {\ttfamily stream.\+pause()} on creation, and then {\ttfamily stream.\+resume()} once you are ready to respond to the {\ttfamily end} event.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8013}{}\doxysubsection{Emit $<$tt$>$end$<$/tt$>$ When Asked}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8013}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8014}{}\doxysubsection{Impact of \char`\"{}immediate flow\char`\"{} on Tee-\/streams}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8014}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8015}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8015}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8016}{}\doxysubsection{OPTIONS}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8016}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8017}{}\doxysubsection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8017}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8018}{}\doxysubsection{Methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8018}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8019}{}\doxysubsection{Properties}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8019}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8020}{}\doxysubsection{Events}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8020}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8021}{}\doxysubsection{Static Methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8021}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8022}{}\doxysection{EXAMPLES}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8022}
Here are some examples of things you can do with Minipass streams.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8023}{}\doxysubsection{simple \char`\"{}are you done yet\char`\"{} promise}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8023}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8024}{}\doxysubsection{collecting}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8024}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8025}{}\doxysubsection{collecting into a single blob}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8025}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8026}{}\doxysubsection{iteration}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8026}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8027}{}\doxysubsection{subclass that $<$tt$>$console.\+log()$<$/tt$>$s everything written into it}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8027}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8028}{}\doxysubsection{same thing, but using an inline anonymous class}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8028}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8029}{}\doxysubsection{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8029}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8030}{}\doxysubsection{transform that creates newline-\/delimited JSON}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8030}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8031}{}\doxysubsection{transform that parses newline-\/delimited JSON}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_README_autotoc_md8031}
