A tiny, fast Java\+Script parser written in Java\+Script.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7563}{}\doxysection{Community}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7563}
...
You are welcome to \href{https://github.com/acornjs/acorn/issues}{\texttt{ report bugs}} or create pull requests on \href{https://github.com/acornjs/acorn}{\texttt{ github}}. For questions and discussion, please use the \href{https://discuss.ternjs.net}{\texttt{ Tern discussion forum}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7564}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7564}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7565}{}\doxysection{Interface}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7565}
...
\begin{DoxyItemize}
\item {\bfseries{ecma\+Version}}\+: Indicates the ECMAScript version to parse. Must be either 3, 5, 6 (2015), 7 (2016), 8 (2017), 9 (2018) or 10 (2019, partial support). This influences support for strict mode, the set of reserved words, and support for new syntax features. Default is 9.
...
{\bfseries{get\+Line\+Info}}{\ttfamily (input, offset)} can be used to get a {\ttfamily \{line, column\}} object for a given program string and offset.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7566}{}\doxysubsection{The $<$tt$>$\+Parser$<$/tt$>$ class}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7566}
...
The {\ttfamily extend} method takes any number of plugin values, and returns a new {\ttfamily Parser} class that includes the extra parser logic provided by the plugins.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7567}{}\doxysection{Command line interface}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7567}
...
The utility spits out the syntax tree as JSON data.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7568}{}\doxysection{Existing plugins}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_acorn_README_autotoc_md7568}
...
\item \href{https://github.com/acornjs/acorn-numeric-separator}{\texttt{ {\ttfamily acorn-\/numeric-\/separator}}}\+: Parse \href{https://github.com/tc39/proposal-numeric-separator}{\texttt{ numeric separator proposal}}
