...
It also provides an abstraction for handling \href{https://html.spec.whatwg.org/multipage/comms.html\#server-sent-events}{\texttt{ Event\+Source}} connections, which are one-\/way connections that allow the server to push data to the client. They are based on streaming HTTP responses and can be easier to access via proxies than Web\+Sockets.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6515}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6515}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install faye-\/websocket}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6516}{}\doxysection{Handling Web\+Socket connections in Node}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6516}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6517}{}\doxysection{Using the Web\+Socket client}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6517}
...
The {\ttfamily tls} value is an object that will be passed to \href{https://nodejs.org/api/tls.html\#tls_tls_connect_options_callback}{\texttt{ {\ttfamily tls.\+connect()}}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6518}{}\doxysection{Subprotocol negotiation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6518}
...
If the client and server agree on a protocol, both the client-\/ and server-\/side socket objects expose the selected protocol through the {\ttfamily ws.\+protocol} property.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6519}{}\doxysection{Protocol extensions}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6519}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6520}{}\doxysection{Initialization options}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6520}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6521}{}\doxysection{Web\+Socket API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6521}
...
\item $\ast$$\ast$`on(\textquotesingle{}message', function(event) \{\}){\ttfamily $\ast$$\ast$ fires when the socket receives a message. Event has one attribute, $\ast$$\ast$}data{\ttfamily $\ast$$\ast$, which is either a}String{\ttfamily (for text frames) or a}Buffer$<$tt$>$(for binary frames).
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6522}{}\doxysection{Handling Event\+Source connections in Node}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules825396cd96b4bbdb2ce60925ada8b00c_autotoc_md6522}
