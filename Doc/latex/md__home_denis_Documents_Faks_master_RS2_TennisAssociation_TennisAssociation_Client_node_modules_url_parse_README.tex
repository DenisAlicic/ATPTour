\href{http://unshift.io}{\texttt{ }}\href{https://www.npmjs.com/package/url-parse}{\texttt{ }}\href{https://travis-ci.org/unshiftio/url-parse}{\texttt{ }}\href{https://david-dm.org/unshiftio/url-parse}{\texttt{ }}\href{https://coveralls.io/r/unshiftio/url-parse?branch=master}{\texttt{ }}\href{https://webchat.freenode.net/?channels=unshift}{\texttt{ }}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10446}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10446}
...
\item {\ttfamily base\+URL} ({\ttfamily Object} $\vert$ {\ttfamily String})\+: An object or string representing the base URL to use in case {\ttfamily url} is a relative URL. This argument is optional and defaults to \href{https://developer.mozilla.org/en-US/docs/Web/API/Location}{\texttt{ {\ttfamily location}}} in the browser.
...
\item {\ttfamily hash}\+: The \char`\"{}fragment\char`\"{} portion of the URL including the pound-\/sign ({\ttfamily \#}).
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10447}{}\doxysubsection{Url.\+set(key, value)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10447}
...
It\textquotesingle{}s aware of default ports so you cannot set a port 80 on an URL which has {\ttfamily http} as protocol.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10448}{}\doxysubsection{Url.\+to\+String()}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10448}
...
You would rarely need to use this method as the full URL is also available as {\ttfamily href} property. If you are using the {\ttfamily URL.\+set} method to make changes, this will automatically update.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10449}{}\doxysection{Testing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10449}
...
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10450}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_url_parse_README_autotoc_md10450}
