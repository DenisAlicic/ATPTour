...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21463}{}\doxysection{What is Sock\+JS?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21463}
Sock\+JS is a Java\+Script library (for browsers) that provides a Web\+Socket-\/like object. Sock\+JS gives you a coherent, cross-\/browser, Javascript API which creates a low latency, full duplex, cross-\/domain communication channel between the browser and the web server, with Web\+Sockets or without. This necessitates the use of a server, which this is one version of, for Node.\+js.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21464}{}\doxysection{Sock\+JS-\/node server}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21464}
...
Subscribe to \href{https://groups.google.com/forum/\#!forum/sockjs}{\texttt{ Sock\+JS mailing list}} for discussions and support.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21465}{}\doxysubsection{Sock\+JS-\/node API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21465}
The API design is based on common Node APIs like the \href{http://nodejs.org/docs/v0.5.8/api/streams.html}{\texttt{ Streams API}} or the \href{http://nodejs.org/docs/v0.5.8/api/http.html\#http.Server}{\texttt{ Http.\+Server API}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21466}{}\doxysubsubsection{Server class}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21466}
...
\end{DoxyDescription}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21467}{}\doxysubsubsection{Server instance}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21467}
...
All http requests that don\textquotesingle{}t go under the path selected by {\ttfamily prefix} will remain unanswered and will be passed to previously registered handlers. You must install your custom http handlers before calling {\ttfamily install\+Handlers}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21468}{}\doxysubsubsection{Connection instance}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21468}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21469}{}\doxysubsubsection{Footnote}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21469}
A fully working echo server does need a bit more boilerplate (to handle requests unanswered by Sock\+JS), see the \href{https://github.com/sockjs/sockjs-node/tree/master/examples/echo}{\texttt{ {\ttfamily echo} example}} for a complete code.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21470}{}\doxysubsubsection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21470}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21471}{}\doxysubsection{Connecting to Sock\+JS-\/node without the client}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21471}
...
Note\+: This endpoint will {\itshape not send any heartbeat packets}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21472}{}\doxysubsection{Deployment and load balancing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21472}
There are two issues that need to be considered when planning a non-\/trivial Sock\+JS-\/node deployment\+: Web\+Socket-\/compatible load balancer and sticky sessions (aka session affinity).\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21473}{}\doxysubsubsection{Web\+Socket compatible load balancer}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21473}
...
The config also shows how to use HAproxy balancing to split traffic between multiple Node.\+js servers. You can also do balancing using dns names.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21474}{}\doxysubsubsection{Sticky sessions}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21474}
...
\begin{DoxyItemize}
\item Urls are prefixed with server and session id numbers, like\+: {\ttfamily /resource/$<$server\+\_\+number$>$/$<$session\+\_\+id$>$/transport}. This is useful for load balancers that support prefix-\/based affinity (HAProxy does).
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21475}{}\doxysubsection{Development and testing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21475}
...
\end{DoxyVerb}
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21476}{}\doxysubsubsection{Sock\+JS-\/protocol Python tests}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21476}
To run it run something like\+: \begin{DoxyVerb}cd sockjs-protocol
make test_deps
./venv/bin/python sockjs-protocol.py
\end{DoxyVerb}
 For details see \href{https://github.com/sockjs/sockjs-protocol\#readme}{\texttt{ Sock\+JS-\/protocol README}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21477}{}\doxysubsubsection{Sock\+JS-\/client QUnit tests}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21477}
...
Additionally, if you\textquotesingle{}re doing more serious development consider using {\ttfamily make serve}, which will automatically the server when you modify the source code.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21478}{}\doxysubsection{Various issues and design considerations}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21478}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21479}{}\doxysubsubsection{Authorisation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21479}
...
Basically -\/ cookies are not suited for Sock\+JS model. If you want to authorise a session -\/ provide a unique token on a page, send it as a first thing over Sock\+JS connection and validate it on the server side. In essence, this is how cookies work.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21480}{}\doxysubsubsection{Deploying Sock\+JS on Heroku}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_sockjs_README_autotoc_md21480}
