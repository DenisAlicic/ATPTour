...
Supports pipe()ing (including multi-\/pipe() and backpressure transmission), buffering data until either a {\ttfamily data} event handler or {\ttfamily pipe()} is added (so you don\textquotesingle{}t lose the first chunk), and most other cases where Pass\+Through is a good idea.
...
\item \href{http://npm.im/tap}{\texttt{ tap-\/parser}}
\item \href{http://npm.im/tap}{\texttt{ treport}}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22602}{}\doxysection{Differences from Node.\+js Streams}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22602}
There are several things that make Minipass streams different from (and in some ways superior to) Node.\+js core streams.

Please read these caveats if you are familiar with noode-\/core streams and intend to use Minipass streams in your programs.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22603}{}\doxysubsection{Timing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22603}
...
This non-\/deferring approach makes Minipass streams much easier to reason about, especially in the context of Promises and other flow-\/control mechanisms.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22604}{}\doxysubsection{No High/\+Low Water Marks}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22604}
...
If the data has nowhere to go, then {\ttfamily write()} returns false, and the data sits in a buffer, to be drained out immediately as soon as anyone consumes it.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22605}{}\doxysubsection{Hazards of Buffering (or\+: Why Minipass Is So Fast)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22605}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22606}{}\doxysubsection{Immediately emit $<$tt$>$end$<$/tt$>$ for empty streams (when not paused)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22606}
...
If you have logic that occurs on the {\ttfamily end} event which you don\textquotesingle{}t want to potentially happen immediately (for example, closing file descriptors, moving on to the next entry in an archive parse stream, etc.) then be sure to call {\ttfamily stream.\+pause()} on creation, and then {\ttfamily stream.\+resume()} once you are ready to respond to the {\ttfamily end} event.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22607}{}\doxysubsection{Emit $<$tt$>$end$<$/tt$>$ When Asked}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22607}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22608}{}\doxysubsection{Impact of \char`\"{}immediate flow\char`\"{} on Tee-\/streams}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22608}
...
\DoxyCodeLine{stream.pipe(tee) // tee gets 'foo', pipes to both locations}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22609}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22609}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22610}{}\doxysubsection{OPTIONS}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22610}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22611}{}\doxysubsection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22611}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22612}{}\doxysubsection{Methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22612}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22613}{}\doxysubsection{Properties}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22613}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22614}{}\doxysubsection{Events}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22614}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22615}{}\doxysubsection{Static Methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22615}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22616}{}\doxysection{EXAMPLES}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22616}
Here are some examples of things you can do with Minipass streams.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22617}{}\doxysubsection{simple \char`\"{}are you done yet\char`\"{} promise}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22617}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22618}{}\doxysubsection{collecting}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22618}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22619}{}\doxysubsection{collecting into a single blob}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22619}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22620}{}\doxysubsection{iteration}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22620}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22621}{}\doxysubsection{subclass that $<$tt$>$console.\+log()$<$/tt$>$s everything written into it}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22621}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22622}{}\doxysubsection{same thing, but using an inline anonymous class}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22622}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22623}{}\doxysubsection{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22623}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22624}{}\doxysubsection{transform that creates newline-\/delimited JSON}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22624}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22625}{}\doxysubsection{transform that parses newline-\/delimited JSON}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules06582db2e2862c14f187f4ca2dd4545a_autotoc_md22625}
...
\DoxyCodeLine{      let parsed}
\DoxyCodeLine{      try \{}
\DoxyCodeLine{        super.write(parsed)}
\DoxyCodeLine{      \} catch (er) \{}
\DoxyCodeLine{        this.emit('error', er)}
