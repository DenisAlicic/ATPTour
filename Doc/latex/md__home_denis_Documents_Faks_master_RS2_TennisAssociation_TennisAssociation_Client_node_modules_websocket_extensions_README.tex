...
{\ttfamily websocket-\/extensions} provides a container for registering extension plugins, and provides all the functions required to negotiate which extensions to use during a session via the {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} header. By implementing the APIs defined in this document, an extension may be used by any Web\+Socket library based on this framework.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27085}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27085}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install websocket-\/extensions}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27086}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27086}
...
The library is designed with the aim that any protocol implementation and any extension can be used together, so long as they support the same abstract representation of frames and messages.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27087}{}\doxysubsection{Data types}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27087}
The APIs provided by the framework rely on two data types; extensions will expect to be given data and to be able to return data in these formats\+:\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27088}{}\doxysubsubsection{$<$em$>$\+Frame$<$/em$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27088}
...
\end{longtabu}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27089}{}\doxysubsubsection{$<$em$>$\+Message$<$/em$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27089}
...
\end{longtabu}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27090}{}\doxysubsection{For driver authors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27090}
...
In the following examples, {\ttfamily exts} refers to this {\ttfamily Extensions} instance.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27091}{}\doxysubsubsection{Client sessions}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27091}
...
If the server has sent any extension responses that the client does not recognize, or are in conflict with one another for use of RSV bits, or that use invalid parameters for the named extensions, then {\ttfamily exts.\+activate()} will {\ttfamily throw}. In this event, the client driver should fail the connection with closing code {\ttfamily 1010}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27092}{}\doxysubsubsection{Server sessions}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27092}
...
Calling {\ttfamily exts.\+generate\+Response(header)} activates those extensions the client has asked to use, if they are registered, asks each extension for a set of response parameters, and returns a string containing the response parameters for all accepted extensions.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27093}{}\doxysubsubsection{In both directions}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27093}
...
The callback is invoked when all extensions have finished processing any messages in the pipeline and it\textquotesingle{}s safe to close the socket.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27094}{}\doxysubsection{For extension authors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27094}
...
The extension must decide which set of parameters it wants to accept, if any, and return a {\itshape Server\+Session} if it wants to accept the parameters and {\ttfamily null} otherwise.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27095}{}\doxysubsubsection{$<$em$>$\+Client\+Session$<$/em$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27095}
...
This returns the set of parameters the server session wants to send in its {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} response header. Only one set of parameters is returned to the client per extension. Server sessions that would confict on their use of RSV bits are not activated.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27097}{}\doxysubsubsection{$<$em$>$\+Session$<$/em$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27097}
...
The framework will call this method when the Web\+Socket session ends, allowing the session to release any resources it\textquotesingle{}s using.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27098}{}\doxysection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_websocket_extensions_README_autotoc_md27098}
