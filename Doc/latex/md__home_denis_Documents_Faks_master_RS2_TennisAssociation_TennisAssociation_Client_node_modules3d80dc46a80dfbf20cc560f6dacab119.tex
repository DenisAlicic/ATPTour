\href{https://npmjs.org/package/agentkeepalive}{\texttt{ }} \href{https://snyk.io/test/npm/agentkeepalive}{\texttt{ }} \href{https://npmjs.org/package/agentkeepalive}{\texttt{ }}

The enhancement features {\ttfamily keep alive} {\ttfamily http.\+Agent}. Support {\ttfamily http} and {\ttfamily https}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14835}{}\doxysection{What\textquotesingle{}s different from original $<$tt$>$http.\+Agent$<$/tt$>$?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14835}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14836}{}\doxysection{Node.\+js version required}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14836}
Support Node.\+js $>$= {\ttfamily 8.\+0.\+0}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14837}{}\doxysection{Install}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14837}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install agentkeepalive -\/-\/save}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14838}{}\doxysection{new Agent(\mbox{[}options\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14838}
...
\item {\ttfamily free\+Socket\+Timeout}\+: \{Number\} Sets the free socket to timeout after {\ttfamily free\+Socket\+Timeout} milliseconds of inactivity on the free socket. Default is {\ttfamily 15000}. Only relevant if {\ttfamily keep\+Alive} is set to {\ttfamily true}.
\item {\ttfamily timeout}\+: \{Number\} Sets the working socket to timeout after {\ttfamily timeout} milliseconds of inactivity on the working socket. Default is {\ttfamily free\+Socket\+Timeout $\ast$ 2}.
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14839}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14839}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14840}{}\doxysubsection{$<$tt$>$getter agent.\+status\+Changed$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14840}
counters have change or not after last checkpoint.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14841}{}\doxysubsection{$<$tt$>$agent.\+get\+Current\+Status()$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14841}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14842}{}\doxysubsection{Support $<$tt$>$https$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14842}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14843}{}\doxysubsection{Support $<$tt$>$req.\+reused\+Socket$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14843}
...
This behavior is consistent with Node.\+js core. But through {\ttfamily agentkeepalive}, you can use this feature in older Node.\+js version.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14844}{}\doxysection{$<$a href=\char`\"{}https\+://github.\+com/node-\/modules/agentkeepalive/tree/master/benchmark\char`\"{}$>$\+Benchmark$<$/a$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14844}
run the benchmark\+:
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14845}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d80dc46a80dfbf20cc560f6dacab119_autotoc_md14845}
