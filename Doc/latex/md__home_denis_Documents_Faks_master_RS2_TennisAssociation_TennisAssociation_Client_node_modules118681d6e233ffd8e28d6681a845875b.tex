...
Jobs are lazy, cold, and guaranteed to execute exactly once when scheduled. Subscribing to a job returns messages from the point where the job is at.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20306}{}\doxysection{Argument, Input, Output and Channels}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20306}
...
The I/O model is like that of an executable, where the argument corresponds to arguments on the command line, the input channel to STDIN, the output channel to STDOUT, and the channels would be additional output streams.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20307}{}\doxysection{Life\+Cycle}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20307}
...
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily Job\+State.\+Ready}. The job\textquotesingle{}s dependencies (see \href{\#Dependencies}{\texttt{ \char`\"{}\+Synchronizing and Dependencies\char`\"{}}}) are done running, the argument is validated, and the job is ready to execute.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
The {\ttfamily Queued} state is set as the job is scheduled, so there is no need to listen for the message.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20308}{}\doxysection{$<$tt$>$\+Job$<$\+Output\+Type$>$$<$/tt$>$ Object}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20308}
...
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily output}. An {\ttfamily Observable$<$Output\+Type$>$} that filters out messages to get only the returned output of a job.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily inbound\+Bus}. The raw input {\ttfamily Observer$<$Job\+Inbound\+Message$>$}. This can be used to send messages to the {\ttfamily context.\+inbound\+Bus} observable in the job. These are {\ttfamily Job\+Inbound\+Message} messages. See \href{\#Communicating}{\texttt{ \char`\"{}\+Communicating With Jobs\char`\"{}}}.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily outbound\+Bus}. The raw output {\ttfamily Observable$<$Job\+Output$>$}. This can be used to listen to messages from the job. See \href{\#Communicating}{\texttt{ \char`\"{}\+Communicating With Jobs\char`\"{}}}.
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20309}{}\doxysection{$<$tt$>$\+Job\+Handler\+Context$<$\+I, O$>$$<$/tt$>$ Object}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20309}
The {\ttfamily Job\+Handler\+Context$<$$>$} is passed to the job handler code in addition to its argument. The context contains the following members\+:
...
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily scheduler}. A {\ttfamily Scheduler$<$$>$} instance that can be used to create additional jobs.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily dependencies}. A generic list of other job instances that were run as dependencies when scheduling this job. Their {\ttfamily id} is not guaranteed to match the {\ttfamily id} of the {\ttfamily Job$<$$>$} instance itself (those {\ttfamily Job$<$$>$}s might just be proxies). The state of those {\ttfamily Job$<$$>$} is guaranteed to be {\ttfamily Job\+State.\+Ended}, as {\ttfamily Job\+State.\+Errored} would have prevented this handler from running.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item {\ttfamily inbound\+Bus}. The raw input observable, complement of the {\ttfamily inbound\+Bus} observer from the {\ttfamily Job$<$$>$}.
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20310}{}\doxysection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20310}
...
\DoxyCodeLine{}
\DoxyCodeLine{const add = jobs.createJobHandle<number[], number>(}
\DoxyCodeLine{  input => input.reduce((total, curr) => total + curr, 0),}
\DoxyCodeLine{);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{scheduler.schedule('add', [1, 2, 3, 4]).promise}
\DoxyCodeLine{  .then(output => console.log('1 + 2 + 3 + 4 is ' + output));}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20311}{}\doxysection{Creating Jobs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20311}
...
\DoxyCodeLine{  type: 'array', items: \{ type: 'number' \},}
\DoxyCodeLine{\};}
...
\DoxyCodeLine{    .output.subscribe(x => console.log(x));  // Will output 10.}
...
\DoxyCodeLine{export const add = jobs.createJobHandler<number[], number>(}
\DoxyCodeLine{  argument => argument.reduce((total, curr) => total + curr, 0),}
\DoxyCodeLine{);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  (argument: number, \{ createChannel \}) => new Observable<number>(o => \{}
...
\DoxyCodeLine{job.getChannel<number>('progress', \{ type: 'number' \}).subscribe(x => console.log(x));}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20312}{}\doxysubsection{$<$a name=\char`\"{}\+Communicating\char`\"{}$>$$<$/a$>$\+Communicating With Jobs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20312}
Jobs can be started and updated in a separate process or thread, and as such communication with a job should avoid using global objects (which might not be shared). The jobs API and schedulers provide 2 communication streams (one for input and the other for output), named {\ttfamily inbound\+Bus} and {\ttfamily outbound\+Bus}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20313}{}\doxysubsubsection{Raw Input Stream}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20313}
The {\ttfamily schedule()} function returns a {\ttfamily Job$<$$>$} interface that contains a {\ttfamily inbound\+Bus} member of type {\ttfamily Observer$<$Job\+Inbound\+Message$>$}. All messages sent {\itshape to} the job goes through this stream. The {\ttfamily kind} member of the {\ttfamily Job\+Inbound\+Message} interface dictates what kind of message it is sending\+:
...
Using the {\ttfamily create\+Job\+Handler()} helper, all those messages are automatically handled by the boilerplate code. If you need direct access to raw inputs, you should subscribe to the {\ttfamily context.\+inbound\+Bus} Observable.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20314}{}\doxysubsubsection{Raw Output Stream}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20314}
The {\ttfamily Job$<$$>$} interface also contains a {\ttfamily outbound\+Bus} member (of type {\ttfamily Observable$<$Job\+Outbound\+Message$<$O$>$$>$} where {\ttfamily O} is the typed output of the job) which is the output complement of {\ttfamily inbound\+Bus}. All messages sent {\itshape from} the job goes through this stream. The {\ttfamily kind} member of the {\ttfamily Job\+Outbound\+Message$<$O$>$} interface dictates what kind of message it is sending\+:


\begin{DoxyEnumerate}
\item {\ttfamily Job\+Outbound\+Message\+Kind.\+Create}. The {\ttfamily Job$<$$>$} was created, its dependencies are done, and the library is validating Argument and calling the internal job code.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
Those messages can be accessed directly through the {\ttfamily job.\+outbound\+Bus} member. The job itself should return an {\ttfamily Observable$<$Job\+Outbound\+Message$<$O$>$$>$}. The {\ttfamily create\+Job\+Handler()} helper handles most of use cases of this and makes it easier for jobs to handle this.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20315}{}\doxysubsection{Job Dispatchers}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20315}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20316}{}\doxysubsection{Execution Strategy}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20316}
...
\DoxyCodeLine{  jobs.createJobHandler<number[], number>(}
\DoxyCodeLine{      argument => argument.reduce((total, curr) => total + curr, 0),}
\DoxyCodeLine{  ),}
\DoxyCodeLine{);}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20317}{}\doxysection{Scheduling Jobs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20317}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20318}{}\doxysubsection{$<$a name=\char`\"{}\+Dependencies\char`\"{}$>$$<$/a$>$\+Synchronizing and Dependencies}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20318}
...
An example of this would be a compiler that needs to know the output directory of other compilers before it, in a tool chain.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20319}{}\doxysubsubsection{Dependencies}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20319}
When scheduling jobs, the user can add a {\ttfamily dependencies} field to the scheduling options. The scheduler will wait for those dependencies to finish before running the job, and pass those jobs in the context of the job.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20320}{}\doxysubsubsection{Accessing Dependencies}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20320}
Jobs are called with a {\ttfamily Job\+Handler\+Context} as a second argument, which contains a {\ttfamily dependencies\+: Job$<$Json\+Value$>$\mbox{[}\mbox{]}} member which contains all dependencies that were used when scheduling the job. Those aren\textquotesingle{}t fully typed as they are determined by the user, and not the job itself. They also can contain jobs that are not finished, and the job should use the {\ttfamily state} member of the job itself before trying to access its content.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20321}{}\doxysubsubsection{Scheduler Sub Jobs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20321}
The {\ttfamily Job\+Handler\+Context} also contains a {\ttfamily scheduler} member which can be used to schedule jobs using the same scheduler that was used for the job. This allows jobs to call other jobs and wait for them to end.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20322}{}\doxysubsection{Available Schedulers}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20322}
The Core Angular Dev\+Kit library provides 2 implementations for the {\ttfamily Scheduler} interface\+:\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20323}{}\doxysubsection{Simple\+Job\+Registry}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20323}
...
\DoxyCodeLine{import \{ jobs \} from '@angular-\/devkit/core';}
\DoxyCodeLine{}
\DoxyCodeLine{const add = jobs.createJobHandler<number[], number>(}
\DoxyCodeLine{  argument => argument.reduce((total, curr) => total + curr, 0),}
\DoxyCodeLine{);}
\DoxyCodeLine{}
\DoxyCodeLine{// Register the job in a SimpleJobRegistry. Different registries have different API.}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20324}{}\doxysubsection{Node\+Module\+Job\+Registry}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20324}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20325}{}\doxysection{Gotchas}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20325}
...
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20326}{}\doxysection{FAQ}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules118681d6e233ffd8e28d6681a845875b_autotoc_md20326}
