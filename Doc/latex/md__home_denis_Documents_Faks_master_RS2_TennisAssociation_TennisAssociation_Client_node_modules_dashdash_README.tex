...
Follow \href{https://twitter.com/intent/user?screen_name=trentmick}{\texttt{ @trentmick}} for updates to node-\/dashdash.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10937}{}\doxysection{Install}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10937}
\begin{DoxyVerb}npm install dashdash
\end{DoxyVerb}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10938}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10938}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10939}{}\doxysection{Longer Example}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10939}
...
See the \href{examples/}{\texttt{ \char`\"{}examples\char`\"{}}} dir for a number of starter examples using some of dashdash\textquotesingle{}s features.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10940}{}\doxysection{Environment variable integration}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10940}
...
\end{DoxyVerb}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10941}{}\doxysection{Bash completion}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10941}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10942}{}\doxysection{Parser config}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10942}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10943}{}\doxysection{Option specs}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10943}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10944}{}\doxysection{Option group headings}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10944}
...
Note\+: You can use an empty string, `\{group\+: '\textquotesingle{}\}\`{}, to get a blank line in help output between groups of options.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10945}{}\doxysection{Help config}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10945}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10946}{}\doxysection{Custom option types}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10946}
...
var opts = dashdash.parse({options: options});
\end{DoxyVerb}
 See \char`\"{}examples/custom-\/option-\/\textbackslash{}$\ast$.\+js\char`\"{} for other examples. See the {\ttfamily add\+Option\+Type} block comment in \char`\"{}lib/dashdash.\+js\char`\"{} for more details. Please let me know \href{https://github.com/trentm/node-dashdash/issues/new}{\texttt{ with an issue}} if you write a generally useful one.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10947}{}\doxysection{Why}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10947}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10948}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_dashdash_README_autotoc_md10948}
MIT. See LICENSE.\+txt. 