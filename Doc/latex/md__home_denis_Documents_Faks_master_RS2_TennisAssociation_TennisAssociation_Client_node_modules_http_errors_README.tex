...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2234}{}\doxysection{Install}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2234}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2235}{}\doxysection{Example}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2235}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2236}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2236}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2237}{}\doxysubsection{Error Properties}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2237}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2238}{}\doxysubsection{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2238}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2239}{}\doxysubsection{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2239}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2240}{}\doxysubsection{new create\+Error\mbox{[}code $\vert$$\vert$ name\mbox{]}(\mbox{[}msg\mbox{]}))}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2240}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2241}{}\doxysubsubsection{List of all constructors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2241}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2242}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_http_errors_README_autotoc_md2242}
