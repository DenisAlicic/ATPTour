...
The complete solution for \href{http://nodejs.org}{\texttt{ node.\+js}} command-\/line interfaces, inspired by Ruby\textquotesingle{}s \href{https://github.com/commander-rb/commander}{\texttt{ commander}}. ~\newline
 \href{http://tj.github.com/commander.js/}{\texttt{ API documentation}}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21548}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21548}
\begin{DoxyVerb}$ npm install commander
\end{DoxyVerb}
 \hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21549}{}\doxysection{Option parsing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21549}
...
{\bfseries{NOTE}}\+: If you pass a argument without using brackets the example above will return true and not the value passed in.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21550}{}\doxysection{Version option}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21550}
...
The version flags can be named anything, but the long option is required.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21551}{}\doxysection{Command-\/specific options}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21551}
...
A command\textquotesingle{}s options are validated when the command is used. Any unknown options will be reported as an error. However, if an action-\/based command does not define an action, then the options are not validated.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21552}{}\doxysection{Coercion}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21552}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21553}{}\doxysection{Regular Expression}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21553}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21554}{}\doxysection{Variadic arguments}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21554}
...
An {\ttfamily Array} is used for the value of a variadic argument. This applies to {\ttfamily program.\+args} as well as the argument passed to your action as demonstrated above.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21555}{}\doxysection{Specify the argument syntax}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21555}
...
\end{DoxyCode}
 Angled brackets (e.\+g. {\ttfamily $<$cmd$>$}) indicate required input. Square brackets (e.\+g. {\ttfamily \mbox{[}env\mbox{]}}) indicate optional input.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21556}{}\doxysection{Git-\/style sub-\/commands}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21556}
...
Options can be passed with the call to {\ttfamily .\mbox{\hyperlink{namespacegyp_1_1generator_1_1cmake_a3de86707eee30a1d0d8c4ee365485ecb}{command()}}}. Specifying {\ttfamily true} for {\ttfamily opts.\+no\+Help} will remove the subcommand from the generated help output. Specifying {\ttfamily true} for {\ttfamily opts.\+is\+Default} will run the subcommand if no other subcommand is specified.

If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21557}{}\doxysubsection{$<$tt$>$-\/-\/harmony$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21557}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21558}{}\doxysection{Automated –help}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21558}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21559}{}\doxysection{Custom help}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21559}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21560}{}\doxysection{.\+output\+Help(cb)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21560}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21561}{}\doxysection{.\+help(cb)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21561}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21562}{}\doxysection{Custom event listeners}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21562}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21563}{}\doxysection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21563}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{ examples}} directory.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21564}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_commander_Readme_autotoc_md21564}
