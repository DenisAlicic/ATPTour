...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16727}{}\doxysection{Quick start}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16727}
...
You can also decorate Error objects with additional information so that callers can not only handle each kind of error differently, but also construct their own error messages (e.\+g., to localize them, format them, group them by type, and so on). See the example below.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16728}{}\doxysection{Deeper dive}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16728}
...
Let\textquotesingle{}s put this all together with an example from the node-\/fast RPC library. node-\/fast implements a simple RPC protocol for Node programs. There\textquotesingle{}s a server and client interface, and clients make RPC requests to servers. Let\textquotesingle{}s say the server fails with an Unauthorized\+Error with message \char`\"{}user \textquotesingle{}bob\textquotesingle{} is not authorized\char`\"{}. The client wraps all server errors with a Fast\+Server\+Error. The client also wraps all request errors with a Fast\+Request\+Error that includes the name of the RPC call being made. The result of this failed RPC might look like this\+: \begin{DoxyVerb}name: FastRequestError
...
new VError(\char`\"{}my service isn\textquotesingle{}t working\char`\"{});

for the simple cases.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16729}{}\doxysection{Reference\+: VError, WError, SError}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16729}
VError, WError, and SError are convenient drop-\/in replacements for {\ttfamily Error} that support printf-\/style arguments, first-\/class causes, informational properties, and other useful features.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16730}{}\doxysubsection{Constructors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16730}
...
The {\ttfamily WError} constructor is used exactly the same way as the {\ttfamily VError} constructor. The {\ttfamily SError} constructor is also used the same way as the {\ttfamily VError} constructor except that in all cases, the {\ttfamily strict} property is overriden to \`{}true.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16731}{}\doxysubsection{Public properties}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16731}
...
The {\ttfamily stack} property is managed entirely by the underlying Java\+Script implementation. It\textquotesingle{}s generally implemented using a getter function because constructing the human-\/readable stack trace is somewhat expensive.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16732}{}\doxysubsection{Class methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16732}
The following methods are defined on the {\ttfamily VError} class and as exported functions on the {\ttfamily verror} module. They\textquotesingle{}re defined this way rather than using methods on VError instances so that they can be used on Errors not created with {\ttfamily VError}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16733}{}\doxysubsubsection{$<$tt$>$\+VError.\+cause(err)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16733}
The {\ttfamily cause()} function returns the next Error in the cause chain for {\ttfamily err}, or {\ttfamily null} if there is no next error. See the {\ttfamily cause} argument to the constructor. Errors can have arbitrarily long cause chains. You can walk the {\ttfamily cause} chain by invoking {\ttfamily VError.\+cause(err)} on each subsequent return value. If {\ttfamily err} is not a {\ttfamily VError}, the cause is {\ttfamily null}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16734}{}\doxysubsubsection{$<$tt$>$\+VError.\+info(err)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16734}
...
These properties are intended to provide programmatically-\/accessible metadata about the error. For an error that indicates a failure to resolve a DNS name, informational properties might include the DNS name to be resolved, or even the list of resolvers used to resolve it. The values of these properties should generally be plain objects (i.\+e., consisting only of null, undefined, numbers, booleans, strings, and objects and arrays containing only other plain objects).\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16735}{}\doxysubsubsection{$<$tt$>$\+VError.\+full\+Stack(err)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16735}
Returns a string containing the full stack trace, with all nested errors recursively reported as `\textquotesingle{}caused by\+:' + err.\+stack\`{}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16736}{}\doxysubsubsection{$<$tt$>$\+VError.\+find\+Cause\+By\+Name(err, name)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16736}
...
If a vanilla error or a non-\/\+VError error is passed in, then there is no cause chain to traverse. In this scenario, the function will check the {\ttfamily name} property of only {\ttfamily err}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16737}{}\doxysubsubsection{$<$tt$>$\+VError.\+has\+Cause\+With\+Name(err, name)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16737}
Returns true if and only if {\ttfamily VError.\+find\+Cause\+By\+Name(err, name)} would return a non-\/null value. This essentially determines whether {\ttfamily err} has any cause in its cause chain that has name {\ttfamily name}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16738}{}\doxysubsubsection{$<$tt$>$\+VError.\+error\+From\+List(errors)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16738}
...
This is useful for cases where an operation may produce any number of errors, and you ultimately want to implement the usual {\ttfamily callback(err)} pattern. You can accumulate the errors in an array and then invoke {\ttfamily callback(VError.\+error\+From\+List(errors))} when the operation is complete.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16739}{}\doxysubsubsection{$<$tt$>$\+VError.\+error\+For\+Each(err, func)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16739}
...
This function does not iterate an error\textquotesingle{}s cause chain.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16740}{}\doxysubsection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16740}
...
caused by: VError: something bad happened
    ...
    at node.js:968:3
\end{DoxyVerb}
 {\ttfamily VError.\+full\+Stack} is also safe to use on regular {\ttfamily Error}s, so feel free to use it whenever you need to extract the stack trace from an {\ttfamily Error}, regardless if it\textquotesingle{}s a {\ttfamily VError} or not.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16741}{}\doxysection{Reference\+: Multi\+Error}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16741}
...
\end{DoxyVerb}
 See the convenience function {\ttfamily VError.\+error\+From\+List}, which is sometimes simpler to use than this constructor.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16742}{}\doxysubsection{Public methods}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16742}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16743}{}\doxysubsubsection{$<$tt$>$errors()$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16743}
Returns an array of the errors used to construct this Multi\+Error.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16744}{}\doxysection{Contributing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_npm_node_modules_verror_README_autotoc_md16744}
See separate \mbox{\hyperlink{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules20a88855bebd8dfc7f5335f06fe79577}{contribution guidelines}}. 