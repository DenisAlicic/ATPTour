...
This library was extracted from \href{http://npm.im/fastparallel}{\texttt{ fastparallel}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21004}{}\doxysection{Example}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21004}
...
Also note how in the above examples, the code, that consumes an istance of {\ttfamily My\+Object}, reset the state to initial condition, just before storing it in the cache. That\textquotesingle{}s needed so that every subsequent request for an instance from the cache, could get a clean instance.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21005}{}\doxysection{Why}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21005}
It is faster because V8 doesn\textquotesingle{}t have to collect all the functions you create. On a short-\/lived benchmark, it is as fast as creating the nested function, but on a longer time frame it creates less pressure on the garbage collector.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21006}{}\doxysection{Other examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21006}
If you want to see some complex example, checkout \href{https://github.com/fastify/middie}{\texttt{ middie}} and \href{https://github.com/mcollina/steed}{\texttt{ steed}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21007}{}\doxysection{Acknowledgements}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21007}
Thanks to \href{https://github.com/trevnorris}{\texttt{ Trevor Norris}} for getting me down the rabbit hole of performance, and thanks to \href{http://github.com/mafintosh}{\texttt{ Mathias Buss}} for suggesting me to share this trick.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21008}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_reusify_README_autotoc_md21008}
MIT 