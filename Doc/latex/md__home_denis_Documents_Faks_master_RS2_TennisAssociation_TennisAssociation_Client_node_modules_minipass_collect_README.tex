...
Note\+: this is primarily useful for the {\ttfamily Collect.\+Pass\+Through} class, since Minipass streams already have a {\ttfamily .collect()} method which returns a promise that resolves to the array of chunks, and a {\ttfamily .concat()} method that returns the data concatenated into a single Buffer or String.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_collect_README_autotoc_md18953}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minipass_collect_README_autotoc_md18953}
