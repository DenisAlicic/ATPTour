\href{http://travis-ci.org/kriskowal/q}{\texttt{ }}

\href{http://promises-aplus.github.com/promises-spec}{\texttt{  }}

{\itshape This is Q version 1, from the {\ttfamily v1} branch in Git. This documentation applies to the latest of both the version 1 and version 0.\+9 release trains. These releases are stable. There will be no further releases of 0.\+9 after 0.\+9.\+7 which is nearly equivalent to version 1.\+0.\+0. All further releases of {\ttfamily q@$\sim$1.0} will be backward compatible. The version 2 release train introduces significant and backward-\/incompatible changes and is experimental at this time.}
...
The callback approach is called an “inversion of control”. A function that accepts a callback instead of a return value is saying, “\+Don’t call me, I’ll call you.\+”. Promises \href{http://www.slideshare.net/domenicdenicola/callbacks-promises-and-coroutines-oh-my-the-evolution-of-asynchronicity-in-javascript}{\texttt{ un-\/invert}} the inversion, cleanly separating the input arguments from control flow arguments. This simplifies the use and creation of API’s, particularly variadic, rest and spread arguments.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3761}{}\doxysubsection{Getting Started}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3761}
...
\item Using \href{http://bower.io/}{\texttt{ bower}} as {\ttfamily q\#1.\+0.\+1}
\item Using \href{http://nuget.org/}{\texttt{ Nu\+Get}} as \href{https://nuget.org/packages/q}{\texttt{ Q}}
\end{DoxyItemize}

Q can exchange promises with j\+Query, Dojo, When.\+js, Win\+JS, and more.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3762}{}\doxysubsection{Resources}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3762}
...
We\textquotesingle{}d also love to have you join the Q-\/\+Continuum \href{https://groups.google.com/forum/\#!forum/q-continuum}{\texttt{ mailing list}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3763}{}\doxysubsection{Tutorial}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3763}
...
In this tutorial, we begin with how to consume and work with promises. We\textquotesingle{}ll talk about how to create them, and thus create functions like {\ttfamily promise\+Me\+Something} that return promises, \href{\#the-beginning}{\texttt{ below}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3764}{}\doxysubsubsection{Propagation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3764}
...
If you are writing Java\+Script for modern engines only or using Coffee\+Script, you may use {\ttfamily finally} instead of {\ttfamily fin}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3765}{}\doxysubsubsection{Chaining}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3765}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3766}{}\doxysubsubsection{Combination}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3766}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3767}{}\doxysubsubsection{Sequences}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3767}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3768}{}\doxysubsubsection{Handling Errors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3768}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3769}{}\doxysubsubsection{Progress Notification}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3769}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3770}{}\doxysubsubsection{The End}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3770}
...
This is a stopgap. We are exploring ways to make unhandled errors visible without any explicit handling.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3771}{}\doxysubsubsection{The Beginning}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3771}
Everything above assumes you get a promise from somewhere else. This is the common case. Every once in a while, you will need to create a promise from scratch.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3772}{}\doxyparagraph{Using $<$tt$>$\+Q.\+fcall$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3772}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3773}{}\doxyparagraph{Using Deferreds}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3773}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3774}{}\doxyparagraph{Using $<$tt$>$\+Q.\+Promise$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3774}
...
If {\ttfamily request\+Ok\+Text} were to throw an exception, the returned promise would be rejected with that thrown exception as the rejection reason.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3775}{}\doxysubsubsection{The Middle}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3775}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3776}{}\doxysubsubsection{Over the Wire}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3776}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3777}{}\doxysubsubsection{Adapting Node}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3777}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3778}{}\doxysubsubsection{Long Stack Traces}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3778}
...
This feature does come with somewhat-\/serious performance and memory overhead, however. If you\textquotesingle{}re working with lots of promises, or trying to scale a server to many users, you should probably keep it off. But in development, go for it!\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3779}{}\doxysubsection{Tests}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3779}
You can view the results of the Q test suite \href{https://rawgithub.com/kriskowal/q/v1/spec/q-spec.html}{\texttt{ in your browser}}!\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3780}{}\doxysubsection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_q_README_autotoc_md3780}
