...
The API is designed to mimic the behavior of {\ttfamily tar(1)} on unix systems. If you are familiar with how tar works, most of this will hopefully be straightforward for you. If not, then hopefully this module can teach you useful unix skills that may come in handy someday \+:)\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24340}{}\doxysection{Background}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24340}
...
The other flags and options modify how this top level function works.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24341}{}\doxysection{High-\/\+Level API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24341}
...
Sync commands without a file argument return a stream that acts on its input immediately in the same tick. For readable streams, this means that all of the data is immediately available by calling {\ttfamily stream.\+read()}. For writable streams, it will be acted upon as soon as it is provided, but this can be at any time.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24342}{}\doxysubsection{Warnings and Errors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24342}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24343}{}\doxysubsubsection{Error Codes}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24343}
...
Errors generated by tar will have one of the above codes set as the {\ttfamily error.\+code} field as well, but since errors originating in zlib or fs will have their original codes, it\textquotesingle{}s better to read {\ttfamily error.\+tar\+Code} if you wish to see how tar is handling the issue.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24344}{}\doxysubsection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24344}
...
Keep reading for all the command descriptions and options, as well as the low-\/level API that they are built on.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24345}{}\doxysubsection{tar.\+c(options, file\+List, callback) \mbox{[}alias\+: tar.\+create\mbox{]}}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24345}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24346}{}\doxysubsection{tar.\+x(options, file\+List, callback) \mbox{[}alias\+: tar.\+extract\mbox{]}}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24346}
...
Note that using an asynchronous stream type with the {\ttfamily transform} option will cause undefined behavior in sync extractions. \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}-\/based streams are designed for this use case.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24347}{}\doxysubsection{tar.\+t(options, file\+List, callback) \mbox{[}alias\+: tar.\+list\mbox{]}}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24347}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24348}{}\doxysubsection{tar.\+u(options, file\+List, callback) \mbox{[}alias\+: tar.\+update\mbox{]}}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24348}
...
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive. \mbox{[}Alias\+: {\ttfamily m}, {\ttfamily no-\/mtime}\mbox{]}
\item {\ttfamily mtime} Set to a {\ttfamily Date} object to force a specific {\ttfamily mtime} for everything added to the archive. Overridden by {\ttfamily no\+Mtime}.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24349}{}\doxysubsection{tar.\+r(options, file\+List, callback) \mbox{[}alias\+: tar.\+replace\mbox{]}}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24349}
...
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive. \mbox{[}Alias\+: {\ttfamily m}, {\ttfamily no-\/mtime}\mbox{]}
\item {\ttfamily mtime} Set to a {\ttfamily Date} object to force a specific {\ttfamily mtime} for everything added to the archive. Overridden by {\ttfamily no\+Mtime}.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24350}{}\doxysection{Low-\/\+Level API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24350}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24351}{}\doxysubsection{class tar.\+Pack}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24351}
A readable tar stream.

Has all the standard readable stream interface stuff. `\textquotesingle{}data'{\ttfamily and }\textquotesingle{}end\textquotesingle{}{\ttfamily events,}read(){\ttfamily method,}pause(){\ttfamily and}resume()\`{}, etc.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24352}{}\doxysubsubsection{constructor(options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24352}
The following options are supported\+:
...
\item {\ttfamily mtime} Set to a {\ttfamily Date} object to force a specific {\ttfamily mtime} for everything added to the archive. Overridden by {\ttfamily no\+Mtime}.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24353}{}\doxysubsubsection{add(path)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24353}
Adds an entry to the archive. Returns the Pack stream.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24354}{}\doxysubsubsection{write(path)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24354}
Adds an entry to the archive. Returns true if flushed.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24355}{}\doxysubsubsection{end()}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24355}
Finishes the archive.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24356}{}\doxysubsection{class tar.\+Pack.\+Sync}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24356}
Synchronous version of {\ttfamily tar.\+Pack}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24357}{}\doxysubsection{class tar.\+Unpack}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24357}
...
Most unpack errors will cause a {\ttfamily warn} event to be emitted. If the {\ttfamily cwd} is missing, or not a directory, then an error will be emitted.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24358}{}\doxysubsubsection{constructor(options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24358}
...
\item {\ttfamily onentry} A function that gets called with {\ttfamily (entry)} for each entry that passes the filter.
\item {\ttfamily onwarn} A function that will get called with {\ttfamily (code, message, data)} for any warnings encountered. (See \char`\"{}\+Warnings and Errors\char`\"{})
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24359}{}\doxysubsection{class tar.\+Unpack.\+Sync}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24359}
Synchronous version of {\ttfamily tar.\+Unpack}.

Note that using an asynchronous stream type with the {\ttfamily transform} option will cause undefined behavior in sync unpack streams. \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}-\/based streams are designed for this use case.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24360}{}\doxysubsection{class tar.\+Parse}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24360}
...
Each {\ttfamily entry} will not emit until the one before it is flushed through, so make sure to either consume the data (with `on(\textquotesingle{}data', ...){\ttfamily or }.pipe(...){\ttfamily ) or throw it away with}.resume()\`{} to keep the stream flowing.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24361}{}\doxysubsubsection{constructor(options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24361}
...
\item {\ttfamily onentry} A function that gets called with {\ttfamily (entry)} for each entry that passes the filter.
\item {\ttfamily onwarn} A function that will get called with {\ttfamily (code, message, data)} for any warnings encountered. (See \char`\"{}\+Warnings and Errors\char`\"{})
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24362}{}\doxysubsubsection{abort(error)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24362}
Stop all parsing activities. This is called when there are zlib errors. It also emits an unrecoverable warning with the error provided.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24363}{}\doxysubsection{class tar.\+Read\+Entry extends $<$a href=\char`\"{}http\+://npm.\+im/minipass\char`\"{}$>$\+Mini\+Pass$<$/a$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24363}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24364}{}\doxysubsubsection{constructor(header, extended, global\+Extended)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24364}
Create a new Read\+Entry object with the specified header, extended header, and global extended header values.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24365}{}\doxysubsection{class tar.\+Write\+Entry extends $<$a href=\char`\"{}http\+://npm.\+im/minipass\char`\"{}$>$\+Mini\+Pass$<$/a$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24365}
...
\item {\ttfamily no\+Pax} Suppress pax extended headers. Note that this means that long paths and linkpaths will be truncated, and large or negative numeric values may be interpreted incorrectly.
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24366}{}\doxysubsubsection{constructor(path, options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24366}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24367}{}\doxysubsubsection{warn(message, data)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24367}
If strict, emit an error with the provided message.

Othewise, emit a `\textquotesingle{}warn'\`{} event with the provided message and data.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24368}{}\doxysubsection{class tar.\+Write\+Entry.\+Sync}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24368}
Synchronous version of tar.\+Write\+Entry\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24369}{}\doxysubsection{class tar.\+Write\+Entry.\+Tar}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24369}
A version of tar.\+Write\+Entry that gets its data from a tar.\+Read\+Entry instead of from the filesystem.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24370}{}\doxysubsubsection{constructor(read\+Entry, options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24370}
...
\item {\ttfamily onwarn} A function that will get called with {\ttfamily (code, message, data)} for any warnings encountered. (See \char`\"{}\+Warnings and Errors\char`\"{})
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive.
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24371}{}\doxysubsection{class tar.\+Header}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24371}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24372}{}\doxysubsubsection{constructor(data, \mbox{[}offset=0\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24372}
{\ttfamily data} is optional. It is either a Buffer that should be interpreted as a tar Header starting at the specified offset and continuing for 512 bytes, or a data object of keys and values to set on the header object, and eventually encode as a tar Header.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24373}{}\doxysubsubsection{decode(block, offset)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24373}
Decode the provided buffer starting at the specified offset.

Buffer length must be greater than 512 bytes.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24374}{}\doxysubsubsection{set(data)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24374}
Set the fields in the data object.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24375}{}\doxysubsubsection{encode(buffer, offset)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24375}
Encode the header fields into the buffer at the specified offset.

Returns {\ttfamily this.\+need\+Pax} to indicate whether a Pax Extended Header is required to properly encode the specified data.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24376}{}\doxysubsection{class tar.\+Pax}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24376}
...
\item {\ttfamily ino}
\item {\ttfamily nlink}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24377}{}\doxysubsubsection{constructor(object, global)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24377}
Set the fields set in the object. {\ttfamily global} is a boolean that defaults to false.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24378}{}\doxysubsubsection{encode()}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24378}
Return a Buffer containing the header and body for the Pax extended header entry, or {\ttfamily null} if there is nothing to encode.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24379}{}\doxysubsubsection{encode\+Body()}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24379}
Return a string representing the body of the pax extended header entry.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24380}{}\doxysubsubsection{encode\+Field(field\+Name)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24380}
Return a string representing the key/value encoding for the specified field\+Name, or `'\textquotesingle{}\`{} if the field is unset.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24381}{}\doxysubsection{tar.\+Pax.\+parse(string, extended, global)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24381}
Return a new Pax object created by parsing the contents of the string provided.

If the {\ttfamily extended} object is set, then also add the fields from that object. (This is necessary because multiple metadata entries can occur in sequence.)\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24382}{}\doxysubsection{tar.\+types}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24382}
A translation table for the {\ttfamily type} field in tar headers.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24383}{}\doxysubsubsection{tar.\+types.\+name.\+get(code)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24383}
Get the human-\/readable name for a given alphanumeric code.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24384}{}\doxysubsubsection{tar.\+types.\+code.\+get(name)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tar_README_autotoc_md24384}
