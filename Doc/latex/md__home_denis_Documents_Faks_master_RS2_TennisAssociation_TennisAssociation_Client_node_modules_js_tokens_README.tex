...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23316}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23316}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23317}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23317}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23318}{}\doxysubsubsection{$<$tt$>$js\+Tokens$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23318}
...
The next match is always directly after the previous.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23319}{}\doxysubsubsection{$<$tt$>$var token = match\+To\+Token(match)$<$/tt$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23319}
...
Whitespace includes both line terminators and other whitespace.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23320}{}\doxysection{ECMAScript support}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23320}
...
Currently, ECMAScript 2018 is supported.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23321}{}\doxysection{Invalid code handling}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23321}
...
Strings may contain invalid escape sequences.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23322}{}\doxysection{Limitations}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23322}
Tokenizing Java\+Script using regexes—in fact, \+\_\+one single regex\+\_\+—won’t be perfect. But that’s not the point either.

You may compare js\+Tokens with \href{http://esprima.org/}{\texttt{ esprima}} by using {\ttfamily esprima-\/compare.\+js}. See {\ttfamily npm run esprima-\/compare}!\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23323}{}\doxysubsubsection{Template string interpolation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23323}
...
Matching template string interpolations requires recursive balancing of {\ttfamily \{} and {\ttfamily \}}—something that Java\+Script regexes cannot do. Only one level of nesting is supported.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23324}{}\doxysubsubsection{Division and regex literals collision}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23324}
...
If the end of a statement looks like a regex literal (even if it isn’t), it will be treated as one. Otherwise it should work as expected (if you write sane code).\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23325}{}\doxysubsubsection{ES2018}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23325}
...
These things would be nice to do, but are not critical. They probably have to wait until the oldest maintained Node.\+js LTS release supports those features.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23326}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_js_tokens_README_autotoc_md23326}
