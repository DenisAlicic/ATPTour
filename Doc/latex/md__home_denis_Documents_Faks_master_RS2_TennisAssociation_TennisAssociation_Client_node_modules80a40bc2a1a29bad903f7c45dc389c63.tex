Like \href{http://npm.im/JSONStream}{\texttt{ JSONStream}}, but using Minipass streams\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16011}{}\doxysection{install}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16011}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install minipass-\/json-\/stream}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16012}{}\doxysection{example}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16012}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16013}{}\doxysection{new JSONStream(options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16013}
Create a new stream. This is a \href{http://npm.im/minipass}{\texttt{ minipass}} stream that is always set in {\ttfamily object\+Mode}. It emits objects parsed out of string/buffer JSON input that match the supplied {\ttfamily path} option.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16014}{}\doxysection{JSONStream.\+parse(path)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16014}
...
If you want to have keys emitted, you can prefix your {\ttfamily $\ast$} operator with {\ttfamily \$}\+: {\ttfamily obj.\$$\ast$} -\/ in this case the data passed to the stream is an object with a {\ttfamily key} holding the key and a {\ttfamily value} property holding the data.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16015}{}\doxysubsection{Examples}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16015}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16016}{}\doxysubsection{recursive patterns (..)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16016}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16017}{}\doxysection{JSONStream.\+parse(pattern, map)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16017}
...
{\ttfamily JSONStream} also emits `\textquotesingle{}header'{\ttfamily and}\textquotesingle{}footer\textquotesingle{}{\ttfamily events, the}\textquotesingle{}header\textquotesingle{}{\ttfamily event contains anything in the output that was before the first match, and the}\textquotesingle{}footer\textquotesingle{}\`{}, is anything after the last match.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16018}{}\doxysection{Acknowlegements}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules80a40bc2a1a29bad903f7c45dc389c63_autotoc_md16018}
