...
It also provides defaults for a number of core AWS headers and request parameters, making it very easy to query AWS services, or build out a fully-\/featured AWS library.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4707}{}\doxysection{Example}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4707}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4708}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4708}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4709}{}\doxysubsection{aws4.\+sign(request\+Options, \mbox{[}credentials\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4709}
...
Can also be used \href{./browser}{\texttt{ in the browser}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4711}{}\doxysection{Thanks}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aws4_README_autotoc_md4711}
