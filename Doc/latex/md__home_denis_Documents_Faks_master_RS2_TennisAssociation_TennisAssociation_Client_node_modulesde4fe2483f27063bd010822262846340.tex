\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesde4fe2483f27063bd010822262846340_autotoc_md14229}{}\doxysection{Example for SOCKS \textquotesingle{}bind\textquotesingle{} command}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesde4fe2483f27063bd010822262846340_autotoc_md14229}
...
\begin{DoxyEnumerate}
\item Client -\/(bind)-\/$>$ Proxy (Tells the proxy to bind to a new port)
\item Client $<$-\/(port)-\/ Proxy (Tells the origin client which port it opened)
\item Client2 -\/-\/$>$ Proxy (Other client connects to the proxy on this port)
\item Client $<$--(client2\textquotesingle{}s host info) (Proxy tells the origin client who connected to it)
\item Original connection to the proxy is now a full TCP stream between client (you) and client2.
\item Client $<$-\/-\/$>$ Proxy $<$-\/-\/$>$ Client2
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesde4fe2483f27063bd010822262846340_autotoc_md14230}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesde4fe2483f27063bd010822262846340_autotoc_md14230}
