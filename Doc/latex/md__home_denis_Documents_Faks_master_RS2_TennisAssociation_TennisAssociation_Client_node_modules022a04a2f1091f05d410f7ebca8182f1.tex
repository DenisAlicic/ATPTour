...
This is only suitable for reading package.\+json files in a node\+\_\+modules tree, since it doesn\textquotesingle{}t do the various cleanups, normalization, and warnings that are beneficial at the root level in a package being published.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13227}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13227}
...
Errors raised from parsing will use \href{http://npm.im/json-parse-even-better-errors}{\texttt{ {\ttfamily json-\/parse-\/even-\/better-\/errors}}}, so they\textquotesingle{}ll be of type {\ttfamily JSONParse\+Error} and have a `code\+: \textquotesingle{}EJSONPARSE'{\ttfamily  property. Errors will also always have a}path\`{} member referring to the path originally passed into the function.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13228}{}\doxysection{Indentation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13228}
...
Indentation is determined by looking at the whitespace between the initial {\ttfamily \{} and the first {\ttfamily "{}} that follows it. If you have lots of weird inconsistent indentation, then it won\textquotesingle{}t track that or give you any way to preserve it. Whether this is a bug or a feature is debatable ;)\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13229}{}\doxysection{WHAT THIS MODULE DOES}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13229}
...
\item Normalize {\ttfamily funding\+: $<$string$>$} to {\ttfamily funding\+: \{ url\+: $<$string$>$ \}}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13230}{}\doxysection{WHAT THIS MODULE DOES NOT DO}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules022a04a2f1091f05d410f7ebca8182f1_autotoc_md13230}
