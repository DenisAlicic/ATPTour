\href{http://travis-ci.org/socketio/engine.io-parser}{\texttt{ }} \href{http://badge.fury.io/js/engine.io-parser}{\texttt{ }}

This is the Java\+Script parser for the engine.\+io protocol encoding, shared by both \href{https://github.com/socketio/engine.io-client}{\texttt{ engine.\+io-\/client}} and \href{https://github.com/socketio/engine.io}{\texttt{ engine.\+io}}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26208}{}\doxysection{How to use}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26208}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26209}{}\doxysubsection{Standalone}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26209}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{var parser = require('engine.io-\/parser');}
\DoxyCodeLine{}
\DoxyCodeLine{var data = new Buffer(5);}
\DoxyCodeLine{for (var i = 0; i < data.length; i++) \{ data[i] = i; \}}
\DoxyCodeLine{}
\DoxyCodeLine{parser.encodePacket(\{ type: 'message', data: data \}, function(encoded) \{}
\DoxyCodeLine{  var decodedData = parser.decodePacket(encoded); // \{ type: 'message', data: data \}}
\DoxyCodeLine{\});}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26210}{}\doxysubsection{With browserify}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26210}
...
\end{DoxyEnumerate}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26211}{}\doxysection{Features}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26211}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26212}{}\doxysection{API}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26212}
Note\+: {\ttfamily cb(type)} means the type is a callback function that contains a parameter of type {\ttfamily type} when called.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26213}{}\doxysubsection{Node}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26213}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26214}{}\doxysubsection{Browser}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26214}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26215}{}\doxysection{Tests}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26215}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26216}{}\doxysection{Support}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26216}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26217}{}\doxysection{Development}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26217}
To contribute patches, run tests or benchmarks, make sure to clone the repository\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{git clone git://github.com/LearnBoost/engine.io-\/parser.git}
...
See the {\ttfamily Tests} section above for how to run tests before submitting any patches.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26218}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_engine_io_parser_Readme_autotoc_md26218}
MIT 