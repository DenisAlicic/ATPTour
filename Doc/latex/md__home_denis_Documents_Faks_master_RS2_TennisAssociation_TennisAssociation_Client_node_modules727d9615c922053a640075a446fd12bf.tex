...
The improvements are meant to normalize behavior across different platforms and environments, and to make filesystem access more resilient to errors.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15353}{}\doxysection{Improvements over $<$a href=\char`\"{}https\+://nodejs.\+org/api/fs.\+html\char`\"{}$>$fs module$<$/a$>$}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15353}
...
On Windows, it retries renaming a file for up to one second if {\ttfamily EACCESS} or {\ttfamily EPERM} error occurs, likely because antivirus software has locked the directory.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15354}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15354}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15355}{}\doxysection{Global Patching}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15355}
...
This should only ever be done at the top-\/level application layer, in order to delay on EMFILE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15356}{}\doxysection{Changes}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15356}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of Node from 0.\+8 through 7.\+0.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15357}{}\doxysubsection{v4}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15357}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15358}{}\doxysubsection{v3}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15358}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15359}{}\doxysubsection{v2.\+1.\+0}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15359}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15360}{}\doxysubsection{v2.\+0}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15360}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15361}{}\doxysubsection{v1.\+1}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15361}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15362}{}\doxysubsection{1.\+0}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules727d9615c922053a640075a446fd12bf_autotoc_md15362}
