...
The async versions work much like their node builtin counterparts, with the exception of introducing significantly less Stream machinery overhead.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_fs_minipass_README_autotoc_md20338}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_fs_minipass_README_autotoc_md20338}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_fs_minipass_README_autotoc_md20339}{}\doxysection{Read\+Stream(path, options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_fs_minipass_README_autotoc_md20339}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_fs_minipass_README_autotoc_md20340}{}\doxysection{Write\+Stream(path, options)}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_fs_minipass_README_autotoc_md20340}
Path string is required, but somewhat irrelevant if an open file descriptor is passed in as an option.
