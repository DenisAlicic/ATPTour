...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11323}{}\doxysection{Installation}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11323}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install -\/-\/save tapable}

\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11324}{}\doxysection{Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11324}
...
This ensures fastest possible execution.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11325}{}\doxysection{Hook types}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11325}
...
The hook type is reflected in its class name. E.\+g., {\ttfamily Async\+Series\+Waterfall\+Hook} allows asynchronous functions and runs them in series, passing each function’s return value into the next function.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11326}{}\doxysection{Interception}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11326}
...
{\bfseries{call}}\+: {\ttfamily (...args) =$>$ void} Adding {\ttfamily call} to your interceptor will trigger when hooks are triggered. You have access to the hooks arguments.

{\bfseries{tap}}\+: {\ttfamily (tap\+: Tap) =$>$ void} Adding {\ttfamily tap} to your interceptor will trigger when a plugin taps into a hook. Provided is the {\ttfamily Tap} object. {\ttfamily Tap} object can\textquotesingle{}t be changed.

{\bfseries{loop}}\+: {\ttfamily (...args) =$>$ void} Adding {\ttfamily loop} to your interceptor will trigger for each loop of a looping hook.

{\bfseries{register}}\+: {\ttfamily (tap\+: Tap) =$>$ Tap $\vert$ undefined} Adding {\ttfamily register} to your interceptor will trigger for each added {\ttfamily Tap} and allows to modify it.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11327}{}\doxysection{Context}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11327}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11328}{}\doxysection{Hook\+Map}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11328}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11329}{}\doxysection{Hook/\+Hook\+Map interface}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11329}
Public\+:
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11330}{}\doxysection{Multi\+Hook}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_tapable_README_autotoc_md11330}
