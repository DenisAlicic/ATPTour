A simple module to escape/unescape common problematic entities.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_html_escaper_README_autotoc_md25485}{}\doxysubsection{How}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_html_escaper_README_autotoc_md25485}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_html_escaper_README_autotoc_md25486}{}\doxysubsection{Why}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_html_escaper_README_autotoc_md25486}
...
The last example will produce {\ttfamily $<$script$>$alert(\char`\"{}yo\char`\"{})$<$/script$>$} instead of the expected {\ttfamily $<$script$>$alert(\char`\"{}yo\char`\"{})$<$/script$>$}.
...
We have proofs this approach can fail already so ... why should we risk? Just avoid and grab all chars at once or simply use this tiny utility.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_html_escaper_README_autotoc_md25487}{}\doxysubsection{Backtick}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_html_escaper_README_autotoc_md25487}
Internt explorer $<$ 9 has \href{https://html5sec.org/\#102}{\texttt{ some backtick issue}}
...
{\bfseries{However}}, if you use {\ttfamily inner\+HTML} and you target IE $<$ 9 then \href{https://github.com/nette/nette/issues/1496}{\texttt{ this {\bfseries{might}} be a problem}}.
