...
If an {\bfseries{error}} argument is found and is not null then the remaining arguments are optional. That is, if you say {\ttfamily ESO} then that\textquotesingle{}s like using a non-\/magical {\ttfamily E} in\+: {\ttfamily E$\vert$\+ESO$\vert$\+ZSO}.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aproba_README_autotoc_md18945}{}\doxysubsection{But I have optional arguments?!}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aproba_README_autotoc_md18945}
...
To reproduce this you have to fully enumerate all of the possible combinations and that implies a signature of {\ttfamily SO$\vert$\+SS$\vert$\+OO$\vert$\+OS$\vert$\+S$\vert$O}. The awkwardness is a feature\+: It reminds you of the complexity you\textquotesingle{}re adding to your API when you do this sort of thing.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aproba_README_autotoc_md18946}{}\doxysubsection{Browser support}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aproba_README_autotoc_md18946}
This has no dependencies and should work in browsers, though you\textquotesingle{}ll have noisier stack traces.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aproba_README_autotoc_md18947}{}\doxysubsection{Why this exists}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_aproba_README_autotoc_md18947}
