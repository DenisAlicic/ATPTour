This is an extension for node\textquotesingle{}s {\ttfamily fs.\+write\+File} that makes its operation atomic and allows you set ownership (uid/gid of the file).\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d5489dfeca6f957339df5d3e5895cca_autotoc_md14162}{}\doxysubsection{var write\+File\+Atomic = require(\textquotesingle{}write-\/file-\/atomic\textquotesingle{})$<$br$>$write\+File\+Atomic(filename, data, \mbox{[}options\mbox{]}, \mbox{[}callback\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d5489dfeca6f957339df5d3e5895cca_autotoc_md14162}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d5489dfeca6f957339df5d3e5895cca_autotoc_md14163}{}\doxysubsection{var write\+File\+Atomic\+Sync = require(\textquotesingle{}write-\/file-\/atomic\textquotesingle{}).\+sync$<$br$>$write\+File\+Atomic\+Sync(filename, data, \mbox{[}options\mbox{]})}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules3d5489dfeca6f957339df5d3e5895cca_autotoc_md14163}
