...
Brotli is supported in versions of node with a Brotli binding.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8916}{}\doxysection{How does this differ from the streams in ‘require(\textquotesingle{}zlib’)\`{}?}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8916}
...
See \href{http://npm.im/minipass}{\texttt{ Minipass}} for more on the differences between Node.\+js core streams and Minipass streams, and the convenience methods provided by that class.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8917}{}\doxysection{Classes}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8917}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8918}{}\doxysection{USAGE}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8918}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8919}{}\doxysection{REPRODUCIBLE BUILDS}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_minizlib_README_autotoc_md8919}
