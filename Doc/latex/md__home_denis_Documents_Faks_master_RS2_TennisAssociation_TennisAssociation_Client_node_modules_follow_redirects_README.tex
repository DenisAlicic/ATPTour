...
\href{https://www.npmjs.com/package/follow-redirects}{\texttt{ }} \href{https://travis-ci.org/follow-redirects/follow-redirects}{\texttt{ }} \href{https://coveralls.io/r/follow-redirects/follow-redirects?branch=master}{\texttt{ }} \href{https://www.npmjs.com/package/follow-redirects}{\texttt{ }} \href{https://github.com/sponsors/RubenVerborgh}{\texttt{ }}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12452}{}\doxysection{Options}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12452}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12453}{}\doxysubsection{Global options}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12453}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12454}{}\doxysubsection{Per-\/request options}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12454}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12455}{}\doxysubsection{Advanced usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12455}
...
Such custom protocols only need an implementation of the {\ttfamily request} method.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12456}{}\doxysection{Browser Usage}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12456}
...
\end{DoxyCode}
\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12457}{}\doxysection{Contributing}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12457}
Pull Requests are always welcome. Please \href{https://github.com/follow-redirects/follow-redirects/issues}{\texttt{ file an issue}} detailing your proposal before you invest your valuable time. Additional features and bug fixes should be accompanied by tests. You can run the test suite locally with a simple {\ttfamily npm test} command.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12458}{}\doxysection{Debug Logging}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12458}
{\ttfamily follow-\/redirects} uses the excellent \href{https://www.npmjs.com/package/debug}{\texttt{ debug}} for logging. To turn on logging set the environment variable {\ttfamily DEBUG=follow-\/redirects} for debug output from just this module. When running the test suite it is sometimes advantageous to set {\ttfamily DEBUG=$\ast$} to see output from the express server as well.\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12459}{}\doxysection{Authors}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12459}
...
\end{DoxyItemize}\hypertarget{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12460}{}\doxysection{License}\label{md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_follow_redirects_README_autotoc_md12460}
