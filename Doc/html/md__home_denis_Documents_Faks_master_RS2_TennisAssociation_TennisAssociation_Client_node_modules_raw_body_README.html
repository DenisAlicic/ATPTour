...
<title>Tennis Association: raw-body</title>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11820"></a>
TypeScript</h2>
<p class="">This module includes a <a href="https://www.typescriptlang.org/">TypeScript</a> declaration file to enable auto complete in compatible editors and type information for TypeScript projects. This module depends on the Node.js types, so install <code>@types/node</code>:</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11822"></a>
getRawBody(stream, [options], [callback])</h2>
<p class=""><b>Returns a promise if no callback specified and global <code>Promise</code> exists.</b></p>
<p class="">Options:</p>
<ul>
...
<p class="">You can also pass a string in place of options to just specify the encoding.</p>
<p class="">If an error occurs, the stream will be paused, everything unpiped, and you are responsible for correctly disposing the stream. For HTTP requests, no handling is required if you send a response. For streams that use file descriptors, you should <code>stream.destroy()</code> or <code>stream.close()</code> to prevent leaks.</p>
<h1><a class="anchor" id="autotoc_md11823"></a>
Errors</h1>
<p class="">This module creates errors depending on the error condition during reading. The error may be an error from the underlying Node.js implementation, but is otherwise an error created by this module, which has the following attributes:</p>
<ul>
...
Types</h2>
<p class="">The errors from this module have a <code>type</code> property which allows for the progamatic determination of the type of error returned.</p>
<h3><a class="anchor" id="autotoc_md11825"></a>
encoding.unsupported</h3>
<p class="">This error will occur when the <code>encoding</code> option is specified, but the value does not map to an encoding supported by the <a href="https://www.npmjs.org/package/iconv-lite#readme">iconv-lite</a> module.</p>
<h3><a class="anchor" id="autotoc_md11826"></a>
entity.too.large</h3>
<p class="">This error will occur when the <code>limit</code> option is specified, but the stream has an entity that is larger.</p>
<h3><a class="anchor" id="autotoc_md11827"></a>
request.aborted</h3>
<p class="">This error will occur when the request stream is aborted by the client before reading the body has finished.</p>
<h3><a class="anchor" id="autotoc_md11828"></a>
request.size.invalid</h3>
<p class="">This error will occur when the <code>length</code> option is specified, but the stream has emitted more bytes.</p>
<h3><a class="anchor" id="autotoc_md11829"></a>
stream.encoding.set</h3>
<p class="">This error will occur when the given stream has an encoding set on it, making it a decoded stream. The stream should not have an encoding set and is expected to emit <code>Buffer</code> objects.</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11832"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11833"></a>
Using as a promise</h2>
<p class="">To use this library as a promise, simply omit the <code>callback</code> and a promise is returned, provided that a global <code>Promise</code> is defined.</p>
<div class="fragment"><div class="line">var getRawBody = require(&#39;raw-body&#39;)</div>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11834"></a>
