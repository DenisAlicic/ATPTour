...
<title>Tennis Association: Output customization</title>
...
<div class="contents">
<div class="textblock"><p class="">If you want to add extra information to the reporter output, you can build your own display processor and add it to options in the customProcessors array.</p>
<h1><a class="anchor" id="autotoc_md22333"></a>
Example</h1>
<p class="">Let's say that you want to add the current time before each output of the reporter in order to have something like this: </p><pre class="fragment">Spec started
...
</pre><h2><a class="anchor" id="autotoc_md22334"></a>
Build your display processor</h2>
<p class="">You need to require the display processor:</p>
<div class="fragment"><div class="line">var DisplayProcessor = require(&#39;jasmine-spec-reporter&#39;).DisplayProcessor;</div>
</div><!-- fragment --><p class="">You can then customize the following methods:</p><ul>
...
<p class="">The first argument is the jasmine object corresponding to the suite or the spec. The second argument is the log to be displayed. Those methods should return the modified log.</p>
<p class="">For our example:</p>
<div class="fragment"><div class="line">var DisplayProcessor = require(&#39;jasmine-spec-reporter&#39;).DisplayProcessor;</div>
<div class="line"> </div>
...
<div class="line">  return getTime() + &#39; - &#39; + log;</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md22335"></a>
Add it to the configuration</h2>
<p class="">Then you need to configure jasmine spec reporter to use your processor:</p>
...
</div><!-- fragment --><p class="">You must pass the processor constructor in the customProcessors array. Jasmine spec reporter will instantiate it with the options if you need them. You can add as many processors as you want, they will be applied in the order which they are in the customProcessors array. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<!-- start footer part -->
