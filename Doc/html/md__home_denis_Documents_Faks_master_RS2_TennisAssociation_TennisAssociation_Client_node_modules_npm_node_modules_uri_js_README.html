...
<title>Tennis Association: URI.js</title>
...
//  host : "2001:db8::7%en1"
//}
</pre> <h2><a class="anchor" id="autotoc_md13677"></a>
IRI Support</h2>
<pre class="fragment">//convert IRI to URI
URI.serialize(URI.parse("http://examplé.org/rosé")) === "http://xn--exampl-gva.org/ros%C3%A9"
//convert URI to IRI
URI.serialize(URI.parse("http://xn--exampl-gva.org/ros%C3%A9"), {iri:true}) === "http://examplé.org/rosé"
</pre> <h2><a class="anchor" id="autotoc_md13678"></a>
Options</h2>
<p class="">All of the above functions can accept an additional options argument that is an object that can contain one or more of the following properties:</p>
<ul>
...
<p class="">URI.js supports inserting custom <a href="http://en.wikipedia.org/wiki/URI_scheme">scheme</a> dependent processing rules. Currently, URI.js has built in support for the following schemes:</p>
<ul>
...
</pre> <h2><a class="anchor" id="autotoc_md13682"></a>
Mailto Support</h2>
...
</pre> <h2><a class="anchor" id="autotoc_md13683"></a>
URN Support</h2>
...
//  nss : "foo",
//}
</pre> <h3><a class="anchor" id="autotoc_md13684"></a>
URN UUID Support</h3>
...
//}
</pre> <h1><a class="anchor" id="autotoc_md13685"></a>
Usage</h1>
<p class="">To load in a browser, use the following tag: </p><pre class="fragment">&lt;script type="text/javascript" src="uri-js/dist/es5/uri.all.min.js"&gt;&lt;/script&gt;
...
</pre> <h1><a class="anchor" id="autotoc_md13686"></a>
Breaking changes</h1>
<h2><a class="anchor" id="autotoc_md13687"></a>
Breaking changes from 3.x</h2>
<p class="">URN parsing has been completely changed to better align with the specification. Scheme is now always <code>urn</code>, but has two new properties: <code>nid</code> which contains the Namspace Identifier, and <code>nss</code> which contains the Namespace Specific String. The <code>nss</code> property will be removed by higher order scheme handlers, such as the UUID URN scheme handler.</p>
<p class="">The UUID of a URN can now be found in the <code>uuid</code> property.</p>
<h2><a class="anchor" id="autotoc_md13688"></a>
Breaking changes from 2.x</h2>
<p class="">URI validation has been removed as it was slow, exposed a vulnerabilty, and was generally not useful.</p>
<h2><a class="anchor" id="autotoc_md13689"></a>
Breaking changes from 1.x</h2>
<p class="">The <code>errors</code> array on parsed components is now an <code>error</code> string. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<!-- start footer part -->
