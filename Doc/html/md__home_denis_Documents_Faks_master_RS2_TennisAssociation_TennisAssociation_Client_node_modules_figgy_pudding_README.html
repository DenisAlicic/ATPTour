...
<div class="contents">
<div class="textblock"><p class=""><b>This module will be deprecated once npm v7 is released. Please do not rely on it more than absolutely necessary (ie, only if you are depending on it for use with npm v6 internal dependencies).</b></p>
<hr  />
...
<p class=""><a href="https://github.com/npm/figgy-pudding"><code>figgy-pudding</code></a> is a small JavaScript library for managing and composing cascading options objects &ndash; hiding what needs to be hidden from each layer, without having to do a lot of manual munging and passing of options.</p>
...
Install</h2>
<p class=""><code>$ npm install figgy-pudding</code></p>
<h2><a class="anchor" id="autotoc_md21409"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21411"></a>
Features</h3>
<ul>
...
<p class="">Defines an Options constructor that can be used to collect only the needed options.</p>
<p class="">An optional <code>default</code> property for specs can be used to specify default values if nothing was passed in.</p>
<p class="">If the value for a spec is a string, it will be treated as an alias to that other key.</p>
<p class=""><a class="anchor" id="autotoc_md21414"></a> </p><h5>Example</h5>
...
<div class="line">  cache: {}</div>
<div class="line">})</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21415"></a>
&lt;a name="pudding-factory"&gt;&lt;/a&gt; &lt;tt&gt;&gt; PuddingFactory(...providers) -&gt; FiggyPudding{}&lt;/tt&gt;</h4>
<p class="">Instantiates an options object defined by <code>figgyPudding()</code>, which uses <code>providers</code>, in order, to find requested properties.</p>
<p class="">Each provider can be either a plain object, a <code>Map</code>-like object (that is, one with a <code>.get()</code> method) or another figgyPudding <code>Opts</code> object.</p>
<p class="">When nesting <code>Opts</code> objects, their properties will not become available to the new object, but any further nested <code>Opts</code> that reference that property <em>will</em> be able to read from their grandparent, as long as they define that key. Default values for nested <code>Opts</code> parents will be used, if found.</p>
<p class=""><a class="anchor" id="autotoc_md21416"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21417"></a>
&lt;a name="opts-get"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.get(key) -&gt; Value&lt;/tt&gt;</h4>
<p class="">Gets a value from the options object.</p>
<p class=""><a class="anchor" id="autotoc_md21418"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21419"></a>
&lt;a name="opts-concat"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.concat(...moreProviders) -&gt; FiggyPudding{}&lt;/tt&gt;</h4>
<p class="">Creates a new opts object of the same type as <code>opts</code> with additional providers. Providers further to the right shadow providers to the left, with properties in the original <code>opts</code> being shadows by the new providers.</p>
<p class=""><a class="anchor" id="autotoc_md21420"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21421"></a>
&lt;a name="opts-to-json"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.toJSON() -&gt; Value&lt;/tt&gt;</h4>
<p class="">Converts <code>opts</code> to a plain, JSON-stringifiable JavaScript value. Used internally by JavaScript to get <code>JSON.stringify()</code> working.</p>
<p class="">Only keys that are readable by the current pudding type will be serialized.</p>
<p class=""><a class="anchor" id="autotoc_md21422"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1})</div>
<div class="line">opts.toJSON() // {x: 1}</div>
<div class="line">JSON.stringify(opts) // &#39;{&quot;x&quot;:1}&#39;</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21423"></a>
&lt;a name="opts-for-each"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.forEach((value, key, opts) =&gt; {}, thisArg) -&gt; undefined&lt;/tt&gt;</h4>
<p class="">Iterates over the values of <code>opts</code>, limited to the keys readable by the current pudding type. <code>thisArg</code> will be used to set the <code>this</code> argument when calling the <code>fn</code>.</p>
<p class=""><a class="anchor" id="autotoc_md21424"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21425"></a>
&lt;a name="opts-entries"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.entries() -&gt; Iterator&lt;[[key, value], ...]&gt;&lt;/tt&gt;</h4>
<p class="">Returns an iterator that iterates over the keys and values in <code>opts</code>, limited to the keys readable by the current pudding type. Each iteration returns an array of <code>[key, value]</code>.</p>
<p class=""><a class="anchor" id="autotoc_md21426"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
<div class="line">[...opts({x: 1, y: 2}).entries()] // [[&#39;x&#39;, 1], [&#39;y&#39;, 2]]</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21427"></a>
&lt;a name="opts-symbol-iterator"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts[Symbol.iterator]() -&gt; Iterator&lt;[[key, value], ...]&gt;&lt;/tt&gt;</h4>
<p class="">Returns an iterator that iterates over the keys and values in <code>opts</code>, limited to the keys readable by the current pudding type. Each iteration returns an array of <code>[key, value]</code>. Makes puddings work natively with JS iteration mechanisms.</p>
<p class=""><a class="anchor" id="autotoc_md21428"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
...
<div class="line">}</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21429"></a>
&lt;a name="opts-keys"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.keys() -&gt; Iterator&lt;[key, ...]&gt;&lt;/tt&gt;</h4>
<p class="">Returns an iterator that iterates over the keys in <code>opts</code>, limited to the keys readable by the current pudding type.</p>
<p class=""><a class="anchor" id="autotoc_md21430"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
<div class="line">[...opts({x: 1, y: 2}).keys()] // [&#39;x&#39;, &#39;y&#39;]</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md21431"></a>
&lt;a name="opts-values"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.values() -&gt; Iterator&lt;[value, ...]&gt;&lt;/tt&gt;</h4>
<p class="">Returns an iterator that iterates over the values in <code>opts</code>, limited to the keys readable by the current pudding type.</p>
<p class=""><a class="anchor" id="autotoc_md21432"></a> </p><h5>Example</h5>
<p class="">' </p><div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
