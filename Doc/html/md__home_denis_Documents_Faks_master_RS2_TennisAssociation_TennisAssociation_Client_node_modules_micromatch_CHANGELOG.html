...
<title>Tennis Association: Release history</title>
...
<div class="contents">
<div class="textblock"><p class=""><b>Guiding Principles</b></p>
<p class="">All notable changes to this project will be documented in this file.</p>
<p class="">The format is based on <a href="http://keepachangelog.com/en/1.0.0/">Keep a Changelog</a> and this project adheres to <a href="http://semver.org/spec/v2.0.0.html">Semantic Versioning</a>.</p>
<p class="">&lt;details&gt;</p>
<ul>
...
<p class="">&lt;/details&gt;</p>
<p class="">&lt;details&gt;</p>
<p class=""><b>Types of changes</b></p>
<p class="">Changelog entries are classified using the following labels _(from <a href="http://keepachangelog.com/">keep-a-changelog</a>_):</p>
<ul>
...
<p class="">&lt;/details&gt;</p>
<h1><a class="anchor" id="autotoc_md21244"></a>
[4.0.0] - 2019-03-20</h1>
...
<h2><a class="anchor" id="autotoc_md21246"></a>
Breaking changes</h2>
<ul>
<li>Removed support for passing an array of brace patterns to <code>micromatch.braces()</code>.</li>
<li>To strictly enforce closing brackets (for <code>{</code>, <code>[</code>, and <code>(</code>), you must now use <code>strictBrackets=true</code> instead of <code>strictErrors</code>. <br  />
</li>
...
<h1><a class="anchor" id="autotoc_md21247"></a>
[3.0.0] - 2017-04-11</h1>
<p class="">Complete overhaul, with 36,000+ new unit tests validated against actual output generated by Bash and minimatch. More specifically, 35,000+ of the tests:</p>
<ul>
...
<p class="">This refactor introduces a parser and compiler that are supersets of more granular parsers and compilers from other sub-modules. Each of these sub-modules has a singular responsibility and focuses on a certain type of matching that aligns with a specific part of the Bash "expansion" API.</p>
<p class="">These sub-modules work like plugins to seamlessly create the micromatch parser/compiler, so that strings are parsed in one pass, an <a href="https://gist.github.com/jonschlinkert/099c8914f56529f75bc757cc9e5e8e2a">AST is created</a>, then a new string is generated by the compiler.</p>
<p class="">Here are those sub-modules with links to related prs on those modules if you want to see how they contribute to this code:</p>
<p class=""><a href="https://github.com/jonschlinkert/nanomatch">nanomatch</a> (new library) - glob expansion (<code>*</code>, <code>**</code>, <code>?</code> and <code>[...]</code>)) <a href="https://github.com/jonschlinkert/braces/pull/10">braces</a> - brace expansion (<code>{1..10}</code>, <code>{a,b,c}</code>, etc) <a href="https://github.com/jonschlinkert/extglob/pull/5">extglob</a> - extended globs (<code>!(a|b)</code>, <code>@(!(foo|bar))</code>, etc) <a href="https://github.com/jonschlinkert/expand-brackets/pull/5">expand-brackets</a> - POSIX character classes <code>[[:alpha:][:digit:]]</code></p>
<p class=""><b>Added</b></p>
<ul>
...
<h1><a class="anchor" id="autotoc_md21249"></a>
[1.0.0] - 2016-12-12</h1>
<p class="">Stable release.</p>
<h1><a class="anchor" id="autotoc_md21250"></a>
[0.1.0] - 2016-10-08</h1>
