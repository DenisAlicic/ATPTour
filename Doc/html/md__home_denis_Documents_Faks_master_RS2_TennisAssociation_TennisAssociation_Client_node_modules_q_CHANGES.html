...
<title>Tennis Association: 1.4.1</title>
...
1.0.0</h1>
<p class="">:cake: This is all but a re-release of version 0.9, which has settled into a gentle maintenance mode and rightly deserves an official 1.0. An ambitious 2.0 release is already around the corner, but 0.9/1.0 have been distributed far and wide and demand long term support.</p>
<ul>
...
0.9.0</h1>
<p class="">This release removes many layers of deprecated methods and brings Q closer to alignment with Mark Miller’s TC39 <a href="http://wiki.ecmascript.org/doku.php?id=strawman:concurrency">strawman</a> for concurrency. At the same time, it fixes many bugs and adds a few features around error handling. Finally, it comes with an updated and comprehensive <a href="https://github.com/kriskowal/q/wiki/API-Reference">API Reference</a>.</p>
<h2><a class="anchor" id="autotoc_md3706"></a>
API Cleanup</h2>
<p class="">The following deprecated or undocumented methods have been removed. Their replacements are listed here:</p>
<table class="doxtable">
</table>
<p class="">0.8.x method </p>
<p class="">0.9 replacement  &lt;/thead&gt; &lt;tbody&gt; </p>
<p class=""><code>Q.ref</code> </p>
<p class=""><code>Q</code>  </p>
<p class=""><code>call</code>, <code>apply</code>, <code>bind</code> (*) </p>
<p class=""><code>fcall</code>/<code>invoke</code>, <code>fapply</code>/<code>post</code>, <code>fbind</code>  </p>
<p class=""><code>ncall</code>, <code>napply</code> (*) </p>
<p class=""><code>nfcall</code>/<code>ninvoke</code>, <code>nfapply</code>/<code>npost</code>  </p>
<p class=""><code>end</code> </p>
<p class=""><code>done</code>  </p>
<p class=""><code>put</code> </p>
<p class=""><code>set</code>  </p>
<p class=""><code>node</code> </p>
<p class=""><code>nbind</code>  </p>
<p class=""><code>nend</code> </p>
<p class=""><code>nodeify</code>  </p>
<p class=""><code>isResolved</code> </p>
<p class=""><code>isPending</code>  </p>
<p class=""><code>deferred.node</code> </p>
<p class=""><code>deferred.makeNodeResolver</code>  </p>
<p class=""><code>Method</code>, <code>sender</code> </p>
<p class=""><code>dispatcher</code>  </p>
<p class=""><code>send</code> </p>
<p class=""><code>dispatch</code>  </p>
<p class=""><code>view</code>, <code>viewInfo</code> </p>
<p class="">(none)  &lt;/tbody&gt; </p>
<p class="">(*) Use of <code>thisp</code> is discouraged. For calling methods, use <code>post</code> or <code>invoke</code>.</p>
