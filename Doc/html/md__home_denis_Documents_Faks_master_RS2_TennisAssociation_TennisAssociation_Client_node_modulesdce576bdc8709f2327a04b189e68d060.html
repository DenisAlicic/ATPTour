...
<title>Tennis Association: @npmcli/run-script</title>
...
<div class="title">@npmcli/run-script </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p class="">Run a lifecycle script for a package (descendant of npm-lifecycle)</p>
...
<div class="line">  })</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md15454"></a>
API</h1>
<p class="">Call the exported <code>runScript</code> function with an options object.</p>
<p class="">Returns a promise that resolves to the result of the execution. Promise rejects if the execution fails (exits non-zero) or has any other error. Rejected errors are decorated with the same values as the result object.</p>
<p class="">If the stdio options mean that it'll have a piped stdin, then the stdin is ended immediately on the child process. If stdin is shared with the parent terminal, then it is up to the user to end it, of course.</p>
<h2><a class="anchor" id="autotoc_md15455"></a>
Results</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md15456"></a>
Options</h2>
<ul>
...
<p class="">Note that this does <em>not</em> run pre-event and post-event scripts. The caller has to manage that process themselves.</p>
<h1><a class="anchor" id="autotoc_md15457"></a>
Differences from &lt;a href="https://github.com/npm/npm-lifecycle"&gt;npm-lifecycle&lt;/a&gt;</h1>
<p class="">This is an implementation to satisfy <a href="https://github.com/npm/rfcs/pull/90">RFC 90</a>, <a href="https://github.com/npm/rfcs/pull/77">RFC 77</a>, and <a href="https://github.com/npm/rfcs/pull/73">RFC 73</a>.</p>
<p class="">Apart from those behavior changes in npm v7, this is also just refresh of the codebase, with modern coding techniques and better test coverage.</p>
<p class="">Functionally, this means:</p>
<ul>
