...
<title>Tennis Association: Circular Dependency Plugin</title>
...
<div class="contents">
<div class="textblock"><p class="">Detect modules with circular dependencies when bundling with webpack.</p>
<p class="">Circular dependencies are often a necessity in complex software, the presence of a circular dependency doesn't always imply a bug, but in the case where you believe a bug exists, this module may help find it.</p>
<h2><a class="anchor" id="autotoc_md9422"></a>
Webpack Versions</h2>
<p class="">The latest major version of this plugin <code>5</code>, supports webpack <code>4.0.1</code> and greater as a peer dependency. Major version <code>4</code> of this plugin and below are intended to support webpack <code>3.x.x</code> and below as a peer dependency.</p>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md9424"></a>
Advanced Usage</h2>
<div class="fragment"><div class="line">// webpack.config.js</div>
<div class="line">const CircularDependencyPlugin = require(&#39;circular-dependency-plugin&#39;)</div>
<div class="line"> </div>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><p class="">If you have some number of cycles and want to fail if any new ones are introduced, you can use the life cycle methods to count and fail when the count is exceeded. (Note if you care about detecting a cycle being replaced by another, this won't catch that.)</p>
<div class="fragment"><div class="line">// webpack.config.js</div>
<div class="line">const CircularDependencyPlugin = require(&#39;circular-dependency-plugin&#39;)</div>
<div class="line"> </div>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md9425"></a>
Maintenance</h2>
<p class="">This module is maintained despite few changes being necessary, please open issues if you find any bugs relating to integration with webpack core. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<!-- start footer part -->
