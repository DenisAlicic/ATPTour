...
<title>Tennis Association: aws4</title>
...
<div class="contents">
<div class="textblock"><p class=""><a href="https://travis-ci.org/github/mhart/aws4"><img src="https://api.travis-ci.org/mhart/aws4.png?branch=master" alt="Build Status" class="inline"/></a></p>
<p class="">A small utility to sign vanilla Node.js http(s) request options using Amazon's <a href="https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html">AWS Signature Version 4</a>.</p>
<p class="">If you want to sign and send AWS requests in a modern browser, or an environment like <a href="https://developers.cloudflare.com/workers/">Cloudflare Workers</a>, then check out <a href="https://github.com/mhart/aws4fetch">aws4fetch</a> – otherwise you can also bundle this library for use <a href="./browser">in older browsers</a>.</p>
<p class="">The only AWS service that <em>doesn't</em> support v4 as of 2020-05-22 is <a href="https://docs.aws.amazon.com/AmazonSimpleDB/latest/DeveloperGuide/SDB_API.html">SimpleDB</a> (it only supports <a href="https://github.com/mhart/aws2">AWS Signature Version 2</a>).</p>
<p class="">It also provides defaults for a number of core AWS headers and request parameters, making it very easy to query AWS services, or build out a fully-featured AWS library.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13569"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md13570"></a>
aws4.sign(requestOptions, [credentials])</h2>
<p class="">Calculates and populates any necessary AWS headers and/or request options on <code>requestOptions</code>. Returns <code>requestOptions</code> as a convenience for chaining.</p>
<p class=""><code>requestOptions</code> is an object holding the same options that the Node.js <a href="https://nodejs.org/docs/latest/api/http.html#http_http_request_options_callback">http.request</a> function takes.</p>
<p class="">The following properties of <code>requestOptions</code> are used in the signing or populated if they don't already exist:</p>
<ul>
...
<p class="">Your AWS credentials (which can be found in your <a href="https://portal.aws.amazon.com/gp/aws/securityCredentials">AWS console</a>) can be specified in one of two ways:</p>
<ul>
...
</div><!-- fragment --><p class="">(will also use <code>AWS_ACCESS_KEY</code> and <code>AWS_SECRET_KEY</code> if available)</p>
<p class="">The <code>sessionToken</code> property and <code>AWS_SESSION_TOKEN</code> environment variable are optional for signing with <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html">IAM STS temporary credentials</a>.</p>
<h1><a class="anchor" id="autotoc_md13571"></a>
Installation</h1>
<p class="">With <a href="https://www.npmjs.com/">npm</a> do:</p>
<div class="fragment"><div class="line">npm install aws4</div>
</div><!-- fragment --><p class="">Can also be used <a href="./browser">in the browser</a>.</p>
<h1><a class="anchor" id="autotoc_md13572"></a>
Thanks</h1>
<p class="">Thanks to <a href="https://github.com/jed">@jed</a> for his <a href="https://github.com/jed/dynamo-client">dynamo-client</a> lib where I first committed and subsequently extracted this code.</p>
<p class="">Also thanks to the <a href="https://github.com/aws/aws-sdk-js">official Node.js AWS SDK</a> for giving me a start on implementing the v4 signature. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<!-- start footer part -->
