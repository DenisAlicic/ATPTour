...
<title>Tennis Association: ajv-keywords</title>
...
<p class=""><sup>*</sup> - keywords that modify data</p>
<h1><a class="anchor" id="autotoc_md8177"></a>
Install</h1>
<div class="fragment"><div class="line">npm install ajv-keywords</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8178"></a>
Usage</h1>
<p class="">To add all available keywords:</p>
...
</div><!-- fragment --><p class="">To add a single keyword:</p>
<div class="fragment"><div class="line">require(&#39;ajv-keywords&#39;)(ajv, &#39;instanceof&#39;);</div>
</div><!-- fragment --><p class="">To add multiple keywords:</p>
<div class="fragment"><div class="line">require(&#39;ajv-keywords&#39;)(ajv, [&#39;typeof&#39;, &#39;instanceof&#39;]);</div>
</div><!-- fragment --><p class="">To add a single keyword in browser (to avoid adding unused code):</p>
...
Keywords</h1>
<h2><a class="anchor" id="autotoc_md8180"></a>
Types</h2>
<h3><a class="anchor" id="autotoc_md8181"></a>
&lt;tt&gt;typeof&lt;/tt&gt;</h3>
<p class="">Based on JavaScript <code>typeof</code> operation.</p>
<p class="">The value of the keyword should be a string (<code>"undefined"</code>, <code>"string"</code>, <code>"number"</code>, <code>"object"</code>, <code>"function"</code>, <code>"boolean"</code> or <code>"symbol"</code>) or array of strings.</p>
<p class="">To pass validation the result of <code>typeof</code> operation on the value should be equal to the string (or one of the strings in the array).</p>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8182"></a>
&lt;tt&gt;instanceof&lt;/tt&gt;</h3>
<p class="">Based on JavaScript <code>instanceof</code> operation.</p>
<p class="">The value of the keyword should be a string (<code>"Object"</code>, <code>"Array"</code>, <code>"Function"</code>, <code>"Number"</code>, <code>"String"</code>, <code>"Date"</code>, <code>"RegExp"</code>, <code>"Promise"</code> or <code>"Buffer"</code>) or array of strings.</p>
<p class="">To pass validation the result of <code>data instanceof ...</code> operation on the value should be true:</p>
...
</div><!-- fragment --><p class="">You can add your own constructor function to be recognised by this keyword:</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8183"></a>
Keywords for numbers</h2>
<h3><a class="anchor" id="autotoc_md8184"></a>
&lt;tt&gt;range&lt;/tt&gt; and &lt;tt&gt;exclusiveRange&lt;/tt&gt;</h3>
<p class="">Syntax sugar for the combination of minimum and maximum keywords, also fails schema compilation if there are no numbers in the range.</p>
<p class="">The value of this keyword must be the array consisting of two numbers, the second must be greater or equal than the first one.</p>
<p class="">If the validated value is not a number the validation passes, otherwise to pass validation the value should be greater (or equal) than the first number and smaller (or equal) than the second number in the array. If <code>exclusiveRange</code> keyword is present in the same schema and its value is true, the validated value must not be equal to the range boundaries.</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8185"></a>
Keywords for strings</h2>
<h3><a class="anchor" id="autotoc_md8186"></a>
&lt;tt&gt;regexp&lt;/tt&gt;</h3>
<p class="">This keyword allows to use regular expressions with flags in schemas (the standard <code>pattern</code> keyword does not support flags).</p>
<p class="">This keyword applies only to strings. If the data is not a string, the validation succeeds.</p>
<p class="">The value of this keyword can be either a string (the result of <code>regexp.toString()</code>) or an object with the properties <code>pattern</code> and <code>flags</code> (the same strings that should be passed to RegExp constructor).</p>
...
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8187"></a>
&lt;tt&gt;formatMaximum&lt;/tt&gt; / &lt;tt&gt;formatMinimum&lt;/tt&gt; and &lt;tt&gt;formatExclusiveMaximum&lt;/tt&gt; / &lt;tt&gt;formatExclusiveMinimum&lt;/tt&gt;</h3>
<p class="">These keywords allow to define minimum/maximum constraints when the format keyword defines ordering.</p>
<p class="">These keywords apply only to strings. If the data is not a string, the validation succeeds.</p>
<p class="">The value of keyword <code>formatMaximum</code> (<code>formatMinimum</code>) should be a string. This value is the maximum (minimum) allowed value for the data to be valid as determined by <code>format</code> keyword. If <code>format</code> is not present schema compilation will throw exception.</p>
<p class="">When this keyword is added, it defines comparison rules for formats <code>"date"</code>, <code>"time"</code> and <code>"date-time"</code>. Custom formats also can have comparison rules. See <a href="https://github.com/epoberezkin/ajv#api-addformat">addFormat</a> method.</p>
<p class="">The value of keyword <code>formatExclusiveMaximum</code> (<code>formatExclusiveMinimum</code>) should be a boolean value. These keyword cannot be used without <code>formatMaximum</code> (<code>formatMinimum</code>). If this keyword value is equal to <code>true</code>, the data to be valid should not be equal to the value in <code>formatMaximum</code> (<code>formatMinimum</code>) keyword.</p>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8188"></a>
&lt;tt&gt;transform&lt;/tt&gt;</h3>
<p class="">This keyword allows a string to be modified before validation.</p>
<p class="">These keywords apply only to strings. If the data is not a string, the transform is skipped.</p>
<p class="">There are limitation due to how ajv is written:</p><ul>
...
<p class=""><b>Supported options:</b></p><ul>
...
<p class="">Options are applied in the order they are listed.</p>
<p class="">Note: <code>toEnumCase</code> requires that all allowed values are unique when case insensitive.</p>
<p class=""><b>Example: multiple options</b> </p><div class="fragment"><div class="line">require(&#39;ajv-keywords&#39;)(ajv, [&#39;transform&#39;]);</div>
<div class="line"> </div>
<div class="line">var schema = {</div>
...
</div><!-- fragment --><p class=""><b>Example: <code>enumcase</code></b> </p><div class="fragment"><div class="line">require(&#39;ajv-keywords&#39;)(ajv, [&#39;transform&#39;]);</div>
<div class="line"> </div>
<div class="line">var schema = {</div>
<div class="line">  type: &#39;array&#39;,</div>
<div class="line">  items: {</div>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8189"></a>
Keywords for arrays</h2>
<h3><a class="anchor" id="autotoc_md8190"></a>
&lt;tt&gt;uniqueItemProperties&lt;/tt&gt;</h3>
<p class="">The keyword allows to check that some properties in array items are unique.</p>
<p class="">This keyword applies only to arrays. If the data is not an array, the validation succeeds.</p>
<p class="">The value of this keyword must be an array of strings - property names that should have unique values across all items.</p>
...
<div class="line">];</div>
</div><!-- fragment --><p class="">This keyword is contributed by <a href="https://github.com/blainesch">@blainesch</a>.</p>
<h2><a class="anchor" id="autotoc_md8191"></a>
Keywords for objects</h2>
<h3><a class="anchor" id="autotoc_md8192"></a>
&lt;tt&gt;allRequired&lt;/tt&gt;</h3>
<p class="">This keyword allows to require the presence of all properties used in <code>properties</code> keyword in the same schema object.</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value of this keyword must be boolean.</p>
<p class="">If the value of the keyword is <code>false</code>, the validation succeeds.</p>
<p class="">If the value of the keyword is <code>true</code>, the validation succeeds if the data contains all properties defined in <code>properties</code> keyword (in the same schema object).</p>
<p class="">If the <code>properties</code> keyword is not present in the same schema object, schema compilation will throw exception.</p>
<div class="fragment"><div class="line">var schema = {</div>
<div class="line">  properties: {</div>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8193"></a>
&lt;tt&gt;anyRequired&lt;/tt&gt;</h3>
<p class="">This keyword allows to require the presence of any (at least one) property from the list.</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value of this keyword must be an array of strings, each string being a property name. For data object to be valid at least one of the properties in this array should be present in the object.</p>
<div class="fragment"><div class="line">var schema = {</div>
...
<p class="">This keyword allows to require the presence of only one property from the list.</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value of this keyword must be an array of strings, each string being a property name. For data object to be valid exactly one of the properties in this array should be present in the object.</p>
<div class="fragment"><div class="line">var schema = {</div>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8195"></a>
&lt;tt&gt;patternRequired&lt;/tt&gt;</h3>
<p class="">This keyword allows to require the presence of properties that match some pattern(s).</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value of this keyword should be an array of strings, each string being a regular expression. For data object to be valid each regular expression in this array should match at least one property name in the data object.</p>
<p class="">If the array contains multiple regular expressions, more than one expression can match the same property name.</p>
...
&lt;tt&gt;prohibited&lt;/tt&gt;</h3>
<p class="">This keyword allows to prohibit that any of the properties in the list is present in the object.</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value of this keyword should be an array of strings, each string being a property name. For data object to be valid none of the properties in this array should be present in the object.</p>
...
<div class="line">];</div>
</div><!-- fragment --><p class=""><b>Please note</b>: &lsquo;{prohibited: ['foo&rsquo;, 'bar']}<code>is equivalent to</code>{not: {anyRequired: ['foo', 'bar']}}` (i.e. it has the same validation result for any data).</p>
<h3><a class="anchor" id="autotoc_md8197"></a>
&lt;tt&gt;deepProperties&lt;/tt&gt;</h3>
<p class="">This keyword allows to validate deep properties (identified by JSON pointers).</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value should be an object, where keys are JSON pointers to the data, starting from the current position in data, and the values are JSON schemas. For data object to be valid the value of each JSON pointer should be valid according to the corresponding schema.</p>
<div class="fragment"><div class="line">var schema = {</div>
<div class="line">  type: &#39;object&#39;,</div>
...
<p class="">This keyword allows to check that some deep properties (identified by JSON pointers) are available.</p>
<p class="">This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p class="">The value should be an array of JSON pointers to the data, starting from the current position in data. For data object to be valid each JSON pointer should be some existing part of the data.</p>
<div class="fragment"><div class="line">var schema = {</div>
<div class="line">  type: &#39;object&#39;,</div>
...
<div class="line">  ]</div>
<div class="line">};</div>
</div><!-- fragment --><p class="">See <a href="https://github.com/json-schema-org/json-schema-spec/issues/203#issue-197211916">json-schema-org/json-schema-spec#203</a> for an example of the equivalent schema without <code>deepRequired</code> keyword.</p>
<h2><a class="anchor" id="autotoc_md8199"></a>
Compound keywords</h2>
<h3><a class="anchor" id="autotoc_md8200"></a>
&lt;tt&gt;switch&lt;/tt&gt; (deprecated)</h3>
<p class=""><b>Please note</b>: this keyword is provided to preserve backward compatibility with previous versions of Ajv. It is strongly recommended to use <code>if</code>/<code>then</code>/<code>else</code> keywords instead, as they have been added to the draft-07 of JSON Schema specification.</p>
<p class="">This keyword allows to perform advanced conditional validation.</p>
<p class="">The value of the keyword is the array of if/then clauses. Each clause is the object with the following properties:</p>
<ul>
...
<p class="">The validation process is dynamic; all clauses are executed sequentially in the following way:</p>
<ol type="1">
...
</div><!-- fragment --><p class="">The above schema is equivalent to (for example):</p>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8201"></a>
&lt;tt&gt;select&lt;/tt&gt;/&lt;tt&gt;selectCases&lt;/tt&gt;/&lt;tt&gt;selectDefault&lt;/tt&gt;</h3>
<p class="">These keywords allow to choose the schema to validate the data based on the value of some property in the validated data.</p>
<p class="">These keywords must be present in the same schema object (<code>selectDefault</code> is optional).</p>
<p class="">The value of <code>select</code> keyword should be a <a href="https://github.com/epoberezkin/ajv/tree/5.0.2-beta.0#data-reference">$data reference</a> that points to any primitive JSON type (string, number, boolean or null) in the data that is validated. You can also use a constant of primitive type as the value of this keyword (e.g., for debugging purposes).</p>
<p class="">The value of <code>selectCases</code> keyword must be an object where each property name is a possible string representation of the value of <code>select</code> keyword and each property value is a corresponding schema (from draft-06 it can be boolean) that must be used to validate the data.</p>
<p class="">The value of <code>selectDefault</code> keyword is a schema (from draft-06 it can be boolean) that must be used to validate the data in case <code>selectCases</code> has no key equal to the stringified value of <code>select</code> keyword.</p>
<p class="">The validation succeeds in one of the following cases:</p><ul>
...
<p class="">If <code>select</code> value (in data) is not a primitive type the validation fails.</p>
<p class=""><b>Please note</b>: these keywords require Ajv <code>$data</code> option to support <a href="https://github.com/epoberezkin/ajv/tree/5.0.2-beta.0#data-reference">$data reference</a>.</p>
...
<p class="">This keyword allows to assign dynamic defaults to properties, such as timestamps, unique IDs etc.</p>
<p class="">This keyword only works if <code>useDefaults</code> options is used and not inside <code>anyOf</code> keywords etc., in the same way as <a href="https://github.com/epoberezkin/ajv#assigning-defaults">default keyword treated by Ajv</a>.</p>
<p class="">The keyword should be added on the object level. Its value should be an object with each property corresponding to a property name, in the same way as in standard <code>properties</code> keyword. The value of each property can be:</p>
<ul>
...
<p class="">The properties used in <code>dynamicDefaults</code> should not be added to <code>required</code> keyword (or validation will fail), because unlike <code>default</code> this keyword is processed after validation.</p>
<p class="">There are several predefined dynamic default functions:</p>
<ul>
...
<div class="line">ajv.validate(data); // true</div>
<div class="line">data; // { ts: &#39;2016-12-01T22:07:28.829Z&#39;, r: 25, id: 0 }</div>
</div><!-- fragment --><p class="">You can add your own dynamic default function to be recognised by this keyword:</p>
...
</div><!-- fragment --><p class="">You also can define dynamic default that accepts parameters, e.g. version of uuid:</p>
<div class="fragment"><div class="line">var uuid = require(&#39;uuid&#39;);</div>
<div class="line"> </div>
...
<div class="line">  }</div>
<div class="line">};</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8204"></a>
Security contact</h1>
...
<p class="">Please do NOT report security vulnerabilities via GitHub issues.</p>
<h1><a class="anchor" id="autotoc_md8205"></a>
Open-source software support</h1>
<p class="">Ajv-keywords is a part of <a href="https://tidelift.com/subscription/pkg/npm-ajv-keywords?utm_source=npm-ajv-keywords&amp;utm_medium=referral&amp;utm_campaign=readme">Tidelift subscription</a> - it provides a centralised support to open-source software users, in addition to the support provided by software maintainers.</p>
<h1><a class="anchor" id="autotoc_md8206"></a>
License</h1>
<p class=""><a href="https://github.com/epoberezkin/ajv-keywords/blob/master/LICENSE">MIT</a> </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<!-- start footer part -->
