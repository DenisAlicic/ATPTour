...
<title>Tennis Association: Forge</title>
...
<div class="contents">
<div class="textblock"><p class=""><a href="https://nodei.co/npm/node-forge/"><img src="https://nodei.co/npm/node-forge.png?downloads=true&amp;downloadRank=true&amp;stars=true" alt="npm package" class="inline"/></a></p>
<p class=""><a href="https://travis-ci.org/digitalbazaar/forge"><img src="https://img.shields.io/travis/digitalbazaar/forge.svg?branch=master" alt="Build status" style="pointer-events: none;" class="inline"/></a></p>
<p class="">A native implementation of <a href="https://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> (and various other cryptographic tools) in <a href="https://en.wikipedia.org/wiki/JavaScript">JavaScript</a>.</p>
<h1><a class="anchor" id="autotoc_md31822"></a>
Introduction</h1>
<p class="">The Forge software is a fully native implementation of the <a href="https://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> protocol in JavaScript, a set of cryptography utilities, and a set of tools for developing Web Apps that utilize many network resources.</p>
<h1><a class="anchor" id="autotoc_md31823"></a>
Performance</h1>
<p class="">Forge is fast. Benchmarks against other popular JavaScript cryptography libraries can be found here:</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md31824"></a>
Documentation</h1>
<ul>
...
<h2><a class="anchor" id="autotoc_md31825"></a>
API</h2>
<ul>
<li><a href="#options">Options</a></li>
</ul>
<h2><a class="anchor" id="autotoc_md31826"></a>
Transports</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md31827"></a>
Ciphers</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md31828"></a>
PKI</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md31829"></a>
Message Digests</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md31830"></a>
Utilities</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md31831"></a>
Other</h2>
<ul>
...
<hr  />
<h1><a class="anchor" id="autotoc_md31833"></a>
Installation</h1>
<p class=""><b>Note</b>: Please see the <a href="#security-considerations">Security Considerations</a> section before using packaging systems and pre-built files.</p>
<p class="">Forge uses a <a href="https://en.wikipedia.org/wiki/CommonJS">CommonJS</a> module structure with a build process for browser bundles. The older <a href="https://github.com/digitalbazaar/forge/tree/0.6.x">0.6.x</a> branch with standalone files is available but will not be regularly updated.</p>
<h2><a class="anchor" id="autotoc_md31834"></a>
Node.js</h2>
<p class="">If you want to use forge with <a href="https://nodejs.org/">Node.js</a>, it is available through <code>npm</code>:</p>
<p class=""><a href="https://npmjs.org/package/node-forge">https://npmjs.org/package/node-forge</a></p>
<p class="">Installation: </p><pre class="fragment">npm install node-forge
</pre><p> You can then use forge as a regular module:</p>
<div class="fragment"><div class="line">var forge = require(&#39;node-forge&#39;);</div>
</div><!-- fragment --><p class="">The npm package includes pre-built <code>forge.min.js</code>, <code>forge.all.min.js</code>, and <code>prime.worker.min.js</code> using the <a href="https://github.com/umdjs/umd">UMD</a> format.</p>
<h2><a class="anchor" id="autotoc_md31835"></a>
Bundle / Bower</h2>
<p class="">Each release is published in a separate repository as pre-built and minimized basic forge bundles using the <a href="https://github.com/umdjs/umd">UMD</a> format.</p>
<p class=""><a href="https://github.com/digitalbazaar/forge-dist">https://github.com/digitalbazaar/forge-dist</a></p>
<p class="">This bundle can be used in many environments. In particular it can be installed with <a href="https://bower.io/">Bower</a>: </p><pre class="fragment">bower install forge
</pre> <h2><a class="anchor" id="autotoc_md31836"></a>
jsDelivr CDN</h2>
<p class="">To use it via <a href="https://www.jsdelivr.com/package/npm/node-forge">jsDelivr</a> include this in your html:</p>
<div class="fragment"><div class="line">&lt;script src=&quot;https://cdn.jsdelivr.net/npm/node-forge@0.7.0/dist/forge.min.js&quot;&gt;&lt;/script&gt;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31837"></a>
unpkg CDN</h2>
<p class="">To use it via <a href="https://unpkg.com/#/">unpkg</a> include this in your html:</p>
<div class="fragment"><div class="line">&lt;script src=&quot;https://unpkg.com/node-forge@0.7.0/dist/forge.min.js&quot;&gt;&lt;/script&gt;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31838"></a>
Development Requirements</h2>
<p class="">The core JavaScript has the following requirements to build and test:</p>
<ul>
...
<p class="">Some special networking features can optionally use a Flash component. See the <a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_node_forge_flash_README.html">Flash README</a> for details.</p>
<h2><a class="anchor" id="autotoc_md31839"></a>
Building for a web browser</h2>
<p class="">To create single file bundles for use with browsers run the following: </p><pre class="fragment">npm install
npm run build
...
</div><!-- fragment --><p class="">The above bundles will synchronously create a global 'forge' object.</p>
<p class=""><b>Note</b>: These bundles will not include any WebWorker scripts (eg: <code>dist/prime.worker.js</code>), so these will need to be accessible from the browser if any WebWorkers are used.</p>
<h2><a class="anchor" id="autotoc_md31840"></a>
Building a custom browser bundle</h2>
<p class="">The build process uses <a href="https://webpack.github.io/">webpack</a> and the <a href="./webpack.config.js">config</a> file can be modified to generate a file or files that only contain the parts of forge you need.</p>
<p class=""><a href="http://browserify.org/">Browserify</a> override support is also present in <code>package.json</code>.</p>
<h1><a class="anchor" id="autotoc_md31841"></a>
Testing</h1>
<h2><a class="anchor" id="autotoc_md31842"></a>
Prepare to run tests</h2>
<pre class="fragment">npm install
</pre> <h2><a class="anchor" id="autotoc_md31843"></a>
Running automated tests with Node.js</h2>
<p class="">Forge natively runs in a <a href="https://nodejs.org/">Node.js</a> environment: </p><pre class="fragment">npm test
</pre> <h2><a class="anchor" id="autotoc_md31844"></a>
Running automated tests with Headless Chrome</h2>
<p class="">Automated testing is done via <a href="https://karma-runner.github.io/">Karma</a>. By default it will run the tests with Headless Chrome. </p><pre class="fragment">npm run test-karma
...
</pre> <h2><a class="anchor" id="autotoc_md31845"></a>
Running automated tests with one or more browsers</h2>
<p class="">You can also specify one or more browsers to use. </p><pre class="fragment">npm run test-karma -- --browsers Chrome,Firefox,Safari,ChromeHeadless
</pre><p> The reporter option and <code>BUNDLER</code> environment variable can also be used.</p>
<h2><a class="anchor" id="autotoc_md31846"></a>
Running manual tests in a browser</h2>
<p class="">Testing in a browser uses <a href="https://webpack.github.io/">webpack</a> to combine forge and all tests and then loading the result in a browser. A simple web server is provided that will output the HTTP or HTTPS URLs to load. It also will start a simple Flash Policy Server. Unit tests and older legacy tests are provided. Custom ports can be used by running <code>node tests/server.js</code> manually.</p>
<p class="">To run the unit tests in a browser a special forge build is required: </p><pre class="fragment">npm run test-build
...
</pre> <h2><a class="anchor" id="autotoc_md31847"></a>
Running other tests</h2>
<p class="">There are some other random tests and benchmarks available in the tests directory.</p>
<h2><a class="anchor" id="autotoc_md31848"></a>
Coverage testing</h2>
<p class="">To perform coverage testing of the unit tests, run the following. The results will be put in the <code>coverage/</code> directory. Note that coverage testing can slow down some tests considerably. </p><pre class="fragment">npm install
npm run coverage
</pre> <h1><a class="anchor" id="autotoc_md31849"></a>
Contributing</h1>
<p class="">Any contributions (eg: PRs) that are accepted will be brought under the same license used by the rest of the Forge project. This license allows Forge to be used under the terms of either the BSD License or the GNU General Public License (GPL) Version 2.</p>
<p class="">See: <a href="https://github.com/digitalbazaar/forge/blob/cbebca3780658703d925b61b2caffb1d263a6c1d/LICENSE">LICENSE</a></p>
<p class="">If a contribution contains 3rd party source code with its own license, it may retain it, so long as that license is compatible with the Forge license.</p>
<h1><a class="anchor" id="autotoc_md31850"></a>
API</h1>
<p class=""><a class="anchor" id="options"></a></p>
<h2><a class="anchor" id="autotoc_md31851"></a>
Options</h2>
<p class="">If at any time you wish to disable the use of native code, where available, for particular forge features like its secure random number generator, you may set the <code>forge.options.usePureJavaScript</code> flag to <code>true</code>. It is not recommended that you set this flag as native code is typically more performant and may have stronger security properties. It may be useful to set this flag to test certain features that you plan to run in environments that are different from your testing environment.</p>
<p class="">To disable native code when including forge in the browser:</p>
...
</div><!-- fragment --><p class="">To disable native code when using Node.js:</p>
<div class="fragment"><div class="line">var forge = require(&#39;node-forge&#39;);</div>
<div class="line">forge.options.usePureJavaScript = true;</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31852"></a>
Transports</h1>
<p class=""><a class="anchor" id="tls"></a></p>
<h2><a class="anchor" id="autotoc_md31853"></a>
TLS</h2>
<p class="">Provides a native javascript client and server-side <a href="https://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> implementation.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class="">Connect to a TLS server using node's net.Socket:</p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="http"></a></p>
<h2><a class="anchor" id="autotoc_md31854"></a>
HTTP</h2>
<p class="">Provides a native <a href="https://en.wikipedia.org/wiki/JavaScript">JavaScript</a> mini-implementation of an http client that uses pooled sockets.</p>
<p class=""><b>Examples</b></p>
...
<div class="line">  }</div>
<div class="line">};</div>
</div><!-- fragment --><p class=""><a class="anchor" id="ssh"></a></p>
<h2><a class="anchor" id="autotoc_md31855"></a>
SSH</h2>
<p class="">Provides some SSH utility functions.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="xhr"></a></p>
<h2><a class="anchor" id="autotoc_md31856"></a>
XHR</h2>
<p class="">Provides an XmlHttpRequest implementation using forge.http as a backend.</p>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">// TODO</div>
</div><!-- fragment --><p class=""><a class="anchor" id="socket"></a></p>
<h2><a class="anchor" id="autotoc_md31857"></a>
Sockets</h2>
<p class="">Provides an interface to create and use raw sockets provided via Flash.</p>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">// TODO</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31858"></a>
Ciphers</h1>
<p class=""><a class="anchor" id="cipher"></a></p>
<h2><a class="anchor" id="autotoc_md31859"></a>
CIPHER</h2>
<p class="">Provides a basic API for block encryption and decryption. There is built-in support for the ciphers: <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a>, <a href="https://en.wikipedia.org/wiki/Triple_DES">3DES</a>, and <a href="https://en.wikipedia.org/wiki/Data_Encryption_Standard">DES</a>, and for the modes of operation: <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">ECB</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CBC</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CFB</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">OFB</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CTR</a>, and <a href="https://en.wikipedia.org/wiki/GCM_mode">GCM</a>.</p>
<p class="">These algorithms are currently supported:</p>
<ul>
<li>AES-ECB</li>
<li>AES-CBC</li>
<li>AES-CFB</li>
...
<div class="line">}</div>
</div><!-- fragment --><p class=""><a class="anchor" id="aes"></a></p>
<h2><a class="anchor" id="autotoc_md31860"></a>
AES</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a> encryption and decryption in <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CBC</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CFB</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">OFB</a>, <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CTR</a>, and <a href="https://en.wikipedia.org/wiki/GCM_mode">GCM</a> modes. See <a href="#cipher">CIPHER</a> for examples.</p>
<p class=""><a class="anchor" id="des"></a></p>
<h2><a class="anchor" id="autotoc_md31861"></a>
DES</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/Triple_DES">3DES</a> and <a href="https://en.wikipedia.org/wiki/Data_Encryption_Standard">DES</a> encryption and decryption in <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">ECB</a> and <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CBC</a> modes. See <a href="#cipher">CIPHER</a> for examples.</p>
<p class=""><a class="anchor" id="rc2"></a></p>
<h2><a class="anchor" id="autotoc_md31862"></a>
RC2</h2>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">// generate a random key and IV</div>
<div class="line">var key = forge.random.getBytesSync(16);</div>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31863"></a>
PKI</h1>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/X.509">X.509</a> certificate support, ED25519 key generation and signing/verifying, and RSA public and private key encoding, decoding, encryption/decryption, and signing/verifying.</p>
<p class=""><a class="anchor" id="ed25519"></a></p>
<h2><a class="anchor" id="autotoc_md31864"></a>
ED25519</h2>
<p class="">Special thanks to <a href="https://github.com/dchest/tweetnacl-js">TweetNaCl.js</a> for providing the bulk of the implementation.</p>
<p class=""><b>Examples</b></p>
...
<div class="line">  publicKey: publicKey</div>
<div class="line">});</div>
</div><!-- fragment --><p class=""><a class="anchor" id="rsa"></a></p>
<h2><a class="anchor" id="autotoc_md31865"></a>
RSA</h2>
<p class=""><b>Examples</b></p>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><p class=""><a class="anchor" id="rsakem"></a></p>
<h2><a class="anchor" id="autotoc_md31866"></a>
RSA-KEM</h2>
<p class=""><b>Examples</b></p>
...
<div class="line">}</div>
</div><!-- fragment --><p class=""><a class="anchor" id="x509"></a></p>
<h2><a class="anchor" id="autotoc_md31867"></a>
X.509</h2>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="pkcs5"></a></p>
<h2><a class="anchor" id="autotoc_md31868"></a>
PKCS#5</h2>
<p class="">Provides the password-based key-derivation function from <a href="https://en.wikipedia.org/wiki/PKCS">PKCS#5</a>.</p>
<p class=""><b>Examples</b></p>
...
<div class="line">});</div>
</div><!-- fragment --><p class=""><a class="anchor" id="pkcs7"></a></p>
<h2><a class="anchor" id="autotoc_md31869"></a>
PKCS#7</h2>
<p class="">Provides cryptographically protected messages from <a href="https://en.wikipedia.org/wiki/Cryptographic_Message_Syntax">PKCS#7</a>.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="pkcs8"></a></p>
<h2><a class="anchor" id="autotoc_md31870"></a>
PKCS#8</h2>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">var pki = forge.pki;</div>
<div class="line"> </div>
...
</div><!-- fragment --><p class=""><a class="anchor" id="pkcs10"></a></p>
<h2><a class="anchor" id="autotoc_md31871"></a>
PKCS#10</h2>
<p class="">Provides certification requests or certificate signing requests (CSR) from <a href="https://en.wikipedia.org/wiki/Certificate_signing_request">PKCS#10</a>.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="pkcs12"></a></p>
<h2><a class="anchor" id="autotoc_md31872"></a>
PKCS#12</h2>
<p class="">Provides the cryptographic archive file format from <a href="https://en.wikipedia.org/wiki/PKCS_%E2%99%AF12">PKCS#12</a>.</p>
<p class=""><b>Note for Chrome/Firefox/iOS/similar users</b>: If you have trouble importing a PKCS#12 container, try using the TripleDES algorithm. It can be passed to <code>forge.pkcs12.toPkcs12Asn1</code> using the &lsquo;{algorithm: '3des&rsquo;}` option.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="asn"></a></p>
<h2><a class="anchor" id="autotoc_md31873"></a>
ASN.1</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/ASN.1">ASN.1</a> DER encoding and decoding.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31874"></a>
Message Digests</h1>
<p class=""><a class="anchor" id="sha1"></a></p>
<h2><a class="anchor" id="autotoc_md31875"></a>
SHA1</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/SHA-1">SHA-1</a> message digests.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="sha256"></a></p>
<h2><a class="anchor" id="autotoc_md31876"></a>
SHA256</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/SHA-256">SHA-256</a> message digests.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="sha384"></a></p>
<h2><a class="anchor" id="autotoc_md31877"></a>
SHA384</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/SHA-384">SHA-384</a> message digests.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="sha512"></a></p>
<h2><a class="anchor" id="autotoc_md31878"></a>
SHA512</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/SHA-512">SHA-512</a> message digests.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="md5"></a></p>
<h2><a class="anchor" id="autotoc_md31879"></a>
MD5</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/MD5">MD5</a> message digests.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="hmac"></a></p>
<h2><a class="anchor" id="autotoc_md31880"></a>
HMAC</h2>
<p class="">Provides <a href="https://en.wikipedia.org/wiki/HMAC">HMAC</a> w/any supported message digest algorithm.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31881"></a>
Utilities</h1>
<p class=""><a class="anchor" id="prime"></a></p>
<h2><a class="anchor" id="autotoc_md31882"></a>
Prime</h2>
<p class="">Provides an API for generating large, random, probable primes.</p>
<p class=""><b>Examples</b></p>
...
<div class="line">  console.log(&#39;random prime&#39;, num.toString(16));</div>
<div class="line">});</div>
</div><!-- fragment --><p class=""><a class="anchor" id="prng"></a></p>
<h2><a class="anchor" id="autotoc_md31883"></a>
PRNG</h2>
<p class="">Provides a <a href="https://en.wikipedia.org/wiki/Fortuna_(PRNG)">Fortuna</a>-based cryptographically-secure pseudo-random number generator, to be used with a cryptographic function backend, e.g. <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a>. An implementation using <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a> as a backend is provided. An API for collecting entropy is given, though if window.crypto.getRandomValues is available, it will be used automatically.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="task"></a></p>
<h2><a class="anchor" id="autotoc_md31884"></a>
Tasks</h2>
<p class="">Provides queuing and synchronizing tasks in a web application.</p>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">// TODO</div>
</div><!-- fragment --><p class=""><a class="anchor" id="util"></a></p>
<h2><a class="anchor" id="autotoc_md31885"></a>
Utilities</h2>
<p class="">Provides utility functions, including byte buffer support, base64, bytes to/from hex, zlib inflate/deflate, etc.</p>
<p class=""><b>Examples</b></p>
...
</div><!-- fragment --><p class=""><a class="anchor" id="log"></a></p>
<h2><a class="anchor" id="autotoc_md31886"></a>
Logging</h2>
<p class="">Provides logging to a javascript console using various categories and levels of verbosity.</p>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">// TODO</div>
</div><!-- fragment --><p class=""><a class="anchor" id="debug"></a></p>
<h2><a class="anchor" id="autotoc_md31887"></a>
Debugging</h2>
<p class="">Provides storage of debugging information normally inaccessible in closures for viewing/investigation.</p>
<p class=""><b>Examples</b></p>
<div class="fragment"><div class="line">// TODO</div>
</div><!-- fragment --><p class=""><a class="anchor" id="flash"></a></p>
<h2><a class="anchor" id="autotoc_md31888"></a>
Flash Networking Support</h2>
<p class="">The <a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_node_forge_flash_README.html">flash README</a> provides details on rebuilding the optional Flash component used for networking. It also provides details on Policy Server support.</p>
<h1><a class="anchor" id="autotoc_md31889"></a>
Security Considerations</h1>
<p class="">When using this code please keep the following in mind:</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md31890"></a>
...
<h1><a class="anchor" id="autotoc_md31891"></a>
Contact</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md31892"></a>
Donations</h1>
<p class="">Financial support is welcome and helps contribute to futher development:</p>
<ul>
