...
<p class="">Tmp offers both an asynchronous and a synchronous API. For all API calls, all the parameters are optional. There also exists a promisified version of the API, see (5) under references below.</p>
...
Usage</h1>
<p class="">Please also check <a href="https://raszi.github.io/node-tmp/">API docs</a>.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10506"></a>
Advanced usage</h1>
...
<div class="line">  console.log(&#39;Filedescriptor: &#39;, fd);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10508"></a>
Synchronous file creation</h2>
<p class="">A synchronous version of the above.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">console.log(&#39;File: &#39;, tmpobj.name);</div>
<div class="line">console.log(&#39;Filedescriptor: &#39;, tmpobj.fd);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10509"></a>
Controlling the Descriptor</h2>
<p class="">As a side effect of creating a unique file <code>tmp</code> gets a file descriptor that is returned to the user as the <code>fd</code> parameter. The descriptor may be used by the application and is closed when the <code>removeCallback</code> is invoked.</p>
<p class="">In some use cases the application does not need the descriptor, needs to close it without removing the file, or needs to remove the file without closing the descriptor. Two options control how the descriptor is managed:</p>
<ul>
...
<div class="line">  console.log(&#39;Dir: &#39;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10511"></a>
Synchronous directory creation</h2>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10517"></a>
Options</h1>
