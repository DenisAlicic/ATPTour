...
<title>Tennis Association: Overview</title>
...
<div class="contents">
<div class="textblock"><p class="">Jobs is a high-order API that adds inputs, runtime type checking, sequencing, and other functionality on top of RxJS' <code>Observable</code>s.</p>
<h1><a class="anchor" id="autotoc_md20328"></a>
Background</h1>
<p class="">An <code>Observable</code> (at a higher level) is a function that receives a <code>Subscriber</code>, and outputs multiple values, and finishes once it calls the <code>Subscriber.prototype.complete()</code> method (in JavaScript):</p>
...
</div><!-- fragment --><p class="">This, of course, can be typed in TypeScript, but those types are not enforced at runtime.</p>
<h1><a class="anchor" id="autotoc_md20329"></a>
Glossary</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md20330"></a>
Description</h1>
<p class="">A <code>JobHandler</code>, similar to observables, is a function that receives an argument and a context, and returns an <code>Observable</code> of messages, which can include outputs that are typed at runtime (using a Json Schema):</p>
...
</div><!-- fragment --><p class="">This seems like a lot of boilerplate in comparison, but there are a few advantages;</p>
<ol type="1">
...
<div class="line">                                                            - ...</div>
</div><!-- fragment --><p class=""><code>JobInboundMessage</code> includes:</p>
<ol type="1">
...
<p class=""><code>JobOutboundMessage</code> includes:</p>
<ol type="1">
...
<p class="">Utilities should have some filtering and dispatching to separate observables, as a convenience for the user. An example of this would be the <code>Job.prototype.output</code> observable which only contains the value contained by messages of type <code>JobOutboundMessageKind.Output</code>.</p>
<h1><a class="anchor" id="autotoc_md20332"></a>
Higher Order Jobs</h1>
<p class="">Because jobs are expected to be pure functions, they can be composed or transformed to create more complex behaviour, similar to how RxJS operators can transform observables.</p>
...
<div class="line">  };</div>
<div class="line">}</div>
</div><!-- fragment --><p class="">Another way to compose jobs is to schedule jobs based on their name, from other jobs.</p>
<div class="fragment"><div class="line">// Runs a job on the hour, every hour, regardless of how long the job takes.</div>
