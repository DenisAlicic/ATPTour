...
<title>Tennis Association: gensync</title>
...
<div class="contents">
<div class="textblock"><p class="">This module allows for developers to write common code that can share implementation details, hiding whether an underlying request happens synchronously or asynchronously. This is in contrast with many current Node APIs which explicitly implement the same API twice, once with calls to synchronous functions, and once with asynchronous functions.</p>
<p class="">Take for example <code>fs.readFile</code> and <code>fs.readFileSync</code>, if you're writing an API that loads a file and then performs a synchronous operation on the data, it can be frustrating to maintain two parallel functions.</p>
<h1><a class="anchor" id="autotoc_md22064"></a>
Example</h1>
...
<div class="line"> </div>
<div class="line">});</div>
</div><!-- fragment --><p class="">This could even be exposed as your official API by doing </p><div class="fragment"><div class="line">// Using the common &#39;Sync&#39; suffix for sync functions, and &#39;Async&#39; suffix for</div>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md22065"></a>
...
<h4><a class="anchor" id="autotoc_md22066"></a>
Example</h4>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md22067"></a>
gensync.all(iterable)</h2>
<p class=""><code>Promise.all</code>-like combinator that works with an iterable of generator objects that could be passed to <code>yield*</code> within a gensync generator.</p>
<h3><a class="anchor" id="autotoc_md22068"></a>
Example</h3>
...
<div class="line">  ]);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md22069"></a>
gensync.race(iterable)</h2>
<p class=""><code>Promise.race</code>-like combinator that works with an iterable of generator objects that could be passed to <code>yield*</code> within a gensync generator.</p>
<h3><a class="anchor" id="autotoc_md22070"></a>
Example</h3>
<div class="fragment"><div class="line">const loadFiles = gensync(function* () {</div>
