...
<title>Tennis Association: streamroller</title>
...
<div class="contents">
<div class="textblock"><p class="">node.js file streams that roll over when they reach a maximum size, or a date/time. </p><pre class="fragment">    npm install streamroller
</pre> <h1><a class="anchor" id="autotoc_md20436"></a>
usage</h1>
