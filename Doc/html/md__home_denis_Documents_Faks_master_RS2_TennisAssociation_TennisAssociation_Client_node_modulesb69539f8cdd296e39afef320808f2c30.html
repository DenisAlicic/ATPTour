...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md10732"></a>
...
<p class=""><b>Note:</b> UDP packets relayed through the proxy servers are packaged in a special Socks UDP frame format. SocksClient.createUDPFrame() and SocksClient.parseUDPFrame() create and parse these special UDP packets.</p>
