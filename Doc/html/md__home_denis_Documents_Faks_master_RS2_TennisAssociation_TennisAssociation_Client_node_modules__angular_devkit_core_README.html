...
<title>Tennis Association: Core</title>
...
<p class="">Shared utilities for Angular DevKit. </p>
</blockquote>
<h1><a class="anchor" id="autotoc_md20292"></a>
Exception</h1>
<h1><a class="anchor" id="autotoc_md20293"></a>
Json</h1>
<h2><a class="anchor" id="autotoc_md20294"></a>
Schema</h2>
<h3><a class="anchor" id="autotoc_md20295"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md20296"></a>
SchemaValidator</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md20297"></a>
SchemaFormatter</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md20298"></a>
SchemaRegistry</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md20299"></a>
CoreSchemaRegistry</h3>
<p class=""><code>SchemaRegistry</code> implementation using <a href="https://github.com/epoberezkin/ajv">https://github.com/epoberezkin/ajv</a>. Constructor accepts object containing <code>SchemaFormatter</code> that will be added automatically.</p>
...
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md20300"></a>
Logger</h1>
<h1><a class="anchor" id="autotoc_md20301"></a>
Utils</h1>
<h1><a class="anchor" id="autotoc_md20302"></a>
Virtual FS</h1>
<h1><a class="anchor" id="autotoc_md20303"></a>
Workspaces</h1>
<p class="">The <code>workspaces</code> namespace provides an API for interacting with the workspace file formats. It provides an abstraction of the underlying storage format of the workspace and provides support for both reading and writing. Currently, the only supported format is the JSON-based format used by the Angular CLI. For this format, the API provides internal change tracking of values which enables fine-grained updates to the underlying storage of the workspace. This allows for the retention of existing formatting and comments.</p>
<p class="">A workspace is defined via the following object model. Definition collection objects are specialized Javascript <code>Map</code> objects with an additional <code>add</code> method to simplify addition and provide more localized error checking of the newly added values.</p>
...
<div class="line">}</div>
</div><!-- fragment --><p class="">The API is asynchronous and has two main functions to facilitate reading, creation, and modifying a workspace: <code>readWorkspace</code> and <code>writeWorkspace</code>.</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20304"></a>
Usage Example</h2>
<p class="">To demonstrate the usage of the API, the following code will show how to add a option property to a build target for an application.</p>
