...
<title>Tennis Association: Tapable</title>
...
<div class="contents">
<div class="textblock"><p class="">The tapable package expose many Hook classes, which can be used to create hooks for plugins.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md11323"></a>
Installation</h1>
<div class="fragment"><div class="line">npm install --save tapable</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md11324"></a>
Usage</h1>
<p class="">All Hook constructors take one optional argument, which is a list of argument names as strings.</p>
<div class="fragment"><div class="line">const hook = new SyncHook([&quot;arg1&quot;, &quot;arg2&quot;, &quot;arg3&quot;]);</div>
</div><!-- fragment --><p class="">The best practice is to expose all hooks of a class in a <code>hooks</code> property:</p>
...
<div class="line">    /* ... */</div>
<div class="line">}</div>
</div><!-- fragment --><p class="">Other people can now use these hooks:</p>
...
</div><!-- fragment --><p class="">It's required to pass a name to identify the plugin/reason.</p>
<p class="">You may receive arguments:</p>
...
</div><!-- fragment --><p class="">For sync hooks, <code>tap</code> is the only valid method to add a plugin. Async hooks also support async plugins:</p>
...
<div class="line">})</div>
</div><!-- fragment --><p class="">The class declaring these hooks need to call them:</p>
<div class="fragment"><div class="line">class Car {</div>
<div class="line">    /* ... */</div>
<div class="line"> </div>
...
<div class="line">    }</div>
<div class="line">}</div>
</div><!-- fragment --><p class="">The Hook will compile a method with the most efficient way of running your plugins. It generates code depending on:</p><ul>
...
<p class="">This ensures fastest possible execution.</p>
<h1><a class="anchor" id="autotoc_md11325"></a>
Hook types</h1>
<p class="">Each hook can be tapped with one or several functions. How they are executed depends on the hook type:</p>
<ul>
...
<p class="">Additionally, hooks can be synchronous or asynchronous. To reflect this, there’re “Sync”, “AsyncSeries”, and “AsyncParallel” hook classes:</p>
<ul>
...
<p class="">The hook type is reflected in its class name. E.g., <code>AsyncSeriesWaterfallHook</code> allows asynchronous functions and runs them in series, passing each function’s return value into the next function.</p>
<h1><a class="anchor" id="autotoc_md11326"></a>
Interception</h1>
<p class="">All Hooks offer an additional interception API:</p>
...
<div class="line">    }</div>
<div class="line">})</div>
</div><!-- fragment --><p class=""><b>call</b>: <code>(...args) =&gt; void</code> Adding <code>call</code> to your interceptor will trigger when hooks are triggered. You have access to the hooks arguments.</p>
<p class=""><b>tap</b>: <code>(tap: Tap) =&gt; void</code> Adding <code>tap</code> to your interceptor will trigger when a plugin taps into a hook. Provided is the <code>Tap</code> object. <code>Tap</code> object can't be changed.</p>
<p class=""><b>loop</b>: <code>(...args) =&gt; void</code> Adding <code>loop</code> to your interceptor will trigger for each loop of a looping hook.</p>
<p class=""><b>register</b>: <code>(tap: Tap) =&gt; Tap | undefined</code> Adding <code>register</code> to your interceptor will trigger for each added <code>Tap</code> and allows to modify it.</p>
<h1><a class="anchor" id="autotoc_md11327"></a>
Context</h1>
<p class="">Plugins and interceptors can opt-in to access an optional <code>context</code> object, which can be used to pass arbitrary values to subsequent plugins and interceptors.</p>
...
HookMap</h1>
<p class="">A HookMap is a helper class for a Map with Hooks</p>
...
<div class="line">    context: boolean</div>
<div class="line">}</div>
</div><!-- fragment --><p class="">Protected (only for the class containing the hook):</p>
<div class="fragment"><div class="line">interface Hook {</div>
...
MultiHook</h1>
<p class="">A helper Hook-like class to redirect taps to multiple other hooks:</p>
