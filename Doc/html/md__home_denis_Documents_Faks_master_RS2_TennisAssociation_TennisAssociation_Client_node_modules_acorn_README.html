...
<title>Tennis Association: Acorn</title>
...
<div class="contents">
<div class="textblock"><p class="">A tiny, fast JavaScript parser written in JavaScript.</p>
<h1><a class="anchor" id="autotoc_md7563"></a>
Community</h1>
<p class="">Acorn is open source software released under an <a href="https://github.com/acornjs/acorn/blob/master/acorn/LICENSE">MIT license</a>.</p>
<p class="">You are welcome to <a href="https://github.com/acornjs/acorn/issues">report bugs</a> or create pull requests on <a href="https://github.com/acornjs/acorn">github</a>. For questions and discussion, please use the <a href="https://discuss.ternjs.net">Tern discussion forum</a>.</p>
<h1><a class="anchor" id="autotoc_md7564"></a>
Installation</h1>
<p class="">The easiest way to install acorn is from <a href="https://www.npmjs.com/"><code>npm</code></a>:</p>
<div class="fragment"><div class="line">npm install acorn</div>
</div><!-- fragment --><p class="">Alternately, you can download the source and build acorn yourself:</p>
...
<div class="line">}</div>
</div><!-- fragment --><p class="">Note that you are not allowed to call the parser from the callback—that will corrupt its internal state.</p>
<ul>
...
</div><!-- fragment --><p class=""><b>tokTypes</b> holds an object mapping names to the token type objects that end up in the <code>type</code> properties of tokens.</p>
<p class=""><b>getLineInfo</b><code>(input, offset)</code> can be used to get a <code>{line, column}</code> object for a given program string and offset.</p>
<h2><a class="anchor" id="autotoc_md7566"></a>
The &lt;tt&gt;Parser&lt;/tt&gt; class</h2>
<p class="">Instances of the **<code>Parser</code>** class contain all the state and logic that drives a parse. It has static methods <code>parse</code>, <code>parseExpressionAt</code>, and <code>tokenizer</code> that match the top-level functions by the same name.</p>
<p class="">When extending the parser with plugins, you need to call these methods on the extended version of the class. To extend a parser with plugins, you can use its static <code>extend</code> method.</p>
...
</div><!-- fragment --><p class="">The <code>extend</code> method takes any number of plugin values, and returns a new <code>Parser</code> class that includes the extra parser logic provided by the plugins.</p>
<h1><a class="anchor" id="autotoc_md7567"></a>
Command line interface</h1>
<p class="">The <code>bin/acorn</code> utility can be used to parse a file from the command line. It accepts as arguments its input file and the following options:</p>
<ul>
...
<p class="">The utility spits out the syntax tree as JSON data.</p>
...
<p class="">Plugins for ECMAScript proposals:</p>
<ul>
