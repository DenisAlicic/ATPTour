...
<title>Tennis Association: socks  &lt;a href=&quot;https://travis-ci.org/JoshGlazebrook/socks&quot;&gt;&lt;img src=&quot;https://travis-ci.org/JoshGlazebrook/socks.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;  &lt;a href=&quot;https://coveralls.io/github/JoshGlazebrook/socks?branch=v2&quot;&gt;&lt;img src=&quot;https://coveralls.io/repos/github/JoshGlazebrook/socks/badge.svg?branch=master&quot; alt=&quot;Coverage Status&quot;/&gt;&lt;/a&gt;</title>
...
<div class="contents">
<div class="textblock"><p class="">Fully featured SOCKS proxy client supporting SOCKSv4, SOCKSv4a, and SOCKSv5. Includes Bind and Associate functionality.</p>
<h2><a class="anchor" id="autotoc_md14177"></a>
Features</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md14179"></a>
Looking for v1?</h2>
<ul>
...
Installation</h1>
<p class=""><code>yarn add socks</code></p>
<p class="">or</p>
<p class=""><code>npm install --save socks</code></p>
...
<p class="">Connect to github.com (192.30.253.113) on port 80, using a SOCKS proxy.</p>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14183"></a>
Chaining Proxies</h1>
<p class=""><b>Note:</b> Chaining is only supported when using the SOCKS connect command, and chaining can only be done through the special factory chaining function.</p>
<p class="">This example makes a proxy chain through two SOCKS proxies to ip-api.com. Once the connection to the destination is established it sends an HTTP request to get a JSON response that returns ip info for the requesting ip.</p>
<div class="fragment"><div class="line">const options = {</div>
<div class="line">  destination: {</div>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14185"></a>
Associate Example (UDP Relay)</h1>
<p class="">When the associate command is sent to a SOCKS v5 proxy server, it sets up a UDP relay that allows the client to send UDP packets to a remote host through the proxy server, and also receive UDP packet responses back through the proxy server.</p>
<div class="fragment"><div class="line">const options = {</div>
<div class="line">  proxy: {</div>
<div class="line">    host: &#39;159.203.75.235&#39;, // ipv4, ipv6, or hostname</div>
<div class="line">    port: 1081,</div>
...
<div class="line">client.connect();</div>
</div><!-- fragment --><p class=""><b>Note:</b> The associate TCP connection to the proxy must remain open for the UDP relay to work.</p>
<h1><a class="anchor" id="autotoc_md14186"></a>
Additional Examples</h1>
<p class=""><a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulesf602c7f4e0aa805ff65a0ddd4b30a8ce.html">Documentation</a></p>
<h1><a class="anchor" id="autotoc_md14187"></a>
Migrating from v1</h1>
<p class="">Looking for a guide to migrate from v1? Look <a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules9fbdc07dc39dcfde454d5cfc47a4a880.html">here</a></p>
<h1><a class="anchor" id="autotoc_md14188"></a>
Api Reference:</h1>
<p class=""><b>Note:</b> socks includes full TypeScript definitions. These can even be used without using TypeScript as most IDEs (such as VS Code) will use these type definition files for auto completion intellisense even in JavaScript files.</p>
<ul>
...
SocksClient</h2>
<p class="">SocksClient establishes SOCKS proxy connections to remote destination hosts. These proxy connections are fully transparent to the server and once established act as full duplex streams. SOCKS v4, v4a, v5, and v5h are supported, as well as the connect, bind, and associate commands.</p>
<p class="">SocksClient supports creating connections using callbacks, promises, and async/await flow control using two static factory functions createConnection and createConnectionChain. It also internally extends EventEmitter which results in allowing event handling based async flow control.</p>
<p class=""><b>SOCKS Compatibility Table</b></p>
<p class="">Note: When using 4a please specify type: 4, and when using 5h please specify type 5.</p>
...
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyNone">SOCKS v5 (includes 5hh)   </td><td class="markdownTableBodyCenter">✅   </td><td class="markdownTableBodyCenter">✅   </td><td class="markdownTableBodyCenter">✅   </td><td class="markdownTableBodyCenter">✅   </td><td class="markdownTableBodyCenter">✅   </td></tr>
</table>
<h2><a class="anchor" id="autotoc_md14190"></a>
...
<h2><a class="anchor" id="autotoc_md14191"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14192"></a>
...
<p class="">Creates a new proxy connection through the given proxy to the given destination host. This factory function supports callbacks and promises for async flow control.</p>
<p class=""><b>Note:</b> If a callback function is provided, the promise will always resolve regardless of an error occurring. Please be sure to exclusively use either promises or callbacks when using this factory function.</p>
<div class="fragment"><div class="line">const options = {</div>
<div class="line">  proxy: {</div>
<div class="line">    host: &#39;159.203.75.200&#39;, // ipv4, ipv6, or hostname</div>
<div class="line">    port: 1080,</div>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14193"></a>
...
<p class="">Creates a new proxy connection chain through a list of at least two SOCKS proxies to the given destination host. This factory method supports callbacks and promises for async flow control.</p>
<p class=""><b>Note:</b> If a callback function is provided, the promise will always resolve regardless of an error occurring. Please be sure to exclusively use either promises or callbacks when using this factory function.</p>
<p class=""><b>Note:</b> At least two proxies must be provided for the chain to be established.</p>
<div class="fragment"><div class="line">const options = {</div>
<div class="line">  proxies: [ // The chain order is the order in the proxies array, meaning the last proxy will establish a connection to the destination.</div>
<div class="line">    {</div>
<div class="line">      host: &#39;159.203.75.235&#39;, // ipv4, ipv6, or hostname</div>
...
<p class="">Creates a SOCKS UDP frame relay packet that is sent and received via a SOCKS proxy when using the associate command for UDP packet forwarding.</p>
<p class=""><b>SocksUDPFrameDetails</b></p>
<div class="fragment"><div class="line">{</div>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14195"></a>
...
<div class="line">}</div>
<div class="line">*/</div>
</div><!-- fragment --><p class="">Parses a Buffer instance and returns the parsed SocksUDPFrameDetails object.</p>
...
<p class="">This event is emitted if an error occurs when trying to establish the proxy connection.</p>
...
<p class="">This event is emitted when using the BIND command on a remote SOCKS proxy server. This event indicates the proxy server is now listening for incoming connections on a specified port.</p>
<p class=""><b>SocksClientBoundEvent</b> </p><div class="fragment"><div class="line">{</div>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14198"></a>
...
<p class="">This event is emitted when the following conditions are met:</p><ol type="1">
...
<p class="">When using BIND, 'bound' is first emitted to indicate the SOCKS server is waiting for an incoming connection, and provides the remote port the SOCKS server is listening on.</p>
<p class="">When using ASSOCIATE, 'established' is emitted with the remote UDP port the SOCKS server is accepting UDP frame packets on.</p>
<p class=""><b>SocksClientEstablishedEvent</b> </p><div class="fragment"><div class="line">{</div>
<div class="line">  socket: net.Socket, // The underlying raw Socket</div>
<div class="line">  remoteHost: {</div>
<div class="line">    host: &#39;1.2.3.4&#39;, // The remote host that is listening (usually the proxy itself)</div>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14199"></a>
client.connect()</h1>
<p class="">Starts connecting to the remote SOCKS proxy server to establish a proxy connection to the destination host.</p>
...
<p class="">Gets the options that were passed to the SocksClient when it was created.</p>
<p class=""><b>SocksClientError</b> </p><div class="fragment"><div class="line">{ // Subclassed from Error.</div>
<div class="line">  message: &#39;An error has occurred&#39;,</div>
<div class="line">  options: {</div>
<div class="line">    // SocksClientOptions</div>
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14201"></a>
Further Reading:</h1>
<p class="">Please read the SOCKS 5 specifications for more information on how to use BIND and Associate. <a href="http://www.ietf.org/rfc/rfc1928.txt">http://www.ietf.org/rfc/rfc1928.txt</a></p>
