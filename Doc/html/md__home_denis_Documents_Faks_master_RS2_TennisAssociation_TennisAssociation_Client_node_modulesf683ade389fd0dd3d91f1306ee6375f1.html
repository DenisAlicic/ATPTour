...
<title>Tennis Association: Tmp</title>
...
<div class="contents">
<div class="textblock"><p class="">A simple temporary file and directory creator for <a href="http://nodejs.org/">node.js.</a></p>
<p class=""><a href="https://travis-ci.org/raszi/node-tmp"><img src="https://travis-ci.org/raszi/node-tmp.svg?branch=master" alt="Build Status" style="pointer-events: none;" class="inline"/></a> <a href="https://david-dm.org/raszi/node-tmp"><img src="https://david-dm.org/raszi/node-tmp.svg" alt="Dependencies" style="pointer-events: none;" class="inline"/></a> <a href="https://badge.fury.io/js/tmp"><img src="https://badge.fury.io/js/tmp.svg" alt="npm version" style="pointer-events: none;" class="inline"/></a></p>
<h1><a class="anchor" id="autotoc_md31801"></a>
About</h1>
<p class="">This is a <a href="https://www.npmjs.com/browse/depended/tmp">widely used library</a> to create temporary files and directories in a <a href="http://nodejs.org/">node.js</a> environment.</p>
<p class="">Tmp offers both an asynchronous and a synchronous API. For all API calls, all the parameters are optional.</p>
<p class="">Tmp uses crypto for determining random file names, or, when using templates, a six letter random identifier. And just in case that you do not have that much entropy left on your system, Tmp will fall back to pseudo random numbers.</p>
<p class="">You can set whether you want to remove the temporary file on process exit or not, and the destination directory can also be set.</p>
<h1><a class="anchor" id="autotoc_md31802"></a>
How to install</h1>
<div class="fragment"><div class="line">npm install tmp</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31803"></a>
Usage</h1>
<h2><a class="anchor" id="autotoc_md31804"></a>
Asynchronous file creation</h2>
<p class="">Simple temporary file creation, the file will be closed and unlinked on process exit.</p>
...
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31805"></a>
Synchronous file creation</h2>
<p class="">A synchronous version of the above.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
</div><!-- fragment --><p class="">Note that this might throw an exception if either the maximum limit of retries for creating a temporary name fails, or, in case that you do not have the permission to write to the directory where the temporary file should be created in.</p>
<h2><a class="anchor" id="autotoc_md31806"></a>
Asynchronous directory creation</h2>
<p class="">Simple temporary directory creation, it will be removed on process exit.</p>
<p class="">If the directory still contains items on process exit, then it won't be removed.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">  cleanupCallback();</div>
<div class="line">});</div>
</div><!-- fragment --><p class="">If you want to cleanup the directory even when there are entries in it, then you can pass the <code>unsafeCleanup</code> option when creating it.</p>
...
<div class="line">// Manual cleanup</div>
<div class="line">tmpobj.removeCallback();</div>
</div><!-- fragment --><p class="">Note that this might throw an exception if either the maximum limit of retries for creating a temporary name fails, or, in case that you do not have the permission to write to the directory where the temporary directory should be created in.</p>
<h2><a class="anchor" id="autotoc_md31808"></a>
Asynchronous filename generation</h2>
<p class="">It is possible with this library to generate a unique filename in the specified directory.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31809"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31810"></a>
Advanced usage</h1>
<h2><a class="anchor" id="autotoc_md31811"></a>
Asynchronous file creation</h2>
<p class="">Creates a file with mode <code>0644</code>, prefix will be <code>prefix-</code> and postfix will be <code>.txt</code>.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">  console.log(&quot;Filedescriptor: &quot;, fd);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31812"></a>
Synchronous file creation</h2>
<p class="">A synchronous version of the above.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">console.log(&quot;File: &quot;, tmpobj.name);</div>
<div class="line">console.log(&quot;Filedescriptor: &quot;, tmpobj.fd);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31813"></a>
Asynchronous directory creation</h2>
<p class="">Creates a directory with mode <code>0755</code>, prefix will be <code>myTmpDir_</code>.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">  console.log(&quot;Dir: &quot;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31814"></a>
Synchronous directory creation</h2>
<p class="">Again, a synchronous version of the above.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
<div class="line">var tmpobj = tmp.dirSync({ mode: 0750, prefix: &#39;myTmpDir_&#39; });</div>
<div class="line">console.log(&quot;Dir: &quot;, tmpobj.name);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31815"></a>
mkstemp like, asynchronously</h2>
<p class="">Creates a new temporary directory with mode <code>0700</code> and filename like <code>/tmp/tmp-nk2J1u</code>.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">  console.log(&quot;Dir: &quot;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31816"></a>
mkstemp like, synchronously</h2>
<p class="">This will behave similarly to the asynchronous version.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
<div class="line">var tmpobj = tmp.dirSync({ template: &#39;/tmp/tmp-XXXXXX&#39; });</div>
<div class="line">console.log(&quot;Dir: &quot;, tmpobj.name);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31817"></a>
Asynchronous filename generation</h2>
<p class="">The <code>tmpName()</code> function accepts the <code>prefix</code>, <code>postfix</code>, <code>dir</code>, etc. parameters also:</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">    console.log(&quot;Created temporary filename: &quot;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md31818"></a>
Synchronous filename generation</h2>
<p class="">The <code>tmpNameSync()</code> function works similarly to <code>tmpName()</code>.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31819"></a>
Graceful cleanup</h1>
<p class="">One may want to cleanup the temporary files even when an uncaught exception occurs. To enforce this, you can call the <code>setGracefulCleanup()</code> method:</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
<div class="line">tmp.setGracefulCleanup();</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md31820"></a>
Options</h1>
<p class="">All options are optional :)</p>
<ul>
