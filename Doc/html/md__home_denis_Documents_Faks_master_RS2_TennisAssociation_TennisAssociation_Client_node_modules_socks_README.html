...
<h2><a class="anchor" id="autotoc_md10689"></a>
Features</h2>
<ul>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10697"></a>
...
<p class=""><a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_socks_docs_index.html">Documentation</a></p>
<h1><a class="anchor" id="autotoc_md10699"></a>
Migrating from v1</h1>
<p class="">Looking for a guide to migrate from v1? Look <a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modules_socks_docs_migratingFromV1.html">here</a></p>
...
SocksClient</h2>
<p class="">SocksClient establishes SOCKS proxy connections to remote destination hosts. These proxy connections are fully transparent to the server and once established act as full duplex streams. SOCKS v4, v4a, and v5 are supported, as well as the connect, bind, and associate commands.</p>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10704"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10706"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10707"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10711"></a>
client.connect()</h1>
