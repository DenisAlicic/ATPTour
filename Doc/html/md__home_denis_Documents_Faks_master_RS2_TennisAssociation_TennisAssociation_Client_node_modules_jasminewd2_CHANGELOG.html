...
<title>Tennis Association: Changelog for jasminewd2</title>
...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md20084"></a>
2.2.0</h1>
<h2><a class="anchor" id="autotoc_md20085"></a>
Dependencies</h2>
<p class="">Update selenium-webdriverjs to 3.5.0.</p>
<h1><a class="anchor" id="autotoc_md20086"></a>
2.1.0</h1>
...
2.0.0</h1>
<p class="">(Skipping 1.x because <code>0.0.1</code> was originally accidently published as <code>1.0.0</code>.)</p>
...
</div><!-- fragment --><p class="">This removes the dependency on <code>selenium-webdriver</code> and protects jasminewd from having a different webdriver instance than Protractor, which could be a huge problem if they had different control flow settings.</p>
<p class="">This is a breaking change because it changes the API for the <code>init</code> function.</p>
<p class="">I also removed the dependency on jasmine, which didn't do anything anyway. Maybe it should have been a peerDependency but those are deprecated.</p>
...
</div><!-- fragment --><p class="">I thought about it for a little while, and there's no way that's correct. <code>expected</code> is an <code>Array&lt;any&gt;</code>, there's no way it has a <code>.then</code> function.</p>
<p class="">Closes <a href="https://github.com/angular/jasminewd/issues/69">https://github.com/angular/jasminewd/issues/69</a></p>
...
<h1><a class="anchor" id="autotoc_md20094"></a>
0.1.0</h1>
<p class="">Release for the selenium-webdriver 3.0.1 upgrade.</p>
<h1><a class="anchor" id="autotoc_md20095"></a>
0.1.0-beta.1</h1>
<ul>
...
0.1.0-beta.0</h1>
<p class="">This beta release is for the selenium-webdriver 3.0.0-beta-3 upgrade.</p>
...
<h1><a class="anchor" id="autotoc_md20101"></a>
0.0.7</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md20103"></a>
0.0.5</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md20104"></a>
0.0.4</h1>
<ul>
