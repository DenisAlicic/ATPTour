...
<title>Tennis Association: 🚨 Unmaintained 🚨</title>
...
<div class="contents">
<div class="textblock"><p class="" class="banner"></p>
<p class="">JSON 3 is <b>deprecated</b> and <b>no longer maintained</b>. Please don't use it in new projects, and migrate existing projects to use the native <code>JSON.parse</code> and <code>JSON.stringify</code> instead.</p>
<p class="">Thanks to everyone who contributed patches or found it useful! ❤️</p>
<h1><a class="anchor" id="autotoc_md21570"></a>
JSON 3</h1>
<p class=""><a href="http://unmaintained.tech/"><img src="http://unmaintained.tech/badge.svg" alt="No Maintenance Intended" style="pointer-events: none;" class="inline"/></a></p>
<p class=""><b>JSON 3</b> was a JSON polyfill for older JavaScript platforms.</p>
<h2><a class="anchor" id="autotoc_md21571"></a>
About</h2>
...
<h3><a class="anchor" id="autotoc_md21575"></a>
...
<p class=""><b>Note:</b> If you intend to use JSON3 alongside another module, <b>please do not simply concatenate these modules together</b>, as that would cause multiple <code>define</code> calls in one script, resulting in errors in AMD loaders. The <code>r.js</code> build optimizer can be used instead if you need a single compressed file for production.</p>
<h2><a class="anchor" id="autotoc_md21577"></a>
CommonJS Environments</h2>
<pre class="fragment">var JSON3 = require("./path/to/json3");
JSON3.parse("[1, 2, 3]");
// =&gt; [1, 2, 3]
</pre> <h2><a class="anchor" id="autotoc_md21578"></a>
JavaScript Engines</h2>
<pre class="fragment">load("path/to/json3.js");
JSON.stringify({"Hello": 123, "Good-bye": 456}, ["Hello"], "\t");
// =&gt; '{\n\t"Hello": 123\n}'
</pre> <h1><a class="anchor" id="autotoc_md21579"></a>
Compatibility</h1>
<p class="">JSON 3 has been <b>tested</b> with the following web browsers, CommonJS environments, and JavaScript engines.</p>
...
<h2><a class="anchor" id="autotoc_md21581"></a>
CommonJS Environments</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md21582"></a>
JavaScript Engines</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md21583"></a>
...
<h2><a class="anchor" id="autotoc_md21584"></a>
Required Native Methods</h2>
<p class="">JSON 3 assumes that the following methods exist and function as described in the ECMAScript specification:</p>
<ul>
