...
<title>Tennis Association: http-proxy-middleware</title>
...
</div><!-- fragment --><p class=""><em>All</em> <code>http-proxy</code> <a href="https://github.com/nodejitsu/node-http-proxy#options">options</a> can be used, along with some extra <code>http-proxy-middleware</code> <a href="#options">options</a>.</p>
<p class="">:bulb: <b>Tip:</b> Set the option <code>changeOrigin</code> to <code>true</code> for <a href="http://en.wikipedia.org/wiki/Virtual_hosting#Name-based">name-based virtual hosted sites</a>.</p>
<h1><a class="anchor" id="autotoc_md19796"></a>
...
<h1><a class="anchor" id="autotoc_md19797"></a>
Install</h1>
<div class="fragment"><div class="line">$ npm install --save-dev http-proxy-middleware</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19798"></a>
Core concept</h1>
<p class="">Proxy middleware configuration.</p>
<h3><a class="anchor" id="autotoc_md19799"></a>
...
<p class="">(full list of <a href="#options"><code>http-proxy-middleware</code> configuration options</a>)</p>
<h3><a class="anchor" id="autotoc_md19800"></a>
proxy(uri [, config])</h3>
...
</div><!-- fragment --><p class="">More about the <a href="#shorthand">shorthand configuration</a>.</p>
<h1><a class="anchor" id="autotoc_md19801"></a>
Example</h1>
<p class="">An example with <code>express</code> server.</p>
...
<div class="line">app.listen(3000)</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19802"></a>
Context matching</h1>
<p class="">Providing an alternative way to decide which requests should be proxied; In case you are not able to use the server's <a href="http://expressjs.com/en/4x/api.html#app.use"><code>path</code> parameter</a> to mount the proxy or when you need more flexibility.</p>
<p class=""><a href="https://tools.ietf.org/html/rfc3986#section-3.3">RFC 3986 <code>path</code></a> is used for context matching.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19803"></a>
Options</h1>
...
<p class="">Subscribe to <a href="https://github.com/nodejitsu/node-http-proxy#listening-for-proxy-events">http-proxy events</a>:</p>
<ul>
...
<h2><a class="anchor" id="autotoc_md19806"></a>
http-proxy options</h2>
<p class="">The following options are provided by the underlying <a href="https://github.com/nodejitsu/node-http-proxy#options">http-proxy</a> library.</p>
<ul>
...
<div class="line"> </div>
<div class="line">};</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19807"></a>
Shorthand</h1>
<p class="">Use the shorthand syntax when verbose configuration is not needed. The <code>context</code> and <code>option.target</code> will be automatically configured when shorthand is used. Options can still be used if needed.</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md19808"></a>
app.use(path, proxy)</h2>
<p class="">If you want to use the server's <code>app.use</code> <code>path</code> parameter to match requests; Create and mount the proxy without the http-proxy-middleware <code>context</code> parameter:</p>
<div class="fragment"><div class="line">app.use(&#39;/api&#39;, proxy({ target: &#39;http://www.example.org&#39;, changeOrigin: true }))</div>
</div><!-- fragment --><p class=""><code>app.use</code> documentation:</p>
<ul>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md19810"></a>
External WebSocket upgrade</h2>
<p class="">In the previous WebSocket examples, http-proxy-middleware relies on a initial http request in order to listen to the http <code>upgrade</code> event. If you need to proxy WebSockets without the initial http request, you can subscribe to the server's http <code>upgrade</code> event manually.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19811"></a>
Working examples</h1>
<p class="">View and play around with <a href="https://github.com/chimurai/http-proxy-middleware/tree/master/examples">working examples</a>.</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md19812"></a>
Recipes</h1>
<p class="">View the <a href="https://github.com/chimurai/http-proxy-middleware/tree/master/recipes">recipes</a> for common use cases.</p>
<h1><a class="anchor" id="autotoc_md19813"></a>
Compatible servers</h1>
<p class=""><code>http-proxy-middleware</code> is compatible with the following servers:</p>
<ul>
...
<p class="">Sample implementations can be found in the <a href="https://github.com/chimurai/http-proxy-middleware/tree/master/recipes/servers.md">server recipes</a>.</p>
<h1><a class="anchor" id="autotoc_md19814"></a>
Tests</h1>
<p class="">Run the test suite:</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19815"></a>
Changelog</h1>
<ul>
...
License</h1>
<p class="">The MIT License (MIT)</p>
<p class="">Copyright (c) 2015-2018 Steven Chim </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<!-- start footer part -->
