...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13836"></a>
Features</h2>
<ul>
...
API</h2>
<h3><a class="anchor" id="autotoc_md13838"></a>
&lt;a name="pick-manifest"&gt;&lt;/a&gt; &lt;tt&gt;&gt; pickManifest(packument, selector, [opts]) -&gt; manifest&lt;/tt&gt;</h3>
<p class="">Returns the manifest that best matches <code>selector</code>, or throws an error.</p>
...
<p class="">Return value is the manifest as it exists in the packument, possibly decorated with the following boolean flags:</p>
<ul>
