...
<title>Tennis Association: make-fetch-happen</title>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md15619"></a>
Features</h2>
<ul>
...
<p class="">All participants and maintainers in this project are expected to follow the <a href="https://www.npmjs.com/policies/conduct">npm Code of Conduct</a>, and just generally be excellent to each other.</p>
<p class="">Please refer to the <a class="el" href="md__home_denis_Documents_Faks_master_RS2_TennisAssociation_TennisAssociation_Client_node_modulescd4c798b861256da8d78eff7d55b5917.html">Changelog</a> for project history details, too.</p>
<p class="">Happy hacking!</p>
<h2><a class="anchor" id="autotoc_md15621"></a>
API</h2>
<h3><a class="anchor" id="autotoc_md15622"></a>
...
<h4><a class="anchor" id="autotoc_md15623"></a>
Example</h4>
<div class="fragment"><div class="line">fetch(&#39;https://google.com&#39;).then(res =&gt; res.buffer())</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15624"></a>
...
<h4><a class="anchor" id="autotoc_md15625"></a>
Example</h4>
<div class="fragment"><div class="line">const fetch = require(&#39;make-fetch-happen&#39;).defaults({</div>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15626"></a>
&lt;a name="minipass-fetch-options"&gt;&lt;/a&gt; &lt;tt&gt;&gt; minipass-fetch options&lt;/tt&gt;</h3>
<p class="">The following options for <code>minipass-fetch</code> are used as-is:</p>
<ul>
<li>method</li>
<li>body</li>
<li>redirect</li>
...
<p class="">For more details, see <a href="https://github.com/npm/minipass-fetch#options">the documentation for <code>minipass-fetch</code> itself</a>.</p>
<h3><a class="anchor" id="autotoc_md15627"></a>
&lt;a name="extra-options"&gt;&lt;/a&gt; &lt;tt&gt;&gt; make-fetch-happen options&lt;/tt&gt;</h3>
<p class="">make-fetch-happen augments the <code>minipass-fetch</code> API with additional features available through extra options. The following extra options are available:</p>
<ul>
...
<h3><a class="anchor" id="autotoc_md15628"></a>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md15629"></a>
Example</h4>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15630"></a>
...
<h4><a class="anchor" id="autotoc_md15631"></a>
Example</h4>
<div class="fragment"><div class="line">const fetch = require(&#39;make-fetch-happen&#39;).defaults({</div>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15632"></a>
&lt;a name="opts-proxy"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.proxy&lt;/tt&gt;</h3>
<p class="">A string or <code>new url.URL()</code>-d URI to proxy through. Different Proxy handlers will be used depending on the proxy's protocol.</p>
...
<h4><a class="anchor" id="autotoc_md15633"></a>
Example</h4>
<div class="fragment"><div class="line">fetch(&#39;https://registry.npmjs.org/make-fetch-happen&#39;, {</div>
...
<div class="line">  }</div>
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15634"></a>
...
<h3><a class="anchor" id="autotoc_md15635"></a>
...
<h3><a class="anchor" id="autotoc_md15636"></a>
...
<h3><a class="anchor" id="autotoc_md15637"></a>
...
<h3><a class="anchor" id="autotoc_md15638"></a>
...
<div class="line">  }</div>
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15642"></a>
...
<h4><a class="anchor" id="autotoc_md15643"></a>
Example</h4>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md15644"></a>
