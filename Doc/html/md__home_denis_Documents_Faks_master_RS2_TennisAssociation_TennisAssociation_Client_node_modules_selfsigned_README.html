...
<div class="contents">
<div class="textblock"><p class="">Generate a self signed x509 certificate from node.js.</p>
<p class=""><a href="https://travis-ci.org/jfromaniello/selfsigned"><img src="https://travis-ci.org/jfromaniello/selfsigned.png" alt="Build Status" class="inline"/></a></p>
<h2><a class="anchor" id="autotoc_md12171"></a>
Install</h2>
<div class="fragment"><div class="line">npm install selfsigned</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12172"></a>
Usage</h2>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md12173"></a>
Async</h4>
<div class="fragment"><div class="line">selfsigned.generate(attrs, { days: 365 }, function (err, pems) {</div>
<div class="line">  console.log(pems)</div>
<div class="line">});</div>
</div><!-- fragment --><p class="">Will return the following like this:</p>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12174"></a>
Attributes</h2>
<p class="">for attributes, please refer to: <a href="https://github.com/digitalbazaar/forge/blob/0.7.5/lib/x509.js#L129">https://github.com/digitalbazaar/forge/blob/0.7.5/lib/x509.js#L129</a></p>
...
<p class="">You can avoid key pair generation specifying your own keys (&lsquo;{ keyPair: { publicKey: &rsquo;--&mdash;BEGIN PUBLIC KEY--&mdash;...', privateKey: '--&mdash;BEGIN RSA PRIVATE KEY--&mdash;...' }`) </p>
</blockquote>
<h3><a class="anchor" id="autotoc_md12176"></a>
Generate Client Certificates</h3>
<p class="">If you are in an environment where servers require client certificates, you can generate client keys signed by the original (server) key.</p>
...
</div><!-- fragment --><p class="">To override the default client CN of <code>john doe jdoe123</code>, add another option for <code>clientCertificateCN</code>:</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12177"></a>
License</h2>
<p class="">MIT </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
